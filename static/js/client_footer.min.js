 ...
 */
(function(a){if(typeof define==="function"&&define.amd){define(["jquery"],a)}else{a(jQuery)}}(function(f){var a=/\+/g;function d(i){return b.raw?i:encodeURIComponent(i)}function g(i){return b.raw?i:decodeURIComponent(i)}function h(i){return d(b.json?JSON.stringify(i):String(i))}function c(i){if(i.indexOf('"')===0){i=i.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\")}try{i=decodeURIComponent(i.replace(a," "))}catch(j){return}try{return b.json?JSON.parse(i):i}catch(j){}}function e(j,i){var k=b.raw?j:c(j);return f.isFunction(i)?i(k):k}var b=f.cookie=function(q,p,v){if(p!==undefined&&!f.isFunction(p)){v=f.extend({},b.defaults,v);if(typeof v.expires==="number"){var r=v.expires,u=v.expires=new Date();u.setDate(u.getDate()+r)}return(document.cookie=[d(q),"=",h(p),v.expires?"; expires="+v.expires.toUTCString():"",v.path?"; path="+v.path:"",v.domain?"; domain="+v.domain:"",v.secure?"; secure":""].join(""))}var w=q?undefined:{};var s=document.cookie?document.cookie.split("; "):[];for(var o=0,m=s.length;o<m;o++){var n=s[o].split("=");var j=g(n.shift());var k=n.join("=");if(q&&q===j){w=e(k,p);break}if(!q&&(k=e(k))!==undefined){w[j]=k}}return w};b.defaults={};f.removeCookie=function(j,i){if(f.cookie(j)!==undefined){f.cookie(j,"",f.extend({},i,{expires:-1}));return true}return false}}));$(document).ready(function(){$(document).on("click",".sidebar-nav .nav-header",function(){$list=$(this).closest("ul");var c=$list.closest(".menu-sidebar").attr("data-menu-id");if($list.hasClass("collapsed")==true){$list.removeClass("collapsed");$(".nav-item",$list).show();localStorage.setItem("menuVisible_"+c,"true")}else{$list.addClass("collapsed");$(".nav-item",$list).hide();localStorage.setItem("menuVisible_"+c,"false")}});$(".environment-portal .thumbnail").click(function(f){var c=f.target.nodeName;var d=$("h3 a",this).attr("href");if(c!="SPAN"&&$(f.target).hasClass("glyphicon-trash")==false){window.location.href=d}});function a(d){var c=localStorage.getItem("menuVisible_"+d,"true");if(c=="false"){$(".menu-sidebar[data-menu-id='"+d+"'] ul").addClass("collapsed");$(".menu-sidebar[data-menu-id='"+d+"'] .nav-item").hide()}}$(".menu-sidebar").each(function(){var d=$(this).attr("data-menu-id");a(d);var c=$(".menu-sidebar[data-menu-id='"+d+"']");c.css({height:"auto"}).animate({opacity:1},700)});$(".card-header .navToggle").click(function(){if($(".sidebar-nav").hasClass("open")){$(".sidebar-nav").animate({left:"-270px"},200);$(".proto-content").animate({left:"0px"},200);$(".sidebar-nav").removeClass("open")}else{$(".sidebar-nav").animate({left:"0px"},200);$(".proto-content").animate({left:"247px"},200);$(".sidebar-nav").addClass("open")}});var b=localStorage.getItem("cardWidth");if(b<=parseFloat($(".proto-content-holder").width())){$("body.card .proto-content").css({width:b})}$(".proto-content").animate({opacity:1},300);$(document).on("click",".notification",function(){if($(".notification-holder").hasClass("visible")==false){$(this).fadeOut(300)}});$("body").append('<div class="notification-holder"></div>');if($(".notification").size()>=1&&$(".notification-button").size()==0){$(".notification-holder").append('<div class="notification-button"></div>')}$(".notification").appendTo(".notification-holder");$(".notification-button").click(function(){if($(".notification-holder").hasClass("visible")==false){$(".notification-holder").css({"margin-right":"-300px"});setTimeout(function(){$(".notification-holder").addClass("visible");$(".notification-holder").animate({"margin-right":"0px"},300);$(".notification-holder .notification").show()},150)}else{$(".notification-holder").animate({"margin-right":"-300px"},300,function(){$(".notification-holder").removeClass("visible");$(".notification-holder .notification").hide();$(".notification-holder").css({"margin-right":"0px"})})}});$(".modal-content").draggable({handle:".modal-header"})});