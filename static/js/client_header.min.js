...
iEndButton=iPages}else{if(iCurrentPage<=iPageCountHalf){iStartButton=1;iEndButton=iPageCount}else{if(iCurrentPage>=(iPages-iPageCountHalf)){iStartButton=iPages-iPageCount+1;iEndButton=iPages}else{iStartButton=iCurrentPage-Math.ceil(iPageCount/2)+1;iEndButton=iStartButton+iPageCount-1}}}}for(i=iStartButton;i<=iEndButton;i++){sList+=(iCurrentPage!==i)?'<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+'">'+oSettings.fnFormatNumber(i)+"</a>":'<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButtonActive+'">'+oSettings.fnFormatNumber(i)+"</a>"}for(i=0,iLen=an.length;i<iLen;i++){nNode=an[i];if(!nNode.hasChildNodes()){continue}$("span:eq(0)",nNode).html(sList).children("a").each(fnBind);anButtons=nNode.getElementsByTagName("a");anStatic=[anButtons[0],anButtons[1],anButtons[anButtons.length-2],anButtons[anButtons.length-1]];$(anStatic).removeClass(oClasses.sPageButton+" "+oClasses.sPageButtonActive+" "+oClasses.sPageButtonStaticDisabled);$([anStatic[0],anStatic[1]]).addClass((iCurrentPage==1)?oClasses.sPageButtonStaticDisabled:oClasses.sPageButton);$([anStatic[2],anStatic[3]]).addClass((iPages===0||iCurrentPage===iPages||oSettings._iDisplayLength===-1)?oClasses.sPageButtonStaticDisabled:oClasses.sPageButton)}}}});$.extend(DataTable.ext.oSort,{"string-pre":function(a){if(typeof a!="string"){a=(a!==null&&a.toString)?a.toString():""}return a.toLowerCase()},"string-asc":function(x,y){return((x<y)?-1:((x>y)?1:0))},"string-desc":function(x,y){return((x<y)?1:((x>y)?-1:0))},"html-pre":function(a){return a.replace(/<.*?>/g,"").toLowerCase()},"html-asc":function(x,y){return((x<y)?-1:((x>y)?1:0))},"html-desc":function(x,y){return((x<y)?1:((x>y)?-1:0))},"date-pre":function(a){var x=Date.parse(a);if(isNaN(x)||x===""){x=Date.parse("01/01/1970 00:00:00")}return x},"date-asc":function(x,y){return x-y},"date-desc":function(x,y){return y-x},"numeric-pre":function(a){return(a=="-"||a==="")?0:a*1},"numeric-asc":function(x,y){return x-y},"numeric-desc":function(x,y){return y-x}});$.extend(DataTable.ext.aTypes,[function(sData){if(typeof sData==="number"){return"numeric"}else{if(typeof sData!=="string"){return null}}var sValidFirstChars="0123456789-";var sValidChars="0123456789.";var Char;var bDecimal=false;Char=sData.charAt(0);if(sValidFirstChars.indexOf(Char)==-1){return null}for(var i=1;i<sData.length;i++){Char=sData.charAt(i);if(sValidChars.indexOf(Char)==-1){return null}if(Char=="."){if(bDecimal){return null}bDecimal=true}}return"numeric"},function(sData){var iParse=Date.parse(sData);if((iParse!==null&&!isNaN(iParse))||(typeof sData==="string"&&sData.length===0)){return"date"}return null},function(sData){if(typeof sData==="string"&&sData.indexOf("<")!=-1&&sData.indexOf(">")!=-1){return"html"}return null}]);$.fn.DataTable=DataTable;$.fn.dataTable=DataTable;$.fn.dataTableSettings=DataTable.settings;$.fn.dataTableExt=DataTable.ext}))}(window,document));(function(a){a.fn.rowReordering=function(n){function c(o){if(o.fnSettings().oFeatures.bProcessing){a(".dataTables_processing").css("visibility","visible")}}function e(o){if(o.fnSettings().oFeatures.bProcessing){a(".dataTables_processing").css("visibility","hidden")}}function j(p,q){var o=1000000;a(q,p).each(function(){iPosition=parseInt(p.fnGetData(this,k.iIndexColumn));if(iPosition<o){o=iPosition}});return o}function h(o,p,r,s,q){p.sortable("cancel");if(s<=r.iLogLevel){if(q!=undefined){r.fnAlert(q,"")}else{r.fnAlert("Row cannot be moved","")}}r.fnEndProcessingMode(o)}function d(u,t,p){var s=a("#"+p,u);var w=u.fnGetData(s[0],k.iIndexColumn);var v=-1;var o;var q=s.prev(t);if(q.length>0){v=parseInt(u.fnGetData(q[0],k.iIndexColumn));if(v<w){v=v+1}}else{var r=s.next(t);if(r.length>0){v=parseInt(u.fnGetData(r[0],k.iIndexColumn));if(v>w){v=v-1}}}if(v<w){o="back"}else{o="forward"}return{sDirection:o,iCurrentPosition:w,iNewPosition:v}}function m(u,s,w,v,o,p,x){var q=w;var y=v;if(o=="back"){q=v;y=w}a(u.fnGetNodes()).each(function(){if(x!=""&&a(this).attr("data-group")!=x){return}var A=this;var z=parseInt(u.fnGetData(A,k.iIndexColumn));if(q<=z&&z<=y){if(A.id==p){u.fnUpdate(v,u.fnGetPosition(A),k.iIndexColumn,false)}else{if(o=="back"){u.fnUpdate(z+1,u.fnGetPosition(A),k.iIndexColumn,false)}else{u.fnUpdate(z-1,u.fnGetPosition(A),k.iIndexColumn,false)}}}});var r=u.fnSettings();if(r.oFeatures.bServerSide===false){var t=r._iDisplayStart;r.oApi._fnReDraw(r);r._iDisplayStart=t;r.oApi._fnCalculateEnd(r)}r.oApi._fnDraw(r)}function g(p,o){alert(p)}var f={iIndexColumn:0,iStartPosition:1,sURL:null,sRequestType:"POST",iGroupingLevel:0,fnAlert:g,fnSuccess:jQuery.noop,iLogLevel:1,sDataGroupAttribute:"data-group",fnStartProcessingMode:c,fnEndProcessingMode:e,fnUpdateAjaxRequest:jQuery.noop};var k=a.extend(f,n);var b,l;var i=function(q,o){var p=o.children();var r=o.clone();r.children().each(function(s){a(this).width(p.eq(s).width())});return r};return this.each(function(){var o=a(this).dataTable();var q=(o.fnSettings().aaSortingFixed==null?new Array():o.fnSettings().aaSortingFixed);q.push([k.iIndexColumn,"asc"]);o.fnSettings().aaSortingFixed=q;for(var p=0;p<o.fnSettings().aoColumns.length;p++){o.fnSettings().aoColumns[p].bSortable=false}o.fnDraw();a("tbody",o).disableSelection().sortable({cursor:"move",helper:i,update:function(r,s){o.trigger("change")}})})}})(jQuery);(function(d,c,a){var b=function(f,e){if(!this instanceof b){alert("Scroller warning: Scroller must be initialised with the 'new' keyword.");return}if(typeof e=="undefined"){e={}}this.s={dt:f,tableTop:0,tableBottom:0,redrawTop:0,redrawBottom:0,rowHeight:null,autoHeight:true,viewportHeight:0,viewportRows:0,stateTO:null,drawTO:null};this.s=d.extend(this.s,b.oDefaults,e);this.dom={force:a.createElement("div"),scroller:null,table:null};this.s.dt.oScroller=this;this._fnConstruct()};b.prototype={fnRowToPixels:function(e){return e*this.s.rowHeight},fnPixelsToRow:function(e){return parseInt(e/this.s.rowHeight,10)},fnScrollToRow:function(g,f){var e=this.fnRowToPixels(g);if(typeof f=="undefined"||f){d(this.dom.scroller).animate({scrollTop:e})}else{d(this.dom.scroller).scrollTop(e)}},fnMeasure:function(e){if(this.s.autoHeight){this._fnCalcRowHeight()}this.s.viewportHeight=d(this.dom.scroller).height();this.s.viewportRows=parseInt(this.s.viewportHeight/this.s.rowHeight,10)+1;this.s.dt._iDisplayLength=this.s.viewportRows*this.s.displayBuffer;if(this.s.trace){console.log("Row height: "+this.s.rowHeight+" Viewport height: "+this.s.viewportHeight+" Viewport rows: "+this.s.viewportRows+" Display rows: "+this.s.dt._iDisplayLength)}if(typeof e=="undefined"||e){this.s.dt.oInstance.fnDraw()}},_fnConstruct:function(){var e=this;this.dom.force.style.position="absolute";this.dom.force.style.top="0px";this.dom.force.style.left="0px";this.dom.force.style.width="1px";this.dom.scroller=d("div."+this.s.dt.oClasses.sScrollBody,this.s.dt.nTableWrapper)[0];this.dom.scroller.appendChild(this.dom.force);this.dom.scroller.style.position="relative";this.dom.table=d(">table",this.dom.scroller)[0];this.dom.table.style.position="absolute";this.dom.table.style.top="0px";this.dom.table.style.left="0px";d(this.s.dt.nTableWrapper).addClass("DTS");if(this.s.loadingIndicator){d(this.dom.scroller.parentNode).css("position","relative").append('<div class="DTS_Loading">'+this.s.dt.oLanguage.sLoadingRecords+"</div>")}if(this.s.rowHeight&&this.s.rowHeight!="auto"){this.s.autoHeight=false}this.fnMeasure(false);d(this.dom.scroller).scroll(function(){e._fnScroll.call(e)});d(this.dom.scroller).bind("touchstart",function(){e._fnScroll.call(e)});this.s.dt.aoDrawCallback.push({fn:function(){if(e.s.dt.bInitialised){e._fnDrawCallback.call(e)}},sName:"Scroller"});this.s.dt.oApi._fnCallbackReg(this.s.dt,"aoStateSaveParams",function(f,g){g.iScroller=e.dom.scroller.scrollTop},"Scroller_State")},_fnScroll:function(){var g=this,f=this.dom.scroller.scrollTop,h;if(this.s.dt.bFiltered||this.s.dt.bSorted){return}if(this.s.trace){console.log("Scroll: "+f+"px - boundaries: "+this.s.redrawTop+" / "+this.s.redrawBottom+".  Showing rows "+this.fnPixelsToRow(f)+" to "+this.fnPixelsToRow(f+d(this.dom.scroller).height())+" in the viewport, with rows "+this.s.dt._iDisplayStart+" to "+(this.s.dt._iDisplayEnd)+" rendered by the DataTable")}this._fnInfo();clearTimeout(this.s.stateTO);this.s.stateTO=setTimeout(function(){g.s.dt.oApi._fnSaveState(g.s.dt)},250);if(f<this.s.redrawTop||f>this.s.redrawBottom){var e=((this.s.displayBuffer-1)/2)*this.s.viewportRows;h=parseInt(f/this.s.rowHeight,10)-e;if(h<0){h=0}else{if(h+this.s.dt._iDisplayLength>this.s.dt.fnRecordsDisplay()){h=this.s.dt.fnRecordsDisplay()-this.s.dt._iDisplayLength;if(h<0){h=0}}else{if(h%2!==0){h++}}}if(h!=this.s.dt._iDisplayStart){this.s.tableTop=d(this.s.dt.nTable).offset().top;this.s.tableBottom=d(this.s.dt.nTable).height()+this.s.tableTop;if(this.s.dt.oFeatures.bServerSide){clearTimeout(this.s.drawTO);this.s.drawTO=setTimeout(function(){g.s.dt._iDisplayStart=h;g.s.dt.oApi._fnCalculateEnd(g.s.dt);g.s.dt.oApi._fnDraw(g.s.dt)},this.s.serverWait)}else{this.s.dt._iDisplayStart=h;this.s.dt.oApi._fnCalculateEnd(this.s.dt);this.s.dt.oApi._fnDraw(this.s.dt)}if(this.s.trace){console.log("Scroll forcing redraw - top DT render row: "+h)}}}},_fnDrawCallback:function(){var g=this,e=this.dom.scroller.scrollTop,h=e+this.s.viewportHeight;this.dom.force.style.height=(this.s.rowHeight*this.s.dt.fnRecordsDisplay())+"px";
var f=(this.s.rowHeight*this.s.dt._iDisplayStart);if(this.s.dt._iDisplayStart===0){f=0}else{if(this.s.dt._iDisplayStart===this.s.dt.fnRecordsDisplay()-this.s.dt._iDisplayLength){f=this.s.rowHeight*this.s.dt._iDisplayStart}}this.dom.table.style.top=f+"px";this.s.tableTop=f;this.s.tableBottom=d(this.s.dt.nTable).height()+this.s.tableTop;this.s.redrawTop=e-((e-this.s.tableTop)*this.s.boundaryScale);this.s.redrawBottom=e+((this.s.tableBottom-h)*this.s.boundaryScale);if(this.s.trace){console.log("Table redraw. Table top: "+f+"px Table bottom: "+this.s.tableBottom+" Scroll boundary top: "+this.s.redrawTop+" Scroll boundary bottom: "+this.s.redrawBottom+" Rows drawn: "+this.s.dt._iDisplayLength)}setTimeout(function(){g._fnInfo.call(g)},0);if(this.s.dt.oFeatures.bStateSave&&this.s.dt.oLoadedState!==null&&typeof this.s.dt.oLoadedState.iScroller!="undefined"){if((this.s.dt.sAjaxSource!==null&&this.s.dt.iDraw==2)||(this.s.dt.sAjaxSource===null&&this.s.dt.iDraw==1)){setTimeout(function(){d(g.dom.scroller).scrollTop(g.s.dt.oLoadedState.iScroller);g.s.redrawTop=g.s.dt.oLoadedState.iScroller-(g.s.viewportHeight/2)},0)}}},_fnCalcRowHeight:function(){var f=this.s.dt.nTable.cloneNode(false);var e=d('<div class="'+this.s.dt.oClasses.sWrapper+' DTS"><div class="'+this.s.dt.oClasses.sScrollWrapper+'"><div class="'+this.s.dt.oClasses.sScrollBody+'"></div></div></div>')[0];d(f).append("<tbody><tr><td>&nbsp;</td></tr></tbody>");d("div."+this.s.dt.oClasses.sScrollBody,e).append(f);a.body.appendChild(e);this.s.rowHeight=d("tbody tr",f).outerHeight();a.body.removeChild(e)},_fnInfo:function(){if(!this.s.dt.oFeatures.bInfo){return}var f=this.s.dt,l=this.dom.scroller.scrollTop,e=this.fnPixelsToRow(l)+1,m=f.fnRecordsTotal(),r=f.fnRecordsDisplay(),o=this.fnPixelsToRow(l+d(this.dom.scroller).height()),u=r<o?r:o,g=f.fnFormatNumber(e),k=f.fnFormatNumber(u),t=f.fnFormatNumber(m),s=f.fnFormatNumber(r),q;if(f.fnRecordsDisplay()===0&&f.fnRecordsDisplay()==f.fnRecordsTotal()){q=f.oLanguage.sInfoEmpty+f.oLanguage.sInfoPostFix}else{if(f.fnRecordsDisplay()===0){q=f.oLanguage.sInfoEmpty+" "+f.oLanguage.sInfoFiltered.replace("_MAX_",t)+f.oLanguage.sInfoPostFix}else{if(f.fnRecordsDisplay()==f.fnRecordsTotal()){q=f.oLanguage.sInfo.replace("_START_",g).replace("_END_",k).replace("_TOTAL_",s)+f.oLanguage.sInfoPostFix}else{q=f.oLanguage.sInfo.replace("_START_",g).replace("_END_",k).replace("_TOTAL_",s)+" "+f.oLanguage.sInfoFiltered.replace("_MAX_",f.fnFormatNumber(f.fnRecordsTotal()))+f.oLanguage.sInfoPostFix}}}var j=f.aanFeatures.i;if(typeof j!="undefined"){for(var p=0,h=j.length;p<h;p++){d(j[p]).html(q)}}}};b.oDefaults={trace:false,rowHeight:"auto",serverWait:200,displayBuffer:9,boundaryScale:0.5,loadingIndicator:false};b.prototype.CLASS="Scroller";b.VERSION="1.1.0";b.prototype.VERSION=b.VERSION;if(typeof d.fn.dataTable=="function"&&typeof d.fn.dataTableExt.fnVersionCheck=="function"&&d.fn.dataTableExt.fnVersionCheck("1.9.0")){d.fn.dataTableExt.aoFeatures.push({fnInit:function(g){var f=(typeof g.oInit.oScroller=="undefined")?{}:g.oInit.oScroller;var e=new b(g,f);return e.dom.wrapper},cFeature:"S",sFeature:"Scroller"})}else{alert("Warning: Scroller requires DataTables 1.9.0 or greater - www.datatables.net/download")}d.fn.dataTable.Scroller=b})(jQuery,window,document);function mod_reorder_resize_tools(){function c(g){var e=g.dt.aoColumns;for(var f=0;f<e.length;f++){var h=e[f].nTh;if($(h).hasClass("fixed-at-beginning-of-table")){g._fixed_start_columns_end_index=f}if($(h).hasClass("fixed-at-end-of-table")){g._fixed_end_columns_start_index=f;break}}}function b(e,g){var f=e.fnSettings().aoColumns;return $(f[g].nTh).hasClass("non-compressible")}function a(e){var f=e.fnSettings().aoColumns;for(var g=0;g<f.length;g++){if(g===f.length-1||b(e,g)){$(f[g].nTh).addClass("no-column-width-handle")}}}function d(k){var l=$(k.nTableWrapper).find(".dataTables_scrollHead table th");var e=$(k.nTableWrapper).find(".dataTables_scrollBody table th");if(l.length===0||e.length===0){return}var h=l.map(function(){return $(this).outerWidth()}).get();for(var f=0;f<e.length-1;f++){var g=$(e[f]);var j=g.innerWidth()-g.width();g.width(Math.max(h[f]-j,0))}}return{update_fixed_indexes:c,update_resize_handles:a,is_column_non_compressible:b,synchronize_scroller_body_to_head:d}}(function(f,d,a){function e(k){var j=[];for(var h=0,g=k.length;h<g;h++){j[k[h]]=h}return j}function c(h,j,i){var g=h.splice(j,1)[0];h.splice(i,0,g)}function b(k,n,m){var j=[];for(var h=0,g=k.childNodes.length;h<g;h++){if(k.childNodes[h].nodeType==1){j.push(k.childNodes[h])}}var l=j[n];if(m!==null){k.insertBefore(l,j[m])}else{k.appendChild(l)}}f.fn.dataTableExt.oApi.fnColReorder=function(k,g,r){var o,l,n,u,v=k.aoColumns.length,t,m;if(g==r){return}if(g<0||g>=v){this.oApi._fnLog(k,1,"ColReorder 'from' index is out of bounds: "+g);return}if(r<0||r>=v){this.oApi._fnLog(k,1,"ColReorder 'to' index is out of bounds: "+r);return}var q=[];for(o=0,l=v;o<l;o++){q[o]=o}c(q,g,r);var s=e(q);for(o=0,l=k.aaSorting.length;o<l;o++){k.aaSorting[o][0]=s[k.aaSorting[o][0]]}if(k.aaSortingFixed!==null){for(o=0,l=k.aaSortingFixed.length;o<l;o++){k.aaSortingFixed[o][0]=s[k.aaSortingFixed[o][0]]}}for(o=0,l=v;o<l;o++){m=k.aoColumns[o];for(n=0,u=m.aDataSort.length;n<u;n++){m.aDataSort[n]=s[m.aDataSort[n]]}}for(o=0,l=v;o<l;o++){m=k.aoColumns[o];if(typeof m.mData=="number"){m.mData=s[m.mData];m.fnGetData=k.oApi._fnGetObjectDataFn(m.mData);m.fnSetData=k.oApi._fnSetObjectDataFn(m.mData)}}if(k.aoColumns[g].bVisible){var h=this.oApi._fnColumnIndexToVisible(k,g);var p=null;o=r<g?r:r+1;while(p===null&&o<v){p=this.oApi._fnColumnIndexToVisible(k,o);o++}t=k.nTHead.getElementsByTagName("tr");for(o=0,l=t.length;o<l;o++){b(t[o],h,p)}if(k.nTFoot!==null){t=k.nTFoot.getElementsByTagName("tr");for(o=0,l=t.length;o<l;o++){b(t[o],h,p)}}for(o=0,l=k.aoData.length;o<l;o++){if(k.aoData[o].nTr!==null){b(k.aoData[o].nTr,h,p)}}}c(k.aoColumns,g,r);c(k.aoPreSearchCols,g,r);for(o=0,l=k.aoData.length;o<l;o++){if(f.isArray(k.aoData[o]._aData)){c(k.aoData[o]._aData,g,r)}c(k.aoData[o]._anHidden,g,r)}for(o=0,l=k.aoHeader.length;o<l;o++){c(k.aoHeader[o],g,r)}if(k.aoFooter!==null){for(o=0,l=k.aoFooter.length;o<l;o++){c(k.aoFooter[o],g,r)}}for(o=0,l=v;o<l;o++){k.aoColumns[o].aDataSort=[o];k.aoColumns[o]._ColReorder_iOrigCol=o;f(k.aoColumns[o].nTh).unbind("click");this.oApi._fnSortAttachListener(k,k.aoColumns[o].nTh,o)}if(typeof ColVis!="undefined"){ColVis.fnRebuild(k.oInstance)}f(k.oInstance).trigger("column-reorder",[k,{iFrom:g,iTo:r,aiInvertMapping:s}]);if(typeof k.oInstance._oPluginFixedHeader!="undefined"){k.oInstance._oPluginFixedHeader.fnUpdate()}};ColReorder=function(h,g){if(!this.CLASS||this.CLASS!="ColReorder"){alert("Warning: ColReorder must be initialised with the keyword 'new'")}if(typeof g=="undefined"){g={}}this.s={dt:null,init:g,allowReorder:true,allowResize:true,fixed:0,dropCallback:null,mouse:{startX:-1,startY:-1,offsetX:-1,offsetY:-1,target:-1,targetIndex:-1,fromIndex:-1},aoTargets:[]};this.dom={drag:null,resize:null,pointer:null};this.table_size=-1;this.s.dt=h.oInstance.fnSettings();this._fnConstruct();h.oApi._fnCallbackReg(h,"aoDestroyCallback",jQuery.proxy(this._fnDestroy,this),"ColReorder");ColReorder.aoInstances.push(this);return this};ColReorder.prototype={fnReset:function(){var h=[];for(var j=0,g=this.s.dt.aoColumns.length;
j<g;j++){h.push(this.s.dt.aoColumns[j]._ColReorder_iOrigCol)}this._fnOrderColumns(h)},_fnConstruct:function(){var m=this;var l,g;mod_reorder_resize_tools().update_fixed_indexes(this.s);if(typeof this.s.init.allowReorder!="undefined"){this.s.allowReorder=this.s.init.allowReorder}if(typeof this.s.init.allowResize!="undefined"){this.s.allowResize=this.s.init.allowResize}if(typeof this.s.init.iFixedColumns!="undefined"){this.s.fixed=this.s.init.iFixedColumns}if(typeof this.s.init.fnReorderCallback!="undefined"){this.s.dropCallback=this.s.init.fnReorderCallback}for(l=0,g=this.s.dt.aoColumns.length;l<g;l++){if(l>this.s.fixed-1){this._fnMouseListener(l,this.s.dt.aoColumns[l].nTh)}this.s.dt.aoColumns[l]._ColReorder_iOrigCol=l}this.s.dt.oApi._fnCallbackReg(this.s.dt,"aoStateSaveParams",function(i,n){m._fnStateSave.call(m,n)},"ColReorder_State");var h=null;if(typeof this.s.init.aiOrder!="undefined"){h=this.s.init.aiOrder.slice()}if(this.s.dt.oLoadedState&&typeof this.s.dt.oLoadedState.ColReorder!="undefined"&&this.s.dt.oLoadedState.ColReorder.length==this.s.dt.aoColumns.length){h=this.s.dt.oLoadedState.ColReorder}if(h){if(!m.s.dt._bInitComplete){var k=false;this.s.dt.aoDrawCallback.push({fn:function(){if(!m.s.dt._bInitComplete&&!k){k=true;var i=e(h);m._fnOrderColumns.call(m,i)}},sName:"ColReorder_Pre"})}else{var j=e(h);m._fnOrderColumns.call(m,j)}}},_fnOrderColumns:function(h){if(h.length!=this.s.dt.aoColumns.length){this.s.dt.oInstance.oApi._fnLog(oDTSettings,1,"ColReorder - array reorder does not match known number of columns. Skipping.");return}for(var j=0,g=h.length;j<g;j++){var k=f.inArray(j,h);if(j!=k){c(h,k,j);this.s.dt.oInstance.fnColReorder(k,j)}}if(this.s.dt.oScroll.sX!==""||this.s.dt.oScroll.sY!==""){this.s.dt.oInstance.fnAdjustColumnSizing()}this.s.dt.oInstance.oApi._fnSaveState(this.s.dt)},_fnStateSave:function(h){var j,g,k,l;var m=this.s.dt;for(j=0;j<h.aaSorting.length;j++){h.aaSorting[j][0]=m.aoColumns[h.aaSorting[j][0]]._ColReorder_iOrigCol}aSearchCopy=f.extend(true,[],h.aoSearchCols);h.ColReorder=[];for(j=0,g=m.aoColumns.length;j<g;j++){l=m.aoColumns[j]._ColReorder_iOrigCol;h.aoSearchCols[l]=aSearchCopy[j];h.abVisCols[l]=m.aoColumns[j].bVisible;h.ColReorder.push(l)}},_fnMouseListener:function(g,m){var k=this;f(m).unbind("mousemove.ColReorder");f(m).unbind("mousedown.ColReorder");var j=true;if(!(this.s.allowResize)){j=false}else{if(g===this.s.dt.aoColumns.length-1){j=false}else{if(f(this.s.dt.aoColumns[g].nTh).hasClass("non-compressible")){j=false}}}if(j){f(m).bind("mousemove.ColReorder",function(o){if(k.dom.drag===null&&k.dom.resize===null){var i=o.target.nodeName=="TH"?o.target:f(o.target).parents("TH")[0];var p=f(i).offset();var n=f(i).innerWidth();if(Math.abs(o.pageX-Math.round(p.left+n))<=5){f(i).css({cursor:"col-resize"})}else{f(i).css({cursor:"pointer"})}}})}var h=this.s._fixed_start_columns_end_index;if(isNaN(h)){h=-1}var l=this.s._fixed_end_columns_start_index;if(isNaN(l)){l=this.s.dt.aoColumns.length}if(g<l&&g>h){f(m).bind("mousedown.ColReorder",function(i){k._fnMouseDown.call(k,i,m,g);return false})}},_fnMouseDown:function(o,g,m){var n=this,q=this.s.dt.aoColumns;if(f(g).css("cursor")=="col-resize"){this.s.mouse.startX=o.pageX;this.s.mouse.startWidth=f(g).width();this.s.mouse.resizeElem=f(g);var h=f(g).next();this.s.mouse.nextStartWidth=f(h).width();n.dom.resize=true;this.s.dt.aoColumns[m].bSortable=false;this.s.dt.oFeatures.bAutoWidth=false}else{if(this.s.allowReorder){n.dom.resize=null;var p=o.target.nodeName=="TH"?o.target:f(o.target).parents("TH")[0];var l=f(p).offset();this.s.mouse.startX=o.pageX;this.s.mouse.startY=o.pageY;this.s.mouse.offsetX=o.pageX-l.left;this.s.mouse.offsetY=o.pageY-l.top;this.s.mouse.target=g;this.s.mouse.targetIndex=f("th",g.parentNode).index(g);this.s.mouse.fromIndex=this.s.dt.oInstance.oApi._fnVisibleToColumnIndex(this.s.dt,this.s.mouse.targetIndex);this.s.aoTargets.splice(0,this.s.aoTargets.length);this.s.aoTargets.push({x:f(this.s.dt.nTable).offset().left,to:0});var k=0;for(var m=0,j=q.length;
m<j;m++){if(m!=this.s.mouse.fromIndex){k++}if(q[m].bVisible){this.s.aoTargets.push({x:f(q[m].nTh).offset().left+f(q[m].nTh).outerWidth(),to:k})}}if(this.s.fixed!==0){this.s.aoTargets.splice(0,this.s.fixed)}}}f(a).bind("mousemove.ColReorder",function(i){n._fnMouseMove.call(n,i,m)});f(a).bind("mouseup.ColReorder",function(i){setTimeout(function(){n._fnMouseUp.call(n,i,m)},10)})},_fnMouseMove:function(s,q){var r=this;var k;k=(typeof(this.s.dt.oInit.sScrollX)!=="string"||this.s.dt.oInit.sScrollX==="")?false:true;if(this.table_size<0&&k&&f("div.dataTables_scrollHead",this.s.dt.nTableWrapper)!=undefined){if(f("div.dataTables_scrollHead",this.s.dt.nTableWrapper).length>0){this.table_size=f(f("div.dataTables_scrollHead",this.s.dt.nTableWrapper)[0].childNodes[0].childNodes[0]).width()}}if(this.dom.resize){var h=this.s.mouse.resizeElem;var j=f(h).next();var t=s.pageX-this.s.mouse.startX;if(t!==0&&!k){f(j).width(this.s.mouse.nextStartWidth-t)}f(h).width(this.s.mouse.startWidth+t);if(k&&f("div.dataTables_scrollHead",this.s.dt.nTableWrapper)!=undefined){if(f("div.dataTables_scrollHead",this.s.dt.nTableWrapper).length>0){f(f("div.dataTables_scrollHead",this.s.dt.nTableWrapper)[0].childNodes[0].childNodes[0]).width(this.table_size+t)}}var o;if(f("div.dataTables_scrollBody")!=null){if(f("div.dataTables_scrollBody").length>0){var g;o=-1;for(g=-1;g<this.s.dt.aoColumns.length-1&&g!=q;g++){if(this.s.dt.aoColumns[g+1].bVisible){o++}}tableScroller=f("div.dataTables_scrollBody",this.s.dt.nTableWrapper)[0];scrollingTableHead=f(tableScroller)[0].childNodes[0].childNodes[0].childNodes[0];if(t!=0&&!k){f(f(scrollingTableHead)[0].childNodes[o+1]).width(this.s.mouse.nextStartWidth-t)}f(f(scrollingTableHead)[0].childNodes[o]).width(this.s.mouse.startWidth+t);if(k){f(f(tableScroller)[0].childNodes[0]).width(this.table_size+t)}}}return}else{if(this.s.allowReorder){if(this.dom.drag===null){if(Math.pow(Math.pow(s.pageX-this.s.mouse.startX,2)+Math.pow(s.pageY-this.s.mouse.startY,2),0.5)<5){return}this._fnCreateDragNode()}this.dom.drag.style.left=(s.pageX-this.s.mouse.offsetX)+"px";this.dom.drag.style.top=(s.pageY-this.s.mouse.offsetY)+"px";var n=false;var l=this.s.aoTargets.length-1;var m=-1;if(typeof(this.s._fixed_end_columns_start_index)==="number"){l=this.s._fixed_end_columns_start_index}if(typeof(this.s._fixed_start_columns_end_index)==="number"){m=this.s._fixed_start_columns_end_index}for(var p=m+2;p<=l;p++){if(s.pageX<this.s.aoTargets[p-1].x+((this.s.aoTargets[p].x-this.s.aoTargets[p-1].x)/2)){this.dom.pointer.style.left=this.s.aoTargets[p-1].x+"px";this.s.mouse.toIndex=this.s.aoTargets[p-1].to;n=true;break}}if(!n){this.dom.pointer.style.left=this.s.aoTargets[l].x+"px";this.s.mouse.toIndex=this.s.aoTargets[l].to}}}},_fnMouseUp:function(o,k){var n=this;f(a).unbind("mousemove.ColReorder");f(a).unbind("mouseup.ColReorder");if(this.dom.drag!==null){a.body.removeChild(this.dom.drag);a.body.removeChild(this.dom.pointer);this.dom.drag=null;this.dom.pointer=null;this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex,this.s.mouse.toIndex);if(this.s.dt.oScroll.sX!==""||this.s.dt.oScroll.sY!==""){this.s.dt.oInstance.fnAdjustColumnSizing()}if(this.s.dropCallback!==null){this.s.dropCallback.call(this)}mod_reorder_resize_tools().synchronize_scroller_body_to_head(this.s.dt);this._fnConstruct();this.s.dt.oInstance.oApi._fnSaveState(this.s.dt)}else{if(this.dom.resize!==null){var l;var h;var p;var m;var q;var g;this.s.dt.aoColumns[k].bSortable=true;this.s.dt.aoColumns[k].sWidth=f(this.s.mouse.resizeElem).innerWidth()+"px";g=this.s.dt.oInit.sScrollX===""?false:true;if(!g){for(m=k+1;m<this.s.dt.aoColumns.length;m++){if(this.s.dt.aoColumns[m].bVisible){break}}for(q=k-1;q>=0;q--){if(this.s.dt.aoColumns[q].bVisible){break}}if(this.s.dt.aoColumns.length>m){this.s.dt.aoColumns[m].sWidth=f(this.s.mouse.resizeElem).next().innerWidth()+"px"}else{p=this.s.mouse.resizeElem;for(l=q;l>0;l--){if(this.s.dt.aoColumns[l].bVisible){p=f(p).prev();this.s.dt.aoColumns[l].sWidth=f(p).innerWidth()+"px"
}}}}if(g&&f("div.dataTables_scrollHead",this.s.dt.nTableWrapper)!=undefined){if(f("div.dataTables_scrollHead",this.s.dt.nTableWrapper).length>0){this.table_size=f(f("div.dataTables_scrollHead",this.s.dt.nTableWrapper)[0].childNodes[0].childNodes[0]).width()}}mod_reorder_resize_tools().synchronize_scroller_body_to_head(this.s.dt);this.s.dt.oInstance.oApi._fnSaveState(this.s.dt)}}this.dom.resize=null},_fnCreateDragNode:function(){var g=this;this.dom.drag=f(this.s.dt.nTHead.parentNode).clone(true)[0];this.dom.drag.className+=" DTCR_clonedTable";while(this.dom.drag.getElementsByTagName("caption").length>0){this.dom.drag.removeChild(this.dom.drag.getElementsByTagName("caption")[0])}while(this.dom.drag.getElementsByTagName("tbody").length>0){this.dom.drag.removeChild(this.dom.drag.getElementsByTagName("tbody")[0])}while(this.dom.drag.getElementsByTagName("tfoot").length>0){this.dom.drag.removeChild(this.dom.drag.getElementsByTagName("tfoot")[0])}f("thead tr:eq(0)",this.dom.drag).each(function(){f("th:not(:eq("+g.s.mouse.targetIndex+"))",this).remove()});f("tr",this.dom.drag).height(f("tr:eq(0)",g.s.dt.nTHead).height());f("thead tr:gt(0)",this.dom.drag).remove();f("thead th:eq(0)",this.dom.drag).each(function(h){this.style.width=f("th:eq("+g.s.mouse.targetIndex+")",g.s.dt.nTHead).width()+"px"});this.dom.drag.style.position="absolute";this.dom.drag.style.zIndex=1200;this.dom.drag.style.top="0px";this.dom.drag.style.left="0px";this.dom.drag.style.width=f("th:eq("+g.s.mouse.targetIndex+")",g.s.dt.nTHead).outerWidth()+"px";this.dom.pointer=a.createElement("div");this.dom.pointer.className="DTCR_pointer";this.dom.pointer.style.position="absolute";if(this.s.dt.oScroll.sX===""&&this.s.dt.oScroll.sY===""){this.dom.pointer.style.top=f(this.s.dt.nTable).offset().top+"px";this.dom.pointer.style.height=f(this.s.dt.nTable).height()+"px"}else{this.dom.pointer.style.top=f("div.dataTables_scroll",this.s.dt.nTableWrapper).offset().top+"px";this.dom.pointer.style.height=f("div.dataTables_scroll",this.s.dt.nTableWrapper).height()+"px"}a.body.appendChild(this.dom.pointer);a.body.appendChild(this.dom.drag)},_fnDestroy:function(){for(var h=0,g=ColReorder.aoInstances.length;h<g;h++){if(ColReorder.aoInstances[h]===this){ColReorder.aoInstances.splice(h,1);break}}f(this.s.dt.nTHead).find("*").unbind(".ColReorder");this.s.dt.oInstance._oPluginColReorder=null;this.s=null}};ColReorder.aoInstances=[];ColReorder.fnReset=function(h){for(var j=0,g=ColReorder.aoInstances.length;j<g;j++){if(ColReorder.aoInstances[j].s.dt.oInstance==h){ColReorder.aoInstances[j].fnReset()}}};ColReorder.prototype.CLASS="ColReorder";ColReorder.VERSION="1.0.7";ColReorder.prototype.VERSION=ColReorder.VERSION;if(typeof f.fn.dataTable=="function"&&typeof f.fn.dataTableExt.fnVersionCheck=="function"&&f.fn.dataTableExt.fnVersionCheck("1.9.3")){f.fn.dataTableExt.aoFeatures.push({fnInit:function(i){var g=i.oInstance;if(typeof g._oPluginColReorder=="undefined"){var h=typeof i.oInit.oColReorder!="undefined"?i.oInit.oColReorder:{};g._oPluginColReorder=new ColReorder(i,h)}else{g.oApi._fnLog(i,1,"ColReorder attempted to initialise twice. Ignoring second")}return null},cFeature:"R",sFeature:"ColReorder"})}else{alert("Warning: ColReorder requires DataTables 1.9.3 or greater - www.datatables.net/download")}})(jQuery,window,document);$.fn.dataTableExt.oApi.fnGetTds=function(c,g){var e=[];var j=[];var k=0;var d,f,b;var h=(typeof g=="object")?c.oApi._fnNodeToDataIndex(c,g):g;var a=c.aoData[h];if(a===undefined){return null}var i=c.aoData[h].nTr;for(f=0,b=i.childNodes.length;f<b;f++){d=i.childNodes[f];if(d.nodeName.toUpperCase()=="TD"){j.push(d)}}for(f=0,b=c.aoColumns.length;f<b;f++){if(c.aoColumns[f].bVisible){e.push(j[f-k])}else{e.push(c.aoData[h]._anHidden[f]);k++}}return e};function mod_column_autowidth(){var f=mod_reorder_resize_tools();var e=0.5;Array.max=function(h){return Math.max.apply(Math,h)};Array.min=function(h){return Math.min.apply(Math,h)};function d(h){var j=h.fnSettings().aoColumns;for(var k=0;k<j.length;k++){var m=j[k].nTh;if($(m).hasClass("action-column")){continue}$(m).css("width","")}var l=h.fnSettings();$(l.nTableWrapper).find(".dataTables_scrollBody table th").css("width","");$(l.nTableWrapper).find(".dataTables_scrollBody").css("width","");$(l.nTableWrapper).find(".dataTables_scrollBody table").css("width","");$(l.nTableWrapper).find(".dataTables_scrollHeadInner").css("width","");$(l.nTableWrapper).find(".dataTables_scrollHeadInner").css("padding","");$(l.nTableWrapper).find(".dataTables_scrollHeadInner table").css("width","");$(l.nTableWrapper).css("width","")}function a(j){var k=parseInt($(j).data("displaypriority"),10);var i=$(j).data("displaypriority_override");var h=10;if(typeof(i)!=="number"){i=parseInt(i)}if(!(isNaN(i))){h=i}else{if(!(isNaN(k))){h=k}}return h}function c(j,m){var l={};for(var k=0;k<m.length;k++){if(f.is_column_non_compressible(j,k)){continue}var h=a(m[k]);if(l[h]===undefined){l[h]=[k]}else{l[h].push(k)}}return l}function g(){var h,i;h=$('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo("body");i=h.children();width=i.innerWidth()-i.height(99).innerWidth();h.remove();return width}function b(X){var R=[];var h=X.fnSettings().aoColumns;for(var U=0;U<h.length;U++){R.push(h[U].nTh)}var N=X.fnSettings().fnRecordsTotal();var K={};for(var U=0;U<h.length;U++){if(K[U]===undefined){K[U]=[h[U].nTh]}else{K[U].push(h[U].nTh)}}for(var O=0;O<Math.min(N,10);O++){var v=X.fnGetTds(O);if(!(Array.isArray(v))){continue}for(var U=0;U<v.length;U++){if(K[U]===undefined){K[U]=[v[U]]}else{K[U].push(v[U])}}}var D=R.length;if(D===0){return}var j=X.__cached_content_widths_per_column;if(!(Array.isArray(j))){j=[]}var G=X.__cached_spacing_widths_per_column;if(!(Array.isArray(G))){G=[]}var u=X.width();var H=c(X,R);var J=[];$.each(H,function(i,k){if(typeof(i)==="string"){J.push(parseInt(i))}else{J.push(i)}});J.sort(function(k,i){return i-k});var x=[];var C=0;var Y=-1;if(true){var I=X.find("tr:first-child > td:first-child");var W=I.css("font-family");var B=I.css("font-size");var l=I.css("font-style");var w=$("<div>content</div>").css({position:"absolute","float":"left","white-space":"nowrap",visibility:"hidden",font_family:W,"font-size":B,"font-style":l,display:"none"}).appendTo($("body"));for(var U=0;U<D;U++){var t=K[U];j[U]=Array.max($(t).map(function(){var i=w.html($(this).html()).width();return i}).get());G[U]=Array.max($(t).map(function(){var k=$(this).innerWidth()-$(this).width();var i=Math.ceil(($(this).outerWidth()-$(this).innerWidth())/2);return i+k}).get());var z=j[U]+G[U];if(f.is_column_non_compressible(X,U)){x.push(U);C+=z}else{if(H[0]===undefined||H[0].indexOf(U)===-1){Y=U}}}w.remove();X.__cached_content_widths_per_column=j;X.__cached_spacing_widths_per_column=G}var V=Array.max(G);for(var U=0;U<D;U++){if(h[U].bVisible===false){G[U]=V}}var T=[];var q=D-x.length;var s=-1;if(q!==0){var L=Math.floor((u-C)/q);for(var S=0;S<J.length;S++){var o=J[S];var P=H[o];for(var Q=0;Q<P.length;Q++){var E=P[Q];if(o===0){T.push(E);if(Y===E){Y=-1}continue}if(x.indexOf(E)!==-1){continue}var n=j[E]+G[E];var A=e*n;if(n<=L){C+=n;x.push(E)}else{if(S!==0&&L<A){T.push(E);if(Y===E){Y=-1}}else{s=E}}}}}if(s!==-1){Y=s}else{if(Y===-1){Y=0}}var M=D-x.length-T.length;var y=u-C;var F=0;if(M!==0){F=Math.floor(y/M)}var p=[];for(var U=0;U<D;U++){if(T.indexOf(U)!==-1){continue
}var n=j[U]+G[U];if(x.indexOf(U)!==-1){p[U]=n}else{p[U]=Math.max(F-G[U],0)}}$(R).each(function(i,k){if(T.indexOf(i)!==-1){X.fnSetColumnVis(i,false,false)}else{if(i!==Y){X.fnSetColumnVis(i,true,false);$(k).width(p[i])}else{X.fnSetColumnVis(i,true,false)}}})}return{remove_column_widths:d,adjust_columns_to_tablewidth:b}};(function(ba){function a9(e,d,f){switch(arguments.length){case 2:return null!=e?e:d;case 3:return null!=e?e:null!=d?d:f;default:throw new Error("Implement me")}}function a8(d,c){return b5.call(d,c)}function a7(){return{empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1}}function a4(b){b3.suppressDeprecationWarnings===!1&&"undefined"!=typeof console&&console.warn&&console.warn("Deprecation warning: "+b)}function a3(e,d){var f=!0;return aS(function(){return f&&(a4(e),f=!1),d.apply(this,arguments)},d)}function a1(d,c){ax[d]||(a4(c),ax[d]=!0)}function a0(d,c){return function(a){return aO(d.call(this,a),c)}}function aZ(d,c){return function(a){return this.localeData().ordinal(d.call(this,a),c)}}function aW(){}function aV(d,c){c!==!1&&bH(d),aR(this,d),this._d=new Date(+d._d)}function aT(v){var u=aE(v),t=u.year||0,s=u.quarter||0,r=u.month||0,q=u.week||0,p=u.day||0,o=u.hour||0,n=u.minute||0,m=u.second||0,l=u.millisecond||0;this._milliseconds=+l+1000*m+60000*n+3600000*o,this._days=+p+7*q,this._months=+r+3*s+12*t,this._data={},this._locale=b3.localeData(),this._bubble()}function aS(e,c){for(var f in c){a8(c,f)&&(e[f]=c[f])}return a8(c,"toString")&&(e.toString=c.toString),a8(c,"valueOf")&&(e.valueOf=c.valueOf),e}function aR(g,f){var j,i,h;if("undefined"!=typeof f._isAMomentObject&&(g._isAMomentObject=f._isAMomentObject),"undefined"!=typeof f._i&&(g._i=f._i),"undefined"!=typeof f._f&&(g._f=f._f),"undefined"!=typeof f._l&&(g._l=f._l),"undefined"!=typeof f._strict&&(g._strict=f._strict),"undefined"!=typeof f._tzm&&(g._tzm=f._tzm),"undefined"!=typeof f._isUTC&&(g._isUTC=f._isUTC),"undefined"!=typeof f._offset&&(g._offset=f._offset),"undefined"!=typeof f._pf&&(g._pf=f._pf),"undefined"!=typeof f._locale&&(g._locale=f._locale),b1.length>0){for(j in b1){i=b1[j],h=f[i],"undefined"!=typeof h&&(g[i]=h)}}return g}function aP(b){return 0>b?Math.ceil(b):Math.floor(b)}function aO(g,f,j){for(var i=""+Math.abs(g),h=g>=0;i.length<f;){i="0"+i}return(h?j?"+":"":"-")+i}function aM(e,d){var f={milliseconds:0,months:0};return f.months=d.month()-e.month()+12*(d.year()-e.year()),e.clone().add(f.months,"M").isAfter(d)&&--f.months,f.milliseconds=+d-+e.clone().add(f.months,"M"),f}function aL(e,d){var f;return d=bz(d,e),e.isBefore(d)?f=aM(e,d):(f=aM(d,e),f.milliseconds=-f.milliseconds,f.months=-f.months),f}function aK(d,c){return function(h,g){var b,a;return null===g||isNaN(+g)||(a1(c,"moment()."+c+"(period, number) is deprecated. Please use moment()."+c+"(number, period)."),a=h,h=g,g=a),h="string"==typeof h?+h:h,b=b3.duration(h,g),aJ(this,b,d),this}}function aJ(i,h,n,m){var l=h._milliseconds,k=h._days,j=h._months;m=null==m?!0:m,l&&i._d.setTime(+i._d+l*n),k&&b0(i,"Date",ce(i,"Date")+k*n),j&&aj(i,ce(i,"Month")+j*n),m&&b3.updateOffset(i,k||j)}function aI(b){return"[object Array]"===Object.prototype.toString.call(b)}function aH(b){return"[object Date]"===Object.prototype.toString.call(b)||b instanceof Date}function aG(i,h,n){var m,l=Math.min(i.length,h.length),k=Math.abs(i.length-h.length),j=0;for(m=0;l>m;m++){(n&&i[m]!==h[m]||!n&&bQ(i[m])!==bQ(h[m]))&&j++}return j+k}function aF(d){if(d){var c=d.toLowerCase().replace(/(.)s$/,"$1");d=aU[d]||au[c]||c}return d}function aE(f){var c,h,g={};for(h in f){a8(f,h)&&(c=aF(h),c&&(g[c]=f[h]))}return g}function aC(a){var f,e;if(0===a.indexOf("week")){f=7,e="day"}else{if(0!==a.indexOf("month")){return}f=12,e="month"}b3[a]=function(m,l){var k,d,c=b3._locale[a],b=[];if("number"==typeof m&&(l=m,m=ba),d=function(h){var g=b3().utc().set(e,h);return c.call(b3._locale,g,m||"")},null!=l){return d(l)}for(k=0;f>k;k++){b.push(d(k))}return b}}function bQ(e){var d=+e,f=0;return 0!==d&&isFinite(d)&&(f=d>=0?Math.floor(d):Math.ceil(d)),f}function bO(d,c){return new Date(Date.UTC(d,c+1,0)).getUTCDate()}function bN(e,d,f){return bX(b3([e,11,31+d-f]),d,f).week}function bM(b){return bK(b)?366:365}function bK(b){return b%4===0&&b%100!==0||b%400===0}function bH(d){var c;
d._a&&-2===d._pf.overflow&&(c=d._a[ca]<0||d._a[ca]>11?ca:d._a[bY]<1||d._a[bY]>bO(d._a[bS],d._a[ca])?bY:d._a[bB]<0||d._a[bB]>23?bB:d._a[aY]<0||d._a[aY]>59?aY:d._a[aw]<0||d._a[aw]>59?aw:d._a[ak]<0||d._a[ak]>999?ak:-1,d._pf._overflowDayOfYear&&(bS>c||c>bY)&&(c=bY),d._pf.overflow=c)}function bG(b){return null==b._isValid&&(b._isValid=!isNaN(b._d.getTime())&&b._pf.overflow<0&&!b._pf.empty&&!b._pf.invalidMonth&&!b._pf.nullInput&&!b._pf.invalidFormat&&!b._pf.userInvalidated,b._strict&&(b._isValid=b._isValid&&0===b._pf.charsLeftOver&&0===b._pf.unusedTokens.length)),b._isValid}function bE(b){return b?b.toLowerCase().replace("_","-"):b}function bD(h){for(var g,l,k,j,i=0;i<h.length;){for(j=bE(h[i]).split("-"),g=j.length,l=bE(h[i+1]),l=l?l.split("-"):null;g>0;){if(k=bC(j.slice(0,g).join("-"))){return k}if(l&&l.length>=g&&aG(j,l,!0)>=g-1){break}g--}i++}return null}function bC(e){var d=null;if(!cf[e]&&bJ){try{d=b3.locale(),require("./locale/"+e),b3.locale(d)}catch(f){}}return cf[e]}function bz(d,c){return c._isUTC?b3(d).zone(c._offset||0):b3(d).local()}function by(b){return b.match(/\[[\s\S]/)?b.replace(/^\[|\]$/g,""):b.replace(/\\/g,"")}function bw(f){var e,h,g=f.match(ch);for(e=0,h=g.length;h>e;e++){g[e]=a2[g[e]]?a2[g[e]]:by(g[e])}return function(b){var a="";for(e=0;h>e;e++){a+=g[e] instanceof Function?g[e].call(b,f):g[e]}return a}}function bv(d,c){return d.isValid()?(c=bu(c,d.localeData()),ai[c]||(ai[c]=bw(c)),ai[c](d)):d.localeData().invalidDate()}function bu(f,e){function h(b){return e.longDateFormat(b)||b}var g=5;for(b4.lastIndex=0;g>=0&&b4.test(f);){f=f.replace(b4,h),b4.lastIndex=0,g-=1}return f}function bt(f,e){var h,g=e._strict;switch(f){case"Q":return ae;case"DDDD":return bL;case"YYYY":case"GGGG":case"gggg":return g?af:aB;case"Y":case"G":case"g":return bq;case"YYYYYY":case"YYYYY":case"GGGGG":case"ggggg":return g?bU:ap;case"S":if(g){return ae}case"SS":if(g){return b7}case"SSS":if(g){return bL}case"DDD":return be;case"MMM":case"MMMM":case"dd":case"ddd":case"dddd":return b6;case"a":case"A":return e._locale._meridiemParse;case"X":return aD;case"Z":case"ZZ":return bT;case"T":return bg;case"SSSS":return ad;case"MM":case"DD":case"YY":case"GG":case"gg":case"HH":case"hh":case"mm":case"ss":case"ww":case"WW":return g?b7:bR;case"M":case"D":case"d":case"H":case"h":case"m":case"s":case"w":case"W":case"e":case"E":return bR;case"Do":return aq;default:return h=new RegExp(bi(bj(f.replace("\\","")),"i"))}}function br(g){g=g||"";var f=g.match(bT)||[],j=f[f.length-1]||[],i=(j+"").match(bW)||["-",0,0],h=+(60*i[1])+bQ(i[2]);return"+"===i[0]?-h:h}function bp(g,f,j){var i,h=j._a;switch(g){case"Q":null!=f&&(h[ca]=3*(bQ(f)-1));break;case"M":case"MM":null!=f&&(h[ca]=bQ(f)-1);break;case"MMM":case"MMMM":i=j._locale.monthsParse(f),null!=i?h[ca]=i:j._pf.invalidMonth=f;break;case"D":case"DD":null!=f&&(h[bY]=bQ(f));break;case"Do":null!=f&&(h[bY]=bQ(parseInt(f,10)));break;case"DDD":case"DDDD":null!=f&&(j._dayOfYear=bQ(f));break;case"YY":h[bS]=b3.parseTwoDigitYear(f);break;case"YYYY":case"YYYYY":case"YYYYYY":h[bS]=bQ(f);break;case"a":case"A":j._isPm=j._locale.isPM(f);break;case"H":case"HH":case"h":case"hh":h[bB]=bQ(f);break;case"m":case"mm":h[aY]=bQ(f);break;case"s":case"ss":h[aw]=bQ(f);break;case"S":case"SS":case"SSS":case"SSSS":h[ak]=bQ(1000*("0."+f));break;case"X":j._d=new Date(1000*parseFloat(f));break;case"Z":case"ZZ":j._useUTC=!0,j._tzm=br(f);break;case"dd":case"ddd":case"dddd":i=j._locale.weekdaysParse(f),null!=i?(j._w=j._w||{},j._w.d=i):j._pf.invalidWeekday=f;break;case"w":case"ww":case"W":case"WW":case"d":case"e":case"E":g=g.substr(0,1);case"gggg":case"GGGG":case"GGGGG":g=g.substr(0,2),f&&(j._w=j._w||{},j._w[g]=bQ(f));break;case"gg":case"GG":j._w=j._w||{},j._w[g]=b3.parseTwoDigitYear(f)}}function bo(b){var p,o,n,m,l,k,j;p=b._w,null!=p.GG||null!=p.W||null!=p.E?(l=1,k=4,o=a9(p.GG,b._a[bS],bX(b3(),1,4).year),n=a9(p.W,1),m=a9(p.E,1)):(l=b._locale._week.dow,k=b._locale._week.doy,o=a9(p.gg,b._a[bS],bX(b3(),l,k).year),n=a9(p.w,1),null!=p.d?(m=p.d,l>m&&++n):m=null!=p.e?p.e+l:l),j=bA(o,n,m,k,l),b._a[bS]=j.year,b._dayOfYear=j.dayOfYear
}function bn(b){var l,k,j,i,h=[];if(!b._d){for(j=bl(b),b._w&&null==b._a[bY]&&null==b._a[ca]&&bo(b),b._dayOfYear&&(i=a9(b._a[bS],j[bS]),b._dayOfYear>bM(i)&&(b._pf._overflowDayOfYear=!0),k=aQ(i,0,b._dayOfYear),b._a[ca]=k.getUTCMonth(),b._a[bY]=k.getUTCDate()),l=0;3>l&&null==b._a[l];++l){b._a[l]=h[l]=j[l]}for(;7>l;l++){b._a[l]=h[l]=null==b._a[l]?2===l?1:0:b._a[l]}b._d=(b._useUTC?aQ:bs).apply(null,h),null!=b._tzm&&b._d.setUTCMinutes(b._d.getUTCMinutes()+b._tzm)}}function bm(d){var c;d._d||(c=aE(d._i),d._a=[c.year,c.month,c.day,c.hour,c.minute,c.second,c.millisecond],bn(d))}function bl(d){var c=new Date;return d._useUTC?[c.getUTCFullYear(),c.getUTCMonth(),c.getUTCDate()]:[c.getFullYear(),c.getMonth(),c.getDate()]}function bk(r){if(r._f===b3.ISO_8601){return void b2(r)}r._a=[],r._pf.empty=!0;var q,p,o,n,m,l=""+r._i,k=l.length,j=0;for(o=bu(r._f,r._locale).match(ch)||[],q=0;q<o.length;q++){n=o[q],p=(l.match(bt(n,r))||[])[0],p&&(m=l.substr(0,l.indexOf(p)),m.length>0&&r._pf.unusedInput.push(m),l=l.slice(l.indexOf(p)+p.length),j+=p.length),a2[n]?(p?r._pf.empty=!1:r._pf.unusedTokens.push(n),bp(n,p,r)):r._strict&&!p&&r._pf.unusedTokens.push(n)}r._pf.charsLeftOver=k-j,l.length>0&&r._pf.unusedInput.push(l),r._isPm&&r._a[bB]<12&&(r._a[bB]+=12),r._isPm===!1&&12===r._a[bB]&&(r._a[bB]=0),bn(r),bH(r)}function bj(b){return b.replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(g,f,j,i,h){return f||j||i||h})}function bi(b){return b.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function bh(h){var d,l,k,j,i;if(0===h._f.length){return h._pf.invalidFormat=!0,void (h._d=new Date(0/0))}for(j=0;j<h._f.length;j++){i=0,d=aR({},h),d._pf=a7(),d._f=h._f[j],bk(d),bG(d)&&(i+=d._pf.charsLeftOver,i+=10*d._pf.unusedTokens.length,d._pf.score=i,(null==k||k>i)&&(k=i,l=d))}aS(h,l||d)}function b2(g){var f,j,i=g._i,h=aN.exec(i);if(h){for(g._pf.iso=!0,f=0,j=ag.length;j>f;f++){if(ag[f][1].exec(i)){g._f=ag[f][0]+(h[6]||" ");break}}for(f=0,j=b8.length;j>f;f++){if(b8[f][1].exec(i)){g._f+=b8[f][0];break}}i.match(bT)&&(g._f+="Z"),bk(g)}else{g._isValid=!1}}function bf(b){b2(b),b._isValid===!1&&(delete b._isValid,b3.createFromInputFallback(b))}function bV(a){var f,e=a._i;e===ba?a._d=new Date:aH(e)?a._d=new Date(+e):null!==(f=a6.exec(e))?a._d=new Date(+f[1]):"string"==typeof e?bf(a):aI(e)?(a._a=e.slice(0),bn(a)):"object"==typeof e?bm(a):"number"==typeof e?a._d=new Date(e):b3.createFromInputFallback(a)}function bs(j,i,p,o,n,m,l){var k=new Date(j,i,p,o,n,m,l);return 1970>j&&k.setFullYear(j),k}function aQ(d){var c=new Date(Date.UTC.apply(null,arguments));return 1970>d&&c.setUTCFullYear(d),c}function at(d,c){if("string"==typeof d){if(isNaN(d)){if(d=c.weekdaysParse(d),"number"!=typeof d){return null}}else{d=parseInt(d,10)}}return d}function ah(g,f,j,i,h){return h.relativeTime(f||1,!!j,g,i)}function b9(v,u,t){var s=b3.duration(v).abs(),r=aa(s.as("s")),q=aa(s.as("m")),p=aa(s.as("h")),o=aa(s.as("d")),n=aa(s.as("M")),m=aa(s.as("y")),l=r<cd.s&&["s",r]||1===q&&["m"]||q<cd.m&&["mm",q]||1===p&&["h"]||p<cd.h&&["hh",p]||1===o&&["d"]||o<cd.d&&["dd",o]||1===n&&["M"]||n<cd.M&&["MM",n]||1===m&&["y"]||["yy",m];return l[2]=u,l[3]=+v>0,l[4]=t,ah.apply({},l)}function bX(h,g,l){var k,j=l-g,i=l-h.day();return i>j&&(i-=7),j-7>i&&(i+=7),k=b3(h).add(i,"d"),{week:Math.ceil(k.dayOfYear()/7),year:k.year()}}function bA(j,i,p,o,n){var m,l,k=aQ(j,0,1).getUTCDay();return k=0===k?7:k,p=null!=p?p:n,m=n-k+(k>o?7:0)-(n>k?7:0),l=7*(i-1)+(p-n)+m+1,{year:l>0?j:j-1,dayOfYear:l>0?l:bM(j-1)+l}}function aX(a){var f=a._i,e=a._f;return a._locale=a._locale||b3.localeData(a._l),null===f||e===ba&&""===f?b3.invalid({nullInput:!0}):("string"==typeof f&&(a._i=f=a._locale.preparse(f)),b3.isMoment(f)?new aV(f,!0):(e?aI(e)?bh(a):bk(a):bV(a),new aV(a)))}function av(f,e){var h,g;if(1===e.length&&aI(e[0])&&(e=e[0]),!e.length){return b3()}for(h=e[0],g=1;g<e.length;++g){e[g][f](h)&&(h=e[g])}return h}function aj(e,d){var f;return"string"==typeof d&&(d=e.localeData().monthsParse(d),"number"!=typeof d)?e:(f=Math.min(e.date(),bO(e.year(),d)),e._d["set"+(e._isUTC?"UTC":"")+"Month"](d,f),e)
}function ce(d,c){return d._d["get"+(d._isUTC?"UTC":"")+c]()}function b0(e,d,f){return"Month"===d?aj(e,f):e._d["set"+(e._isUTC?"UTC":"")+d](f)}function bI(d,c){return function(a){return null!=a?(b0(this,d,a),b3.updateOffset(this,c),this):ce(this,d)}}function a5(b){return 400*b/146097}function ay(b){return 146097*b/400}function am(b){b3.duration.fn[b]=function(){return this._data[b]}}function cg(b){"undefined"==typeof ender&&(bP=ao.moment,ao.moment=b?a3("Accessing Moment through the global scope is deprecated, and will be removed in an upcoming release.",b3):b3)}for(var b3,bP,bd,aA="2.8.2",ao="undefined"!=typeof global?global:this,aa=Math.round,b5=Object.prototype.hasOwnProperty,bS=0,ca=1,bY=2,bB=3,aY=4,aw=5,ak=6,cf={},b1=[],bJ="undefined"!=typeof module&&module.exports,a6=/^\/?Date\((\-?\d+)/i,az=/(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,an=/^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/,ch=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|X|zz?|ZZ?|.)/g,b4=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,bR=/\d\d?/,be=/\d{1,3}/,aB=/\d{1,4}/,ap=/[+\-]?\d{1,6}/,ad=/\d+/,b6=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,bT=/Z|[\+\-]\d\d:?\d\d/gi,bg=/T/i,aD=/[\+\-]?\d+(\.\d{1,3})?/,aq=/\d{1,2}/,ae=/\d/,b7=/\d\d/,bL=/\d{3}/,af=/\d{4}/,bU=/[+-]?\d{6}/,bq=/[+-]?\d+/,aN=/^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,ar="YYYY-MM-DDTHH:mm:ssZ",ag=[["YYYYYY-MM-DD",/[+-]\d{6}-\d{2}-\d{2}/],["YYYY-MM-DD",/\d{4}-\d{2}-\d{2}/],["GGGG-[W]WW-E",/\d{4}-W\d{2}-\d/],["GGGG-[W]WW",/\d{4}-W\d{2}/],["YYYY-DDD",/\d{4}-\d{3}/]],b8=[["HH:mm:ss.SSSS",/(T| )\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],bW=/([\+\-]|\d\d)/gi,bx=("Date|Hours|Minutes|Seconds|Milliseconds".split("|"),{Milliseconds:1,Seconds:1000,Minutes:60000,Hours:3600000,Days:86400000,Months:2592000000,Years:31536000000}),aU={ms:"millisecond",s:"second",m:"minute",h:"hour",d:"day",D:"date",w:"week",W:"isoWeek",M:"month",Q:"quarter",y:"year",DDD:"dayOfYear",e:"weekday",E:"isoWeekday",gg:"weekYear",GG:"isoWeekYear"},au={dayofyear:"dayOfYear",isoweekday:"isoWeekday",isoweek:"isoWeek",weekyear:"weekYear",isoweekyear:"isoWeekYear"},ai={},cd={s:45,m:45,h:22,d:26,M:11},bZ="DDD w W M D d".split(" "),bF="M D H h m s w W".split(" "),a2={M:function(){return this.month()+1},MMM:function(b){return this.localeData().monthsShort(this,b)},MMMM:function(b){return this.localeData().months(this,b)},D:function(){return this.date()},DDD:function(){return this.dayOfYear()},d:function(){return this.day()},dd:function(b){return this.localeData().weekdaysMin(this,b)},ddd:function(b){return this.localeData().weekdaysShort(this,b)},dddd:function(b){return this.localeData().weekdays(this,b)},w:function(){return this.week()},W:function(){return this.isoWeek()},YY:function(){return aO(this.year()%100,2)},YYYY:function(){return aO(this.year(),4)},YYYYY:function(){return aO(this.year(),5)},YYYYYY:function(){var d=this.year(),c=d>=0?"+":"-";return c+aO(Math.abs(d),6)},gg:function(){return aO(this.weekYear()%100,2)},gggg:function(){return aO(this.weekYear(),4)},ggggg:function(){return aO(this.weekYear(),5)},GG:function(){return aO(this.isoWeekYear()%100,2)},GGGG:function(){return aO(this.isoWeekYear(),4)},GGGGG:function(){return aO(this.isoWeekYear(),5)},e:function(){return this.weekday()},E:function(){return this.isoWeekday()},a:function(){return this.localeData().meridiem(this.hours(),this.minutes(),!0)},A:function(){return this.localeData().meridiem(this.hours(),this.minutes(),!1)},H:function(){return this.hours()},h:function(){return this.hours()%12||12},m:function(){return this.minutes()},s:function(){return this.seconds()},S:function(){return bQ(this.milliseconds()/100)
},SS:function(){return aO(bQ(this.milliseconds()/10),2)},SSS:function(){return aO(this.milliseconds(),3)},SSSS:function(){return aO(this.milliseconds(),3)},Z:function(){var d=-this.zone(),c="+";return 0>d&&(d=-d,c="-"),c+aO(bQ(d/60),2)+":"+aO(bQ(d)%60,2)},ZZ:function(){var d=-this.zone(),c="+";return 0>d&&(d=-d,c="-"),c+aO(bQ(d/60),2)+aO(bQ(d)%60,2)},z:function(){return this.zoneAbbr()},zz:function(){return this.zoneName()},X:function(){return this.unix()},Q:function(){return this.quarter()}},ax={},al=["months","monthsShort","weekdays","weekdaysShort","weekdaysMin"];bZ.length;){bd=bZ.pop(),a2[bd+"o"]=aZ(a2[bd],bd)}for(;bF.length;){bd=bF.pop(),a2[bd+bd]=a0(a2[bd],2)}a2.DDDD=a0(a2.DDD,3),aS(aW.prototype,{set:function(e){var d,f;for(f in e){d=e[f],"function"==typeof d?this[f]=d:this["_"+f]=d}},_months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),months:function(b){return this._months[b.month()]},_monthsShort:"Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),monthsShort:function(b){return this._monthsShort[b.month()]},monthsParse:function(f){var e,h,g;for(this._monthsParse||(this._monthsParse=[]),e=0;12>e;e++){if(this._monthsParse[e]||(h=b3.utc([2000,e]),g="^"+this.months(h,"")+"|^"+this.monthsShort(h,""),this._monthsParse[e]=new RegExp(g.replace(".",""),"i")),this._monthsParse[e].test(f)){return e}}},_weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),weekdays:function(b){return this._weekdays[b.day()]},_weekdaysShort:"Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),weekdaysShort:function(b){return this._weekdaysShort[b.day()]},_weekdaysMin:"Su_Mo_Tu_We_Th_Fr_Sa".split("_"),weekdaysMin:function(b){return this._weekdaysMin[b.day()]},weekdaysParse:function(f){var e,h,g;for(this._weekdaysParse||(this._weekdaysParse=[]),e=0;7>e;e++){if(this._weekdaysParse[e]||(h=b3([2000,1]).day(e),g="^"+this.weekdays(h,"")+"|^"+this.weekdaysShort(h,"")+"|^"+this.weekdaysMin(h,""),this._weekdaysParse[e]=new RegExp(g.replace(".",""),"i")),this._weekdaysParse[e].test(f)){return e}}},_longDateFormat:{LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY LT",LLLL:"dddd, MMMM D, YYYY LT"},longDateFormat:function(d){var c=this._longDateFormat[d];return !c&&this._longDateFormat[d.toUpperCase()]&&(c=this._longDateFormat[d.toUpperCase()].replace(/MMMM|MM|DD|dddd/g,function(b){return b.slice(1)}),this._longDateFormat[d]=c),c},isPM:function(b){return"p"===(b+"").toLowerCase().charAt(0)},_meridiemParse:/[ap]\.?m?\.?/i,meridiem:function(e,d,f){return e>11?f?"pm":"PM":f?"am":"AM"},_calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},calendar:function(e,d){var f=this._calendar[e];return"function"==typeof f?f.apply(d):f},_relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},relativeTime:function(g,f,j,i){var h=this._relativeTime[j];return"function"==typeof h?h(g,f,j,i):h.replace(/%d/i,g)},pastFuture:function(e,d){var f=this._relativeTime[e>0?"future":"past"];return"function"==typeof f?f(d):f.replace(/%s/i,d)},ordinal:function(b){return this._ordinal.replace("%d",b)},_ordinal:"%d",preparse:function(b){return b},postformat:function(b){return b},week:function(b){return bX(b,this._week.dow,this._week.doy).week},_week:{dow:0,doy:6},_invalidDate:"Invalid date",invalidDate:function(){return this._invalidDate}}),b3=function(a,j,i,h){var d;return"boolean"==typeof i&&(h=i,i=ba),d={},d._isAMomentObject=!0,d._i=a,d._f=j,d._l=i,d._strict=h,d._isUTC=!1,d._pf=a7(),aX(d)},b3.suppressDeprecationWarnings=!1,b3.createFromInputFallback=a3("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.",function(b){b._d=new Date(b._i)
}),b3.min=function(){var b=[].slice.call(arguments,0);return av("isBefore",b)},b3.max=function(){var b=[].slice.call(arguments,0);return av("isAfter",b)},b3.utc=function(a,j,i,h){var d;return"boolean"==typeof i&&(h=i,i=ba),d={},d._isAMomentObject=!0,d._useUTC=!0,d._isUTC=!0,d._l=i,d._i=a,d._f=j,d._strict=h,d._pf=a7(),aX(d).utc()},b3.unix=function(b){return b3(1000*b)},b3.duration=function(j,c){var p,o,n,m,l=j,k=null;return b3.isDuration(j)?l={ms:j._milliseconds,d:j._days,M:j._months}:"number"==typeof j?(l={},c?l[c]=j:l.milliseconds=j):(k=az.exec(j))?(p="-"===k[1]?-1:1,l={y:0,d:bQ(k[bY])*p,h:bQ(k[bB])*p,m:bQ(k[aY])*p,s:bQ(k[aw])*p,ms:bQ(k[ak])*p}):(k=an.exec(j))?(p="-"===k[1]?-1:1,n=function(e){var d=e&&parseFloat(e.replace(",","."));return(isNaN(d)?0:d)*p},l={y:n(k[2]),M:n(k[3]),d:n(k[4]),h:n(k[5]),m:n(k[6]),s:n(k[7]),w:n(k[8])}):"object"==typeof l&&("from" in l||"to" in l)&&(m=aL(b3(l.from),b3(l.to)),l={},l.ms=m.milliseconds,l.M=m.months),o=new aT(l),b3.isDuration(j)&&a8(j,"_locale")&&(o._locale=j._locale),o},b3.version=aA,b3.defaultFormat=ar,b3.ISO_8601=function(){},b3.momentProperties=b1,b3.updateOffset=function(){},b3.relativeTimeThreshold=function(a,d){return cd[a]===ba?!1:d===ba?cd[a]:(cd[a]=d,!0)},b3.lang=a3("moment.lang is deprecated. Use moment.locale instead.",function(d,c){return b3.locale(d,c)}),b3.locale=function(e,d){var f;return e&&(f="undefined"!=typeof d?b3.defineLocale(e,d):b3.localeData(e),f&&(b3.duration._locale=b3._locale=f)),b3._locale._abbr},b3.defineLocale=function(d,c){return null!==c?(c.abbr=d,cf[d]||(cf[d]=new aW),cf[d].set(c),b3.locale(d),cf[d]):(delete cf[d],null)},b3.langData=a3("moment.langData is deprecated. Use moment.localeData instead.",function(b){return b3.localeData(b)}),b3.localeData=function(d){var c;if(d&&d._locale&&d._locale._abbr&&(d=d._locale._abbr),!d){return b3._locale}if(!aI(d)){if(c=bC(d)){return c}d=[d]}return bD(d)},b3.isMoment=function(b){return b instanceof aV||null!=b&&a8(b,"_isAMomentObject")},b3.isDuration=function(b){return b instanceof aT};for(bd=al.length-1;bd>=0;--bd){aC(al[bd])}b3.normalizeUnits=function(b){return aF(b)},b3.invalid=function(d){var c=b3.utc(0/0);return null!=d?aS(c._pf,d):c._pf.userInvalidated=!0,c},b3.parseZone=function(){return b3.apply(null,arguments).parseZone()},b3.parseTwoDigitYear=function(b){return bQ(b)+(bQ(b)>68?1900:2000)},aS(b3.fn=aV.prototype,{clone:function(){return b3(this)},valueOf:function(){return +this._d+60000*(this._offset||0)},unix:function(){return Math.floor(+this/1000)},toString:function(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},toDate:function(){return this._offset?new Date(+this):this._d},toISOString:function(){var b=b3(this).utc();return 0<b.year()&&b.year()<=9999?bv(b,"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]"):bv(b,"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")},toArray:function(){var b=this;return[b.year(),b.month(),b.date(),b.hours(),b.minutes(),b.seconds(),b.milliseconds()]},isValid:function(){return bG(this)},isDSTShifted:function(){return this._a?this.isValid()&&aG(this._a,(this._isUTC?b3.utc(this._a):b3(this._a)).toArray())>0:!1},parsingFlags:function(){return aS({},this._pf)},invalidAt:function(){return this._pf.overflow},utc:function(b){return this.zone(0,b)},local:function(b){return this._isUTC&&(this.zone(0,b),this._isUTC=!1,b&&this.add(this._d.getTimezoneOffset(),"m")),this},format:function(d){var c=bv(this,d||b3.defaultFormat);return this.localeData().postformat(c)},add:aK(1,"add"),subtract:aK(-1,"subtract"),diff:function(i,h,n){var m,l,k=bz(i,this),j=60000*(this.zone()-k.zone());return h=aF(h),"year"===h||"month"===h?(m=43200000*(this.daysInMonth()+k.daysInMonth()),l=12*(this.year()-k.year())+(this.month()-k.month()),l+=(this-b3(this).startOf("month")-(k-b3(k).startOf("month")))/m,l-=60000*(this.zone()-b3(this).startOf("month").zone()-(k.zone()-b3(k).startOf("month").zone()))/m,"year"===h&&(l/=12)):(m=this-k,l="second"===h?m/1000:"minute"===h?m/60000:"hour"===h?m/3600000:"day"===h?(m-j)/86400000:"week"===h?(m-j)/604800000:m),n?l:aP(l)
},from:function(d,c){return b3.duration({to:this,from:d}).locale(this.locale()).humanize(!c)},fromNow:function(b){return this.from(b3(),b)},calendar:function(g){var f=g||b3(),j=bz(f,this).startOf("day"),i=this.diff(j,"days",!0),h=-6>i?"sameElse":-1>i?"lastWeek":0>i?"lastDay":1>i?"sameDay":2>i?"nextDay":7>i?"nextWeek":"sameElse";return this.format(this.localeData().calendar(h,this))},isLeapYear:function(){return bK(this.year())},isDST:function(){return this.zone()<this.clone().month(0).zone()||this.zone()<this.clone().month(5).zone()},day:function(d){var c=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=d?(d=at(d,this.localeData()),this.add(d-c,"d")):c},month:bI("Month",!0),startOf:function(b){switch(b=aF(b)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===b?this.weekday(0):"isoWeek"===b&&this.isoWeekday(1),"quarter"===b&&this.month(3*Math.floor(this.month()/3)),this},endOf:function(b){return b=aF(b),this.startOf(b).add(1,"isoWeek"===b?"week":b).subtract(1,"ms")},isAfter:function(d,c){return c="undefined"!=typeof c?c:"millisecond",+this.clone().startOf(c)>+b3(d).startOf(c)},isBefore:function(d,c){return c="undefined"!=typeof c?c:"millisecond",+this.clone().startOf(c)<+b3(d).startOf(c)},isSame:function(d,c){return c=c||"ms",+this.clone().startOf(c)===+bz(d,this).startOf(c)},min:a3("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(b){return b=b3.apply(null,arguments),this>b?this:b}),max:a3("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(b){return b=b3.apply(null,arguments),b>this?this:b}),zone:function(f,e){var h,g=this._offset||0;return null==f?this._isUTC?g:this._d.getTimezoneOffset():("string"==typeof f&&(f=br(f)),Math.abs(f)<16&&(f=60*f),!this._isUTC&&e&&(h=this._d.getTimezoneOffset()),this._offset=f,this._isUTC=!0,null!=h&&this.subtract(h,"m"),g!==f&&(!e||this._changeInProgress?aJ(this,b3.duration(g-f,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,b3.updateOffset(this,!0),this._changeInProgress=null)),this)},zoneAbbr:function(){return this._isUTC?"UTC":""},zoneName:function(){return this._isUTC?"Coordinated Universal Time":""},parseZone:function(){return this._tzm?this.zone(this._tzm):"string"==typeof this._i&&this.zone(this._i),this},hasAlignedHourOffset:function(b){return b=b?b3(b).zone():0,(this.zone()-b)%60===0},daysInMonth:function(){return bO(this.year(),this.month())},dayOfYear:function(d){var c=aa((b3(this).startOf("day")-b3(this).startOf("year"))/86400000)+1;return null==d?c:this.add(d-c,"d")},quarter:function(b){return null==b?Math.ceil((this.month()+1)/3):this.month(3*(b-1)+this.month()%3)},weekYear:function(d){var c=bX(this,this.localeData()._week.dow,this.localeData()._week.doy).year;return null==d?c:this.add(d-c,"y")},isoWeekYear:function(d){var c=bX(this,1,4).year;return null==d?c:this.add(d-c,"y")},week:function(d){var c=this.localeData().week(this);return null==d?c:this.add(7*(d-c),"d")},isoWeek:function(d){var c=bX(this,1,4).week;return null==d?c:this.add(7*(d-c),"d")},weekday:function(d){var c=(this.day()+7-this.localeData()._week.dow)%7;return null==d?c:this.add(d-c,"d")},isoWeekday:function(b){return null==b?this.day()||7:this.day(this.day()%7?b:b-7)},isoWeeksInYear:function(){return bN(this.year(),1,4)},weeksInYear:function(){var b=this.localeData()._week;return bN(this.year(),b.dow,b.doy)},get:function(b){return b=aF(b),this[b]()},set:function(d,c){return d=aF(d),"function"==typeof this[d]&&this[d](c),this},locale:function(a){return a===ba?this._locale._abbr:(this._locale=b3.localeData(a),this)},lang:a3("moment().lang() is deprecated. Use moment().localeData() instead.",function(a){return a===ba?this.localeData():(this._locale=b3.localeData(a),this)}),localeData:function(){return this._locale
}}),b3.fn.millisecond=b3.fn.milliseconds=bI("Milliseconds",!1),b3.fn.second=b3.fn.seconds=bI("Seconds",!1),b3.fn.minute=b3.fn.minutes=bI("Minutes",!1),b3.fn.hour=b3.fn.hours=bI("Hours",!0),b3.fn.date=bI("Date",!0),b3.fn.dates=a3("dates accessor is deprecated. Use date instead.",bI("Date",!0)),b3.fn.year=bI("FullYear",!0),b3.fn.years=a3("years accessor is deprecated. Use year instead.",bI("FullYear",!0)),b3.fn.days=b3.fn.day,b3.fn.months=b3.fn.month,b3.fn.weeks=b3.fn.week,b3.fn.isoWeeks=b3.fn.isoWeek,b3.fn.quarters=b3.fn.quarter,b3.fn.toJSON=b3.fn.toISOString,aS(b3.duration.fn=aT.prototype,{_bubble:function(){var j,i,p,o=this._milliseconds,n=this._days,m=this._months,l=this._data,k=0;l.milliseconds=o%1000,j=aP(o/1000),l.seconds=j%60,i=aP(j/60),l.minutes=i%60,p=aP(i/60),l.hours=p%24,n+=aP(p/24),k=aP(a5(n)),n-=aP(ay(k)),m+=aP(n/30),n%=30,k+=aP(m/12),m%=12,l.days=n,l.months=m,l.years=k},abs:function(){return this._milliseconds=Math.abs(this._milliseconds),this._days=Math.abs(this._days),this._months=Math.abs(this._months),this._data.milliseconds=Math.abs(this._data.milliseconds),this._data.seconds=Math.abs(this._data.seconds),this._data.minutes=Math.abs(this._data.minutes),this._data.hours=Math.abs(this._data.hours),this._data.months=Math.abs(this._data.months),this._data.years=Math.abs(this._data.years),this},weeks:function(){return aP(this.days()/7)},valueOf:function(){return this._milliseconds+86400000*this._days+this._months%12*2592000000+31536000000*bQ(this._months/12)},humanize:function(d){var c=b9(this,!d,this.localeData());return d&&(c=this.localeData().pastFuture(+this,c)),this.localeData().postformat(c)},add:function(e,d){var f=b3.duration(e,d);return this._milliseconds+=f._milliseconds,this._days+=f._days,this._months+=f._months,this._bubble(),this},subtract:function(e,d){var f=b3.duration(e,d);return this._milliseconds-=f._milliseconds,this._days-=f._days,this._months-=f._months,this._bubble(),this},get:function(b){return b=aF(b),this[b.toLowerCase()+"s"]()},as:function(e){var d,f;if(e=aF(e),d=this._days+this._milliseconds/86400000,"month"===e||"year"===e){return f=this._months+12*a5(d),"month"===e?f:f/12}switch(d+=ay(this._months/12),e){case"week":return d/7;case"day":return d;case"hour":return 24*d;case"minute":return 24*d*60;case"second":return 24*d*60*60;case"millisecond":return 24*d*60*60*1000;default:throw new Error("Unknown unit "+e)}},lang:b3.fn.lang,locale:b3.fn.locale,toIsoString:a3("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",function(){return this.toISOString()}),toISOString:function(){var h=Math.abs(this.years()),g=Math.abs(this.months()),l=Math.abs(this.days()),k=Math.abs(this.hours()),j=Math.abs(this.minutes()),i=Math.abs(this.seconds()+this.milliseconds()/1000);return this.asSeconds()?(this.asSeconds()<0?"-":"")+"P"+(h?h+"Y":"")+(g?g+"M":"")+(l?l+"D":"")+(k||j||i?"T":"")+(k?k+"H":"")+(j?j+"M":"")+(i?i+"S":""):"P0D"},localeData:function(){return this._locale}}),b3.duration.fn.toString=b3.duration.fn.toISOString;for(bd in bx){a8(bx,bd)&&am(bd.toLowerCase())}b3.duration.fn.asMilliseconds=function(){return this.as("ms")},b3.duration.fn.asSeconds=function(){return this.as("s")},b3.duration.fn.asMinutes=function(){return this.as("m")},b3.duration.fn.asHours=function(){return this.as("h")},b3.duration.fn.asDays=function(){return this.as("d")},b3.duration.fn.asWeeks=function(){return this.as("weeks")},b3.duration.fn.asMonths=function(){return this.as("M")},b3.duration.fn.asYears=function(){return this.as("y")},b3.locale("en",{ordinal:function(e){var d=e%10,f=1===bQ(e%100/10)?"th":1===d?"st":2===d?"nd":3===d?"rd":"th";return e+f}}),bJ?module.exports=b3:"function"==typeof define&&define.amd?(define("moment",function(e,d,f){return f.config&&f.config()&&f.config().noGlobal===!0&&(ao.moment=bP),b3}),cg(!0)):cg()}).call(this);!function(d,c){if("function"==typeof define&&define.amd){define(["jquery","moment"],c)}else{if("object"==typeof exports){c(require("jquery"),require("moment"))}else{if(!jQuery){throw new Error("bootstrap-datetimepicker requires jQuery to be loaded first")}if(!moment){throw new Error("bootstrap-datetimepicker requires moment.js to be loaded first")}c(d.jQuery,moment)}}}(this,function(f,e){if("undefined"==typeof e){throw new Error("momentjs is required")}var h=0,g=function(aG,aF){var aE,aD=f.fn.datetimepicker.defaults,aC={time:"glyphicon glyphicon-time",date:"glyphicon glyphicon-calendar",up:"glyphicon glyphicon-chevron-up",down:"glyphicon glyphicon-chevron-down"},aB=this,aA=!1,az=function(){var l,i,d=!1;if(aB.options=f.extend({},aD,aF),aB.options.icons=f.extend({},aC,aB.options.icons),aB.element=f(aG),ax(),!aB.options.pickTime&&!aB.options.pickDate){throw new Error("Must choose at least one picker")}if(aB.id=h++,e.locale(aB.options.language),aB.date=e(),aB.unset=!1,aB.isInput=aB.element.is("input"),aB.component=!1,aB.element.hasClass("input-group")&&(aB.component=aB.element.find(0===aB.element.find(".datepickerbutton").size()?'[class^="input-group-"]':".datepickerbutton")),aB.format=aB.options.format,l=e().localeData(),aB.format||(aB.format=aB.options.pickDate?l.longDateFormat("L"):"",aB.options.pickDate&&aB.options.pickTime&&(aB.format+=" "),aB.format+=aB.options.pickTime?l.longDateFormat("LT"):"",aB.options.useSeconds&&(-1!==l.longDateFormat("LT").indexOf(" A")?aB.format=aB.format.split(" A")[0]+":ss A":aB.format+=":ss")),aB.use24hours=aB.format.toLowerCase().indexOf("a")<0&&aB.format.indexOf("h")<0,aB.component&&(d=aB.component.find("span")),aB.options.pickTime&&d&&d.addClass(aB.options.icons.time),aB.options.pickDate&&d&&(d.removeClass(aB.options.icons.time),d.addClass(aB.options.icons.date)),aB.options.widgetParent="string"==typeof aB.options.widgetParent&&aB.options.widgetParent||aB.element.parents().filter(function(){return"scroll"===f(this).css("overflow-y")}).get(0)||"body",aB.widget=f(c()).appendTo(aB.options.widgetParent),aB.minViewMode=aB.options.minViewMode||0,"string"==typeof aB.minViewMode){switch(aB.minViewMode){case"months":aB.minViewMode=1;break;case"years":aB.minViewMode=2;break;default:aB.minViewMode=0}}if(aB.viewMode=aB.options.viewMode||0,"string"==typeof aB.viewMode){switch(aB.viewMode){case"months":aB.viewMode=1;break;case"years":aB.viewMode=2;break;default:aB.viewMode=0}}aB.viewMode=Math.max(aB.viewMode,aB.minViewMode),aB.options.disabledDates=U(aB.options.disabledDates),aB.options.enabledDates=U(aB.options.enabledDates),aB.startViewMode=aB.viewMode,aB.setMinDate(aB.options.minDate),aB.setMaxDate(aB.options.maxDate),ar(),aq(),ao(),an(),am(),at(),ae(),ay().prop("disabled")||ad(),""!==aB.options.defaultDate&&""===ay().val()&&aB.setValue(aB.options.defaultDate),1!==aB.options.minuteStepping&&(i=aB.options.minuteStepping,aB.date.minutes(Math.round(aB.date.minutes()/i)*i%60).seconds(0))},ay=function(){var d;if(aB.isInput){return aB.element}if(d=aB.element.find(".datepickerinput"),0===d.size()){d=aB.element.find("input")}else{if(!d.is("input")){throw new Error('CSS class "datepickerinput" cannot be applied to non input element')}}return d},ax=function(){var d;d=aB.element.is("input")?aB.element.data():aB.element.find("input").data(),void 0!==d.dateFormat&&(aB.options.format=d.dateFormat),void 0!==d.datePickdate&&(aB.options.pickDate=d.datePickdate),void 0!==d.datePicktime&&(aB.options.pickTime=d.datePicktime),void 0!==d.dateUseminutes&&(aB.options.useMinutes=d.dateUseminutes),void 0!==d.dateUseseconds&&(aB.options.useSeconds=d.dateUseseconds),void 0!==d.dateUsecurrent&&(aB.options.useCurrent=d.dateUsecurrent),void 0!==d.calendarWeeks&&(aB.options.calendarWeeks=d.calendarWeeks),void 0!==d.dateMinutestepping&&(aB.options.minuteStepping=d.dateMinutestepping),void 0!==d.dateMindate&&(aB.options.minDate=d.dateMindate),void 0!==d.dateMaxdate&&(aB.options.maxDate=d.dateMaxdate),void 0!==d.dateShowtoday&&(aB.options.showToday=d.dateShowtoday),void 0!==d.dateCollapse&&(aB.options.collapse=d.dateCollapse),void 0!==d.dateLanguage&&(aB.options.language=d.dateLanguage),void 0!==d.dateDefaultdate&&(aB.options.defaultDate=d.dateDefaultdate),void 0!==d.dateDisableddates&&(aB.options.disabledDates=d.dateDisableddates),void 0!==d.dateEnableddates&&(aB.options.enabledDates=d.dateEnableddates),void 0!==d.dateIcons&&(aB.options.icons=d.dateIcons),void 0!==d.dateUsestrict&&(aB.options.useStrict=d.dateUsestrict),void 0!==d.dateDirection&&(aB.options.direction=d.dateDirection),void 0!==d.dateSidebyside&&(aB.options.sideBySide=d.dateSidebyside),void 0!==d.dateDaysofweekdisabled&&(aB.options.daysOfWeekDisabled=d.dateDaysofweekdisabled)
},aw=function(){var i,l="absolute",k=aB.component?aB.component.offset():aB.element.offset(),j=f(window);aB.width=aB.component?aB.component.outerWidth():aB.element.outerWidth(),k.top=k.top+aB.element.outerHeight(),"up"===aB.options.direction?i="top":"bottom"===aB.options.direction?i="bottom":"auto"===aB.options.direction&&(i=k.top+aB.widget.height()>j.height()+j.scrollTop()&&aB.widget.height()+aB.element.outerHeight()<k.top?"top":"bottom"),"top"===i?(k.bottom=j.height()-k.top+aB.element.outerHeight()+3,aB.widget.addClass("top").removeClass("bottom")):(k.top+=1,aB.widget.addClass("bottom").removeClass("top")),void 0!==aB.options.width&&aB.widget.width(aB.options.width),"left"===aB.options.orientation&&(aB.widget.addClass("left-oriented"),k.left=k.left-aB.widget.width()+20),Z()&&(l="fixed",k.top-=j.scrollTop(),k.left-=j.scrollLeft()),j.width()<k.left+aB.widget.outerWidth()?(k.right=j.width()-k.left-aB.width,k.left="auto",aB.widget.addClass("pull-right")):(k.right="auto",aB.widget.removeClass("pull-right")),aB.widget.css("top"===i?{position:l,bottom:k.bottom,top:"auto",left:k.left,right:k.right}:{position:l,top:k.top,bottom:"auto",left:k.left,right:k.right})},av=function(d,i){(!e(aB.date).isSame(e(d))||aA)&&(aA=!1,aB.element.trigger({type:"dp.change",date:e(aB.date),oldDate:e(d)}),"change"!==i&&aB.element.change())},au=function(d){aA=!0,aB.element.trigger({type:"dp.error",date:e(d,aB.format,aB.options.useStrict)})},at=function(d){e.locale(aB.options.language);var i=d;i||(i=ay().val(),i&&(aB.date=e(i,aB.format,aB.options.useStrict)),aB.date||(aB.date=e())),aB.viewDate=e(aB.date).startOf("month"),ap(),al()},ar=function(){e.locale(aB.options.language);var k,j=f("<tr>"),i=e.weekdaysMin();if(aB.options.calendarWeeks===!0&&j.append('<th class="cw">#</th>'),0===e().localeData()._week.dow){for(k=0;7>k;k++){j.append('<th class="dow">'+i[k]+"</th>")}}else{for(k=1;8>k;k++){j.append(7===k?'<th class="dow">'+i[0]+"</th>":'<th class="dow">'+i[k]+"</th>")}}aB.widget.find(".datepicker-days thead").append(j)},aq=function(){e.locale(aB.options.language);var i,k="",j=e.monthsShort();for(i=0;12>i;i++){k+='<span class="month">'+j[i]+"</span>"}aB.widget.find(".datepicker-months td").append(k)},ap=function(){if(aB.options.pickDate){e.locale(aB.options.language);var H,G,F,E,D,C,B,A,z,y=aB.viewDate.year(),x=aB.viewDate.month(),w=aB.options.minDate.year(),v=aB.options.minDate.month(),u=aB.options.maxDate.year(),i=aB.options.maxDate.month(),J=[],I=e.months();for(aB.widget.find(".datepicker-days").find(".disabled").removeClass("disabled"),aB.widget.find(".datepicker-months").find(".disabled").removeClass("disabled"),aB.widget.find(".datepicker-years").find(".disabled").removeClass("disabled"),aB.widget.find(".datepicker-days th:eq(1)").text(I[x]+" "+y),G=e(aB.viewDate,aB.format,aB.options.useStrict).subtract(1,"months"),B=G.daysInMonth(),G.date(B).startOf("week"),(y===w&&v>=x||w>y)&&aB.widget.find(".datepicker-days th:eq(0)").addClass("disabled"),(y===u&&x>=i||y>u)&&aB.widget.find(".datepicker-days th:eq(2)").addClass("disabled"),F=e(G).add(42,"d");G.isBefore(F);){if(G.weekday()===e().startOf("week").weekday()&&(E=f("<tr>"),J.push(E),aB.options.calendarWeeks===!0&&E.append('<td class="cw">'+G.week()+"</td>")),D="",G.year()<y||G.year()===y&&G.month()<x?D+=" old":(G.year()>y||G.year()===y&&G.month()>x)&&(D+=" new"),G.isSame(e({y:aB.date.year(),M:aB.date.month(),d:aB.date.date()}))&&(D+=" active"),(W(G,"day")||!V(G))&&(D+=" disabled"),aB.options.showToday===!0&&G.isSame(e(),"day")&&(D+=" today"),aB.options.daysOfWeekDisabled){for(C=0;C<aB.options.daysOfWeekDisabled.length;C++){if(G.day()===aB.options.daysOfWeekDisabled[C]){D+=" disabled";break}}}E.append('<td class="day'+D+'">'+G.date()+"</td>"),H=G.date(),G.add(1,"d"),H===G.date()&&G.add(1,"d")}for(aB.widget.find(".datepicker-days tbody").empty().append(J),z=aB.date.year(),I=aB.widget.find(".datepicker-months").find("th:eq(1)").text(y).end().find("span").removeClass("active"),z===y&&I.eq(aB.date.month()).addClass("active"),w>y-1&&aB.widget.find(".datepicker-months th:eq(0)").addClass("disabled"),y+1>u&&aB.widget.find(".datepicker-months th:eq(2)").addClass("disabled"),C=0;
12>C;C++){y===w&&v>C||w>y?f(I[C]).addClass("disabled"):(y===u&&C>i||y>u)&&f(I[C]).addClass("disabled")}for(J="",y=10*parseInt(y/10,10),A=aB.widget.find(".datepicker-years").find("th:eq(1)").text(y+"-"+(y+9)).parents("table").find("td"),aB.widget.find(".datepicker-years").find("th").removeClass("disabled"),w>y&&aB.widget.find(".datepicker-years").find("th:eq(0)").addClass("disabled"),y+9>u&&aB.widget.find(".datepicker-years").find("th:eq(2)").addClass("disabled"),y-=1,C=-1;11>C;C++){J+='<span class="year'+(-1===C||10===C?" old":"")+(z===y?" active":"")+(w>y||y>u?" disabled":"")+'">'+y+"</span>",y+=1}A.html(J)}},ao=function(){e.locale(aB.options.language);var i,m,l,k=aB.widget.find(".timepicker .timepicker-hours table"),j="";if(k.parent().hide(),aB.use24hours){for(i=0,m=0;6>m;m+=1){for(j+="<tr>",l=0;4>l;l+=1){j+='<td class="hour">'+T(i.toString())+"</td>",i++}j+="</tr>"}}else{for(i=1,m=0;3>m;m+=1){for(j+="<tr>",l=0;4>l;l+=1){j+='<td class="hour">'+T(i.toString())+"</td>",i++}j+="</tr>"}}k.html(j)},an=function(){var j,i,n=aB.widget.find(".timepicker .timepicker-minutes table"),m="",l=0,k=aB.options.minuteStepping;for(n.parent().hide(),1===k&&(k=5),j=0;j<Math.ceil(60/k/4);j++){for(m+="<tr>",i=0;4>i;i+=1){60>l?(m+='<td class="minute">'+T(l.toString())+"</td>",l+=k):m+="<td></td>"}m+="</tr>"}n.html(m)},am=function(){var j,i,m=aB.widget.find(".timepicker .timepicker-seconds table"),l="",k=0;for(m.parent().hide(),j=0;3>j;j++){for(l+="<tr>",i=0;4>i;i+=1){l+='<td class="second">'+T(k.toString())+"</td>",k+=5}l+="</tr>"}m.html(l)},al=function(){if(aB.date){var i=aB.widget.find(".timepicker span[data-time-component]"),d=aB.date.hours(),j=aB.date.format("A");aB.use24hours||(0===d?d=12:12!==d&&(d%=12),aB.widget.find(".timepicker [data-action=togglePeriod]").text(j)),i.filter("[data-time-component=hours]").text(T(d)),i.filter("[data-time-component=minutes]").text(T(aB.date.minutes())),i.filter("[data-time-component=seconds]").text(T(aB.date.second()))}},ak=function(p){p.stopPropagation(),p.preventDefault(),aB.unset=!1;var o,n,m,l,k=f(p.target).closest("span, td, th"),i=e(aB.date);if(1===k.length&&!k.is(".disabled")){switch(k[0].nodeName.toLowerCase()){case"th":switch(k[0].className){case"picker-switch":ae(1);break;case"prev":case"next":m=b.modes[aB.viewMode].navStep,"prev"===k[0].className&&(m=-1*m),aB.viewDate.add(m,b.modes[aB.viewMode].navFnc),ap()}break;case"span":k.is(".month")?(o=k.parent().find("span").index(k),aB.viewDate.month(o)):(n=parseInt(k.text(),10)||0,aB.viewDate.year(n)),aB.viewMode===aB.minViewMode&&(aB.date=e({y:aB.viewDate.year(),M:aB.viewDate.month(),d:aB.viewDate.date(),h:aB.date.hours(),m:aB.date.minutes(),s:aB.date.seconds()}),Y(),av(i,p.type)),ae(-1),ap();break;case"td":k.is(".day")&&(l=parseInt(k.text(),10)||1,o=aB.viewDate.month(),n=aB.viewDate.year(),k.is(".old")?0===o?(o=11,n-=1):o-=1:k.is(".new")&&(11===o?(o=0,n+=1):o+=1),aB.date=e({y:n,M:o,d:l,h:aB.date.hours(),m:aB.date.minutes(),s:aB.date.seconds()}),aB.viewDate=e({y:n,M:o,d:Math.min(28,l)}),ap(),Y(),av(i,p.type))}}},aj={incrementHours:function(){X("add","hours",1)},incrementMinutes:function(){X("add","minutes",aB.options.minuteStepping)},incrementSeconds:function(){X("add","seconds",1)},decrementHours:function(){X("subtract","hours",1)},decrementMinutes:function(){X("subtract","minutes",aB.options.minuteStepping)},decrementSeconds:function(){X("subtract","seconds",1)},togglePeriod:function(){var d=aB.date.hours();d>=12?d-=12:d+=12,aB.date.hours(d)},showPicker:function(){aB.widget.find(".timepicker > div:not(.timepicker-picker)").hide(),aB.widget.find(".timepicker .timepicker-picker").show()},showHours:function(){aB.widget.find(".timepicker .timepicker-picker").hide(),aB.widget.find(".timepicker .timepicker-hours").show()},showMinutes:function(){aB.widget.find(".timepicker .timepicker-picker").hide(),aB.widget.find(".timepicker .timepicker-minutes").show()},showSeconds:function(){aB.widget.find(".timepicker .timepicker-picker").hide(),aB.widget.find(".timepicker .timepicker-seconds").show()
},selectHour:function(d){var i=parseInt(f(d.target).text(),10);aB.use24hours||(aB.date.hours()>=12?12!==i&&(i+=12):12===i&&(i=0)),aB.date.hours(i),aj.showPicker.call(aB)},selectMinute:function(d){aB.date.minutes(parseInt(f(d.target).text(),10)),aj.showPicker.call(aB)},selectSecond:function(d){aB.date.seconds(parseInt(f(d.target).text(),10)),aj.showPicker.call(aB)}},ai=function(l){var k=e(aB.date),j=f(l.currentTarget).data("action"),i=aj[j].apply(aB,arguments);return ah(l),aB.date||(aB.date=e({y:1970})),Y(),al(),av(k,l.type),i},ah=function(d){d.stopPropagation(),d.preventDefault()},ag=function(d){27===d.keyCode&&aB.hide()},af=function(l){e.locale(aB.options.language);var k=f(l.target),j=e(aB.date),i=e(k.val(),aB.format,aB.options.useStrict);i.isValid()&&!W(i)&&V(i)?(at(),aB.setValue(i),av(j,l.type),Y()):(aB.viewDate=j,aB.unset=!0,av(j,l.type),au(i))},ae=function(d){d&&(aB.viewMode=Math.max(aB.minViewMode,Math.min(2,aB.viewMode+d))),aB.widget.find(".datepicker > div").hide().filter(".datepicker-"+b.modes[aB.viewMode].clsName).show()},ad=function(){var i,m,l,k,j;aB.widget.on("click",".datepicker *",f.proxy(ak,this)),aB.widget.on("click","[data-action]",f.proxy(ai,this)),aB.widget.on("mousedown",f.proxy(ah,this)),aB.element.on("keydown",f.proxy(ag,this)),aB.options.pickDate&&aB.options.pickTime&&aB.widget.on("click.togglePicker",".accordion-toggle",function(d){if(d.stopPropagation(),i=f(this),m=i.closest("ul"),l=m.find(".in"),k=m.find(".collapse:not(.in)"),l&&l.length){if(j=l.data("collapse"),j&&j.transitioning){return}l.collapse("hide"),k.collapse("show"),i.find("span").toggleClass(aB.options.icons.time+" "+aB.options.icons.date),aB.component&&aB.component.find("span").toggleClass(aB.options.icons.time+" "+aB.options.icons.date)}}),aB.isInput?aB.element.on({click:f.proxy(aB.show,this),focus:f.proxy(aB.show,this),change:f.proxy(af,this),blur:f.proxy(aB.hide,this)}):(aB.element.on({change:f.proxy(af,this)},"input"),aB.component?(aB.component.on("click",f.proxy(aB.show,this)),aB.component.on("mousedown",f.proxy(ah,this))):aB.element.on("click",f.proxy(aB.show,this)))},ac=function(){f(window).on("resize.datetimepicker"+aB.id,f.proxy(aw,this)),aB.isInput||f(document).on("mousedown.datetimepicker"+aB.id,f.proxy(aB.hide,this))},ab=function(){aB.widget.off("click",".datepicker *",aB.click),aB.widget.off("click","[data-action]"),aB.widget.off("mousedown",aB.stopEvent),aB.options.pickDate&&aB.options.pickTime&&aB.widget.off("click.togglePicker"),aB.isInput?aB.element.off({focus:aB.show,change:aB.change,click:aB.show,blur:aB.hide}):(aB.element.off({change:aB.change},"input"),aB.component?(aB.component.off("click",aB.show),aB.component.off("mousedown",aB.stopEvent)):aB.element.off("click",aB.show))},aa=function(){f(window).off("resize.datetimepicker"+aB.id),aB.isInput||f(document).off("mousedown.datetimepicker"+aB.id)},Z=function(){if(aB.element){var i,k=aB.element.parents(),j=!1;for(i=0;i<k.length;i++){if("fixed"===f(k[i]).css("position")){j=!0;break}}return j}return !1},Y=function(){e.locale(aB.options.language);var d="";aB.unset||(d=e(aB.date).format(aB.format)),ay().val(d),aB.element.data("date",d),aB.options.pickTime||aB.hide()},X=function(i,l,k){e.locale(aB.options.language);var j;return"add"===i?(j=e(aB.date),23===j.hours()&&j.add(k,l),j.add(k,l)):j=e(aB.date).subtract(k,l),W(e(j.subtract(k,l)))||W(j)?void au(j.format(aB.format)):("add"===i?aB.date.add(k,l):aB.date.subtract(k,l),void (aB.unset=!1))},W=function(i,l){e.locale(aB.options.language);var k=e(aB.options.maxDate,aB.format,aB.options.useStrict),j=e(aB.options.minDate,aB.format,aB.options.useStrict);return l&&(k=k.endOf(l),j=j.startOf(l)),i.isAfter(k)||i.isBefore(j)?!0:aB.options.disabledDates===!1?!1:aB.options.disabledDates[i.format("YYYY-MM-DD")]===!0},V=function(d){return e.locale(aB.options.language),aB.options.enabledDates===!1?!0:aB.options.enabledDates[d.format("YYYY-MM-DD")]===!0},U=function(i){var l,k={},j=0;for(l=0;l<i.length;l++){aE=e.isMoment(i[l])||i[l] instanceof Date?e(i[l]):e(i[l],aB.format,aB.options.useStrict),aE.isValid()&&(k[aE.format("YYYY-MM-DD")]=!0,j++)
}return j>0?k:!1},T=function(d){return d=d.toString(),d.length>=2?d:"0"+d},c=function(){var j='<thead><tr><th class="prev">&lsaquo;</th><th colspan="'+(aB.options.calendarWeeks?"6":"5")+'" class="picker-switch"></th><th class="next">&rsaquo;</th></tr></thead>',i='<tbody><tr><td colspan="'+(aB.options.calendarWeeks?"8":"7")+'"></td></tr></tbody>',l='<div class="datepicker-days"><table class="table-condensed">'+j+'<tbody></tbody></table></div><div class="datepicker-months"><table class="table-condensed">'+j+i+'</table></div><div class="datepicker-years"><table class="table-condensed">'+j+i+"</table></div>",k="";return aB.options.pickDate&&aB.options.pickTime?(k='<div class="bootstrap-datetimepicker-widget'+(aB.options.sideBySide?" timepicker-sbs":"")+(aB.use24hours?" usetwentyfour":"")+' dropdown-menu" style="z-index:9999 !important;">',k+=aB.options.sideBySide?'<div class="row"><div class="col-sm-6 datepicker">'+l+'</div><div class="col-sm-6 timepicker">'+a.getTemplate()+"</div></div>":'<ul class="list-unstyled"><li'+(aB.options.collapse?' class="collapse in"':"")+'><div class="datepicker">'+l+'</div></li><li class="picker-switch accordion-toggle"><a class="btn" style="width:100%"><span class="'+aB.options.icons.time+'"></span></a></li><li'+(aB.options.collapse?' class="collapse"':"")+'><div class="timepicker">'+a.getTemplate()+"</div></li></ul>",k+="</div>"):aB.options.pickTime?'<div class="bootstrap-datetimepicker-widget dropdown-menu"><div class="timepicker">'+a.getTemplate()+"</div></div>":'<div class="bootstrap-datetimepicker-widget dropdown-menu"><div class="datepicker">'+l+"</div></div>"},b={modes:[{clsName:"days",navFnc:"month",navStep:1},{clsName:"months",navFnc:"year",navStep:1},{clsName:"years",navFnc:"year",navStep:10}]},a={hourTemplate:'<span data-action="showHours"   data-time-component="hours"   class="timepicker-hour"></span>',minuteTemplate:'<span data-action="showMinutes" data-time-component="minutes" class="timepicker-minute"></span>',secondTemplate:'<span data-action="showSeconds"  data-time-component="seconds" class="timepicker-second"></span>'};a.getTemplate=function(){return'<div class="timepicker-picker"><table class="table-condensed"><tr><td><a href="#" class="btn" data-action="incrementHours"><span class="'+aB.options.icons.up+'"></span></a></td><td class="separator"></td><td>'+(aB.options.useMinutes?'<a href="#" class="btn" data-action="incrementMinutes"><span class="'+aB.options.icons.up+'"></span></a>':"")+"</td>"+(aB.options.useSeconds?'<td class="separator"></td><td><a href="#" class="btn" data-action="incrementSeconds"><span class="'+aB.options.icons.up+'"></span></a></td>':"")+(aB.use24hours?"":'<td class="separator"></td>')+"</tr><tr><td>"+a.hourTemplate+'</td> <td class="separator">:</td><td>'+(aB.options.useMinutes?a.minuteTemplate:'<span class="timepicker-minute">00</span>')+"</td> "+(aB.options.useSeconds?'<td class="separator">:</td><td>'+a.secondTemplate+"</td>":"")+(aB.use24hours?"":'<td class="separator"></td><td><button type="button" class="btn btn-primary" data-action="togglePeriod"></button></td>')+'</tr><tr><td><a href="#" class="btn" data-action="decrementHours"><span class="'+aB.options.icons.down+'"></span></a></td><td class="separator"></td><td>'+(aB.options.useMinutes?'<a href="#" class="btn" data-action="decrementMinutes"><span class="'+aB.options.icons.down+'"></span></a>':"")+"</td>"+(aB.options.useSeconds?'<td class="separator"></td><td><a href="#" class="btn" data-action="decrementSeconds"><span class="'+aB.options.icons.down+'"></span></a></td>':"")+(aB.use24hours?"":'<td class="separator"></td>')+'</tr></table></div><div class="timepicker-hours" data-action="selectHour"><table class="table-condensed"></table></div><div class="timepicker-minutes" data-action="selectMinute"><table class="table-condensed"></table></div>'+(aB.options.useSeconds?'<div class="timepicker-seconds" data-action="selectSecond"><table class="table-condensed"></table></div>':"")},aB.destroy=function(){ab(),aa(),aB.widget.remove(),aB.element.removeData("DateTimePicker"),aB.component&&aB.component.removeData("DateTimePicker")
},aB.show=function(i){if(!ay().prop("disabled")){if(aB.options.useCurrent&&""===ay().val()){if(1!==aB.options.minuteStepping){var k=e(),j=aB.options.minuteStepping;k.minutes(Math.round(k.minutes()/j)*j%60).seconds(0),aB.setValue(k.format(aB.format))}else{aB.setValue(e().format(aB.format))}av("",i.type)}i&&"click"===i.type&&aB.isInput&&aB.widget.hasClass("picker-open")||(aB.widget.hasClass("picker-open")?(aB.widget.hide(),aB.widget.removeClass("picker-open")):(aB.widget.show(),aB.widget.addClass("picker-open")),aB.height=aB.component?aB.component.outerHeight():aB.element.outerHeight(),aw(),aB.element.trigger({type:"dp.show",date:e(aB.date)}),ac(),i&&ah(i))}},aB.disable=function(){var d=ay();d.prop("disabled")||(d.prop("disabled",!0),ab())},aB.enable=function(){var d=ay();d.prop("disabled")&&(d.prop("disabled",!1),ad())},aB.hide=function(){var i,k,j=aB.widget.find(".collapse");for(i=0;i<j.length;i++){if(k=j.eq(i).data("collapse"),k&&k.transitioning){return}}aB.widget.hide(),aB.widget.removeClass("picker-open"),aB.viewMode=aB.startViewMode,ae(),aB.element.trigger({type:"dp.hide",date:e(aB.date)}),aa()},aB.setValue=function(d){e.locale(aB.options.language),d?aB.unset=!1:(aB.unset=!0,Y()),d=e.isMoment(d)?d.locale(aB.options.language):d instanceof Date?e(d):e(d,aB.format,aB.options.useStrict),d.isValid()?(aB.date=d,Y(),aB.viewDate=e({y:aB.date.year(),M:aB.date.month()}),ap(),al()):au(d)},aB.getDate=function(){return aB.unset?null:e(aB.date)},aB.setDate=function(d){var i=e(aB.date);aB.setValue(d?d:null),av(i,"function")},aB.setDisabledDates=function(d){aB.options.disabledDates=U(d),aB.viewDate&&at()},aB.setEnabledDates=function(d){aB.options.enabledDates=U(d),aB.viewDate&&at()},aB.setMaxDate=function(d){void 0!==d&&(aB.options.maxDate=e.isMoment(d)||d instanceof Date?e(d):e(d,aB.format,aB.options.useStrict),aB.viewDate&&at())},aB.setMinDate=function(d){void 0!==d&&(aB.options.minDate=e.isMoment(d)||d instanceof Date?e(d):e(d,aB.format,aB.options.useStrict),aB.viewDate&&at())},az()};f.fn.datetimepicker=function(a){return this.each(function(){var d=f(this),b=d.data("DateTimePicker");b||d.data("DateTimePicker",new g(this,a))})},f.fn.datetimepicker.defaults={format:!1,pickDate:!0,pickTime:!0,useMinutes:!0,useSeconds:!1,useCurrent:!0,calendarWeeks:!1,minuteStepping:1,minDate:e({y:1900}),maxDate:e().add(100,"y"),showToday:!0,collapse:!0,language:e.locale(),defaultDate:"",disabledDates:!1,enabledDates:!1,icons:{},useStrict:!1,direction:"auto",sideBySide:!1,daysOfWeekDisabled:[],widgetParent:!1}});if(!window.console){window.console={}}if(!window.console.log){window.console.log=function(){}}var autowidth=mod_column_autowidth();var reorder_resize_tools=mod_reorder_resize_tools();var editors_by_element_id={};function isFunction(a){var b={};return a&&b.toString.call(a)==="[object Function]"}function createKey(){function a(){return Math.floor((1+Math.random())*65536).toString(16).substring(1)}return a()+a()+a()+a()}function get_form_data(){var a={};$("#card_form input, #card_form textarea").each(function(c,d){var b=$(d).attr("name");if(typeof(b)!=="string"||b===""){return}var e=$(d).val();a[b]=e});return JSON.stringify(a)}var RequestHandler=(function(){var b={};function c(g,e){var d=document.getElementById("RequestHandlerIFramesContainer");var f=document.createElement("iframe");f.id="RequestFrame"+g;f.src="fake://"+g+"/"+e;d.appendChild(f)}function a(f){var e=document.getElementById("RequestFrame"+f);if(e!==null){var d=document.getElementById("RequestHandlerIFramesContainer");d.removeChild(e)}}this.initializeRootElement=function(){var d=document.createElement("div");d.style.display="none";d.id="RequestHandlerIFramesContainer";document.body.appendChild(d)};this.sendRequest=function(d){var e=createKey();b[e]=d;c(e,d.url)};this.receiveResponse=function(g,d){try{if(b[g]!==null){var f=b[g];a(g);b[g]=null;f.responseText=d;f.readyState=4;f.status=200;if(f.onreadystatechange!==undefined&&f.onreadystatechange!==null){f.onreadystatechange()}return"OK"}return"ID NOT FOUND"}catch(e){return"ERROR: "+e.message}};return this})();if($CLIENT==="iOS"){XMLHttpRequest_to_protogrid_server=function(){var a=this;this.onreadystatechange=null;this.send=function(){RequestHandler.sendRequest(a)};this.open=function(d,b,c){a.method=d;a.url=b}}}function RequestQueue(d){d=d||false;var b=4;var g=[];var a=[];var f=0;function e(){if(b>0){b=b-1;return true}else{return false}}function c(){if(b<4){b=b+1}}function h(){if(e()){if(g.length>0){var i=g.pop();var j=$.ajax(i);a.push(j);if(f>0&&!d){f=f-1;h()}}}else{if(a.length>0){var j=a.pop();j.always(function(){c();h()})}else{f=f+1}}}this.add_request=function(i){g.push(i);h()}}function get_default_sorting(b){var c=-1;var a="asc";b.find("th").each(function(d,e){if(c<0&&!($(e).hasClass("non-sortable"))){c=d;if($(e).data("valuetype")==="date"){a="desc"}}});if(c>-1){return[[c,a]]}else{return[]}}function prepare_datatables_for_serverdata(i,e,a,b){var f=get_filters_by_column_key(e);var d=false;for(var g in f){i.push({name:"sFilter_"+g,value:f[g]});d=true}for(var c=0;c<i.length;c++){if(i[c].name==="sSearch"&&typeof(i[c].value)==="string"&&i[c].value!==""){d=true}}var h=b.aoColumns;if(d===true){update_sortable(h,false)}else{update_sortable(h,true)}i.push({name:"proto_key",value:a});$(e).data("last_request_body",i)}function is_datatable(b){var d=$.fn.dataTableSettings;for(var c=0,a=d.length;c<a;c++){if(d[c].nTable==b){return true}}return false}function get_or_initialize_ajax_datatable(i,g){if(is_datatable($(i)[0])){return $(i).DataTable()}var a="";var c=$(i).data("protokey");if(typeof(c)==="string"&&c!==""){a="/"+encodeURIComponent(c)}var f=$(i).data("label");var b=$(i).prop("id");var d="/"+encodeURIComponent(b);var j=get_aoColumns_of_ajax_tableview(i);var h=$(i).data("tableheight");if($(i).hasClass("table-controls-in-header")){h=$(".card-content").height()-74}var e=$(i).dataTable({sDom:'<"row"<"col-xs-12 col-tableview-controls"rf>><"row"<"col-xs-12"Rlt<"tableview-footer"i>S>>',sScrollY:h,bScrollCollapse:true,bProcessing:true,bServerSide:true,bLengthChange:false,bAutoWidth:false,bScrollAutoCss:false,bFilter:$CLIENT==="android"?false:true,fnServerData:get_datatables_serverdata_function(i,b,c),fnDrawCallback:function(k){$(i).find(".datetime").each(function(l,m){update_datetime_field(m)});if(typeof(form)==="object"&&form!==null&&form.data("beforefirstsave")){ask_user_to_save_before_leaving()}g[b]=true;$(window).trigger("table-data-ready")},sAjaxSource:$(i).data("origin")+d+a,aoColumns:j,aaSorting:get_default_sorting($(i)),oLanguage:{sSearch:"",sProcessing:"<span class='glyphicon glyphicon-time'></span>",sInfo:"Cards _START_ - _END_ (of _TOTAL_)"}}).fnSetFilteringDelay();
return e}var request_queue=new RequestQueue(true);function get_datatables_serverdata_function(c,b,a){if($CLIENT==="iOS"){return function(g,h,m,l){prepare_datatables_for_serverdata(h,c,a,l);var k=new XMLHttpRequest_to_protogrid_server();k.onreadystatechange=function(){if(k.readyState==4&&k.status==200){m(JSON.parse(decodeURIComponent(k.responseText)))}};var e={};for(var j=0;j<h.length;j++){e[h[j].name]=h[j].value}k.open("GET",encodeURIComponent(JSON.stringify(e))+"/"+g,true);k.send()}}else{var f;if(typeof(Worker)!=="undefined"&&typeof(f)==="undefined"){try{f=new Worker($CARD_WORKER_PATH)}catch(d){console.log(d)}}if(typeof(f)!=="undefined"){return function(e,g,k,h){prepare_datatables_for_serverdata(g,c,a,h);var j=g;j.push({name:"mode",value:"raw"});var i={dataType:"json",url:e,data:j,timeout:100000000,success:function(l){var m=l.aaData;m.action="get_rendered_tableview_data";f.onmessage=function(n){if(typeof(n.data.error)==="string"&&n.data.error!==""){alert(n.data.error)}else{var o={aaData:n.data.rendered_tableview_data,iTotalRecords:l.iTotalRecords,iTotalDisplayRecords:l.iTotalDisplayRecords,sEcho:l.sEcho};k(o)}};f.postMessage(m)},error:function(m,n,l){if(n!="abort"){}else{}}};request_queue.add_request(i)}}else{return function(e,g,i,h){prepare_datatables_for_serverdata(g,c,a,h);$.ajax({dataType:"json",url:e,data:g,timeout:10000,success:function(j){i(j)}})}}}}function prepare_app_id(b,d){var a="";if(typeof(b)==="string"&&b!==""){a=b}else{var c=$("select[name='"+d+"']");if(c.length>0){a=c.val()}}return a}function get_select2_serverdata_function(a,c,e,d,b){return function(g){var i={search_term:g.term,related_app_id:prepare_app_id(c,e),element_id:$(d).prop("name"),proto_key:b,page_num:g.page};var f=get_filters_by_column_key(d,false);for(column_key in f){i["filter_"+column_key]=f[column_key]}var j=$(d).data("couchdb-viewname");if(typeof(j)==="string"&&j!==""){i.couchdb_viewname=j}if($CLIENT==="iOS"){var h=new XMLHttpRequest_to_protogrid_server();h.onreadystatechange=function(){if(h.readyState==4&&h.status==200){g.callback(JSON.parse(decodeURIComponent(h.responseText)))}};h.open("GET",encodeURIComponent(JSON.stringify(i))+"/"+a,true);h.send()}else{$.ajax({dataType:"json",url:a,data:i,timeout:10000,success:function(k){g.callback(k)}})}}}function Tools(f){if(f===undefined||f===null||f===""){console.error("[Tools] Tools must be initialized with a valid app_id.");return null}var e=null;var a=f;var i=this;function c(k,j){if(typeof(k)!=="object"||k===null||Array.isArray(k)){return null}return k[j]}function b(k,j){if(typeof(j)!=="boolean"){j=true}if(typeof(k)!=="object"||k===null||Array.isArray(k)){logger.log("cannot get type of invalid card: "+JSON.stringify(k),LOG_LEVEL.error);return null}if(j&&typeof(k._id)==="string"&&k._id in template_cards_by_key){return b(template_cards_by_key[k._id],false)}if(!("definition_type" in k)||k.definition_type==="DynamicCard"){if(!("proto_key" in k)){logger.log("card with id neither contains a definition type nor a proto key - invalid type; card: "+JSON.stringify(k));return null}return"DynamicCard"}card_type=k.definition_type+"Definition";if(!(card_type in structure)){return"DynamicCard"}return card_type}function d(l){if(typeof(l)!=="object"||l===null){return{}}var o=null;var k=null;var n=null;if(!(Array.isArray(l))){k=l;n=c(l.temporary_data,"element_index");o=k.design_elements;if(typeof(n)==="object"&&n!==null){return n}}else{o=l}if(!(Array.isArray(o))){return{}}n={};for(var m=0;m<o.length;m++){if(typeof(o[m])!=="object"||o[m]===null||(Array.isArray(o[m]))){continue}var j=i.get_design_element_identifier(o[m]);if(j===null){continue}n[j]=o[m]}if(k!==null&&"temporary_data" in k){k.temporary_data.element_index=n}else{if(k!==null){k.temporary_data={element_index:n}}}return n}function g(j){j.get_key=function(){return this._id};j.get_type=function(){return b(this)};j.get_proto_key=function(){return this.proto_key};j.get_design_element=function(k){var l=d(this);if(typeof(l[k])!=="object"||l[k]===null){return null}return l[k]
};j.get_value=function(m,k){if(k===undefined){k=null}if(m in this){return this[m]}var l=this.get_design_element(m);if(l===null){return k}return l.value};j.get_shortname=function(m){if(typeof(this.definition_type)==="string"&&this.definition_type.indexOf("Field")!==-1){this.get_multilanguage_string(this.get_value("label"),"field",undefined,m)}var l="";var k=c(this.denormalized,this._id);this.get_multilanguage_string_and_language_from_object_indexed_by_language(k.shortname,function(n){return n},undefined,m)};j.set_design_element_value=function(m,n,k){if(typeof(k)!=="boolean"){k=true}var l=this.get_design_element(m);if(l===null&&k===false){this.design_elements.push({name:m,value:n});return true}else{if(l===null){return false}}l.value=n;return true};j.set_element_value=function(l,m,k){return this.set_design_element_value(l,m,k)};return j}function h(j,l,k){return"json_data"}this.get_multilanguage_string_and_language_from_object_indexed_by_language=function(j,k,l,o){var m=null;if(typeof(l)==="string"&&l!==""){m=[l];n(j,k,l,o,m,this)(undefined)}else{this.get_user_context(n(j,k,l,o,undefined,this))}function n(p,r,s,u,t,q){return function(z){if(t===undefined){t=c(z,"languages")}var x="";if(Array.isArray(t)){for(var A=0;A<t.length;A++){if(t[A] in p){x=r(p[t[A]])}if(typeof(x)==="string"&&x!==""){u([x,t[A]]);return}var w=t[A].split("_");if(w.length<2){continue}for(var y=w.length-1;y>=1;y--){var v=w.slice(0,y).join("_");if(v in p){x=r(p[v])}if(typeof(x)==="string"&&x!==""){u([x,v]);return}}}}function B(C,D,E,F){return function(G){if(typeof(G)==="object"&&G!==null){var J=G.get_value("card_design_elements");if(Array.isArray(J)){for(var H=0;H<J.length;H++){var K=J[H];if(K in C){x=D(C[K])}if(typeof(x)==="string"&&x!==""){F([x,K]);return}}}}if("en" in C){x=D(C.en)}if(typeof(x)==="string"&&x!==""){F([x,"en"]);return}if("en_US" in C){x=D(C.en_US)}if(typeof(x)==="string"&&x!==""){F([x,"en_US"]);return}var I=Object.keys(C);if(I.length>0){x=D(C[I[0]])}F([x,I[0]]);return}}q.resolve_key("&&multilanguageProto",true,B(p,r,s,u))}}};this.get_multilanguage_string=function(m,n,l,o){var j="";function k(r,s,q,t,p){return function(u){if(u===""){if(s!==undefined){t(s);return}else{t("[Missing Multilanguage Text]");return}}u.design_element_index=d(u);p.get_multilanguage_string_and_language_from_object_indexed_by_language(u.design_element_index,function(v){return v.value},q,function(v){v=v[0];if(v!==""&&v.substring(0,7)!=="&&mlkey"){t(v);return}if(s!==undefined){console.warn("[get_multilanguage_string] Cannot resolve ml_card with key "+String(r)+". Therefore returning the specified default string "+String(s)+".");t(s);return}else{console.error("[get_multilanguage_string] Cannot get multilanguage text for key from cards given in context: "+String(r));t("[Missing Multilanguage Text]");return}})}}this.resolve_key(m,true,k(m,n,l,o,this))};this.resolve_key=function(j,k,l){if(k===undefined){k=true}$.ajax({context:this,type:"GET",url:$HOST_DOMAIN+"/api/v2/apps/"+a+"/cards/"+j,contentType:"application/json; charset=utf-8",success:function(m){if((typeof(m)!=="object"||m==null)&&k){console.error("[resolve_key] invalid result returned for key "+j+".\n						Response contained: "+String(m));return}if((Array.isArray(m.errors)&&m.errors.length>0)&&k){console.error("[resolve_key] json response contained errors: "+JSON.stringify(m.errors));l("")}if(m.result!==undefined&&m.result!==null){l(g(m.result))}},error:function(m,o,n){console.error(o,n)}});console.log("resolve_key");return"card"};this.get_design_element_identifier=function(j){if(typeof(j)!=="object"||j===null){console.error("cannot get identifier - design element is not an object");return null}if("definition_key" in j){return j.definition_key}if("name" in j){return j.name}console.error("cannot get identifier - no 'name' or 'definition_key' property in design element");return null};this.get_user_context=function(j){if(e===null){$.ajax({context:this,type:"GET",url:$HOST_DOMAIN+"/api/v2/user/user-context",contentType:"application/json; charset=utf-8",success:function(k){if(typeof(k)!=="object"||k==null){console.error("[get_user_context] invalid result returned.\n							Response contained: "+String(k));
return}if(Array.isArray(k.errors)&&k.errors.length>0){console.error("[get_user_context] json response contained errors: "+JSON.stringify(k.errors));return}if(k.result!==undefined&&k.result!==null){e=k.result;j(k.result)}},error:function(k,m,l){console.error(m,l)}})}else{j(e)}};this.get_user_context(function(j){return})}function get_select2_initdata_function(a,b){return function(f,j){var i=$(f).val();if(typeof(i)!=="string"||$.trim(i)===""){var c=$("#card_form").data("parentcardkey");var h=$("#card_form").data("parentprotokey");if(typeof(c)!=="string"||c===""||typeof(h)!=="string"||h===""||$(f).data("protokey")!==h){return}i=c;$(f).val(i).trigger("change")}var d=$(f).data("origin");var g={related_app_id:prepare_app_id(a,b),related_id:i};if($CLIENT==="iOS"){var e=new XMLHttpRequest_to_protogrid_server();e.onreadystatechange=function(){if(e.readyState==4&&e.status==200){j(JSON.parse(decodeURIComponent(e.responseText)).results[0])}};e.open("GET",encodeURIComponent(JSON.stringify(g))+"/"+d,true);e.send()}else{$.ajax({url:d,data:g,dataType:"json"}).done(function(k){j(k.results[0])})}}}jQuery.fn.dataTableExt.oApi.fnSetFilteringDelay=function(c,b){var a=this;if(b===undefined){b=500}this.each(function(e){$.fn.dataTableExt.iApiIndex=e;var g=this,d=null,h=null,f=$("input",a.fnSettings().aanFeatures.f);f.unbind("keyup").bind("keyup",function(){var i=g;if(h===null||h!=f.val()){window.clearTimeout(d);h=f.val();d=window.setTimeout(function(){$.fn.dataTableExt.iApiIndex=e;a.fnFilter(f.val())},b)}});return this});return this};jQuery.fn.dataTableExt.oApi.fnStandingRedraw=function(b){if(b.oFeatures.bServerSide===false){var a=b._iDisplayStart;b.oApi._fnReDraw(b);b._iDisplayStart=a;b.oApi._fnCalculateEnd(b)}b.oApi._fnDraw(b)};function ask_user_to_save_before_leaving(){var a=$("#card_form");if(a.data("saveable")!==true){return}$("#save_button,#save_and_close_button").removeAttr("disabled");$("a[onclick*='post_form'],button[onclick*='post_form'],.click-to-open").each(function(b,c){var d=$(c).data("modalname");if(typeof(d)!=="string"){return}d="#"+d;$(c).prop("href",d);$(c).removeAttr("onclick");$(c).off("click");$(c).click(function(){var k=$(c).data("action");var e=$(c).data("id");var h=$(c).data("relatedkey");var f=$(c).data("relatedappkey");var j=$(c).parents("tr");if((typeof(h)!=="string"||h==="")&&j.length>0){h=$(j[0]).data("key")}var g=null;var i=$(c).parents("form");if(i.length>0){g=$(i[0]).data("protokey")}$("a[id*='confirm_link_modal']").click(function(){post_form(g,k,e,h,f)});$(d).modal("show");return false})})}function get_cookie(a){var b="; "+document.cookie;var c=b.split("; "+a+"=");if(c.length>=2){return c.pop().split(";").shift()}}function save_cookie_for_non_peristent_fields(b){var a=new Date();a.setFullYear(a.getFullYear()+1);document.cookie=$(b).attr("name")+"="+$(b).val()+"; expires="+a.toGMTString()}function post_form(a,d,b,e,h){var i=$("#card_form");if(typeof(a)!=="string"&&d!=="edit_related_card"){a=i.data("protokey")}post_save_action=i.data("postsaveaction");var c={};if(typeof(a)==="string"){c.proto_key=a}if(typeof(d)==="string"){c.action=d}if(typeof(b)==="string"){c.element_id=b}if(typeof(e)==="string"){c.related_card_key=e}if(typeof(h)==="string"){c.related_app_id=h}if(typeof(post_save_action)==="string"&&post_save_action!=""){c.post_save_action=post_save_action}i.find("input.non-persistent").each(function(k,l){save_cookie_for_non_peristent_fields(l)});var g=$(".manual-ordering");g.each(function(m,k){var l=$(k).prop("id");var n=$(k).find("tbody tr");var o=[];n.each(function(p,q){o.push($(q).data("key"))});c[l]=o});for(var b in editors_by_element_id){var f=editors_by_element_id[b];$("input#"+b).val(f.getValue())}i.find(".dataTables_scrollBody > .ajax-ordering").each(function(k,l){var p=$(l).prop("id");var m=$(l).data("last_request_body");var n=i.find("#tableview_formgroup_"+jquery_selector_escape(p));var o=n.find(".last_request_body");o.val(JSON.stringify(m))});i.find("input.datetime-picker-persistent").each(function(p,o){var n=$(o).val();
if(typeof(n)==="string"&&$.trim(n)!==""){var l=["dd L LT","dd L","LLLL","llll","LLL","lll","LL","ll","L","l","L LT","LT","YYYY-MM-DDTHH:mm"];var q=null;if($(o).data("datetime-display-setting")===1){q=moment.utc(n,"dd L",$DATETIME_LOCALE,true);if(!(q.isValid())){q=moment.utc(n,"YYYY-MM-DD",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YYYY-MM-D",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YYYY-M-DD",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YYYY-M-D",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YY-MM-DD",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YY-MM-D",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YY-M-D",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"YY-M-D",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"L",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd l",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"l",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd LL",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"LL",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd ll",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"ll",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd LLL",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"LLL",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd lll",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"lll",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd LLLL",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"LLLL",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"dd llll",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"llll",$DATETIME_LOCALE,true)}}else{if($(o).data("datetime-display-setting")===2){q=moment.utc(n,"LT",$DATETIME_LOCALE,true);if(!(q.isValid())){q=moment.utc(n,"H:m",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"H:mm",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"HH:mm",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"h:m a",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"h:mm a",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"hh:mm a",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"H.m",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"H.mm",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"HH.mm",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"h.m a",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"h.mm a",$DATETIME_LOCALE,true)}if(!(q.isValid())){q=moment.utc(n,"hh.mm a",$DATETIME_LOCALE,true)}}else{q=moment(n,l,$DATETIME_LOCALE,true)}}if(!(q.isValid())){console.log("WARNING: Date "+n+" could not be parsed: "+q.invalidAt())}else{if($(o).data("datetime-display-setting")===2){var m=$(o).attr("name");var r=q.toISOString();var k=r.substr(r.indexOf("T"));c[m]="1970-01-01"+k}else{var m=$(o).attr("name");c[m]=q.toISOString()}}}});var j="?";for(param_key in c){j+=param_key+"="+encodeURIComponent(c[param_key])+"&"}if(i.length==0){i=$("<form method=post></form>");i.appendTo("body")}i.prop("action",j);i.submit()}function reset_forms_to_html(){$("input").each(function(){if(!this.getAttribute("checked")!=!this.checked){$(this).click()}else{$(this).val(this.getAttribute("value")||"")}});$("select").each(function(){var c=$("option",this),b=0;for(var a=0;a<c.length;a++){if(c[a].getAttribute("selected")){b=a}}this.selectedIndex=b||0})}function jquery_selector_escape(a){if(a){return a.replace(/([ #;?%&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1")}else{return a}}function toggle_column(a,e){if(typeof(a)!=="object"||a===null){throw"cannot toggle column without an initialized dataTable"}var d=a.fnSettings().aoColumns[e];var c=$(d.nTh);var b=c.data("displaypriority_override");var f=false;if(d.bVisible||b===10){c.data("displaypriority_override",0)}else{c.data("displaypriority_override",10);f=true}autowidth.remove_column_widths(a);autowidth.adjust_columns_to_tablewidth(a);reorder_resize_tools.synchronize_scroller_body_to_head(a.fnSettings());
return f}function toggle_column_checker(a,c,b){$(c).prop("checked",toggle_column(a,b))}function update_columns_button(b){if(typeof(b)!=="object"||b===null){throw"cannot update columns button without an initialized dataTable"}var d=b.fnSettings();var c=$(d.nTableWrapper);var g=c.find(".column-list");if(g.length===0){g=$(".column-list")}var a=g.find("li");var f="<button type='button' class='btn btn-default btn-sm dropdown-toggle columns-chooser' data-toggle='dropdown'>	Columns: "+String(a.find(":checked").length)+" of "+String(a.length)+"	<span class='caret'></span>	</button>";var e=$(g).find(".columns-chooser");if(e.length===0){e=$(f);g.prepend(e)}else{e.remove();g.prepend($(f))}}function update_column_menu(f,h){if(typeof(f)!=="object"||f===null){throw"cannot update column menu without an initialized dataTable"}var l=$("<div class='input-group-btn column-list'></div>");var c=$("<ul class='dropdown-menu pull-right'></ul>").appendTo(l);var a=f.fnSettings().aoColumns;var d=0;for(var p=0;p<a.length;p++){if($(a[p].nTh).hasClass("always-visible")){d+=1;continue}var r=a[p].sTitle;var b=$("<li></li>").appendTo(c);var g=$("<label> "+r+"</label>").appendTo(b);var t=a[p].bVisible;var k=$("<input type='checkbox'>");if(t){k.prop("checked","checked");d+=1}g.prepend(k);var j=(function(u,i){return function(v){v.stopPropagation();toggle_column_checker(f,u,i);update_column_menu(f,h)}})(k,p);k.click(j);b.click(function(i){i.stopPropagation()})}$(h).find(".dataTables_empty").prop("colspan",String(d));var m=f.prop("id");var s=f.fnSettings();var n=$(s.nTableWrapper);var q=null;if($(f).hasClass("table-controls-in-header")){q=$("#integrated-tableview-actions")}else{q=n.find(".horicontal-group")}var o=q.find(".column-list");o.remove();var e=q.find(".merged");if(e.length!==0){q.find(".merged").before(l)}else{q.append(l)}update_columns_button(f)}function input_type_not_supported(c){var b=document.createElement("input");b.setAttribute("type",c);var a="not-a-date";b.setAttribute("value",a);return(b.value===a)}function initialize_datetime_field(d,c){var b="dd L LT";if($(d).data("datetime-display-setting")===1){b="dd L"}else{if($(d).data("datetime-display-setting")===2){b="LT"}}var a=true;if($CLIENT==="iOS"){a=false}c.format=b;c.sideBySide=a;c.useCurrent=false;if(input_type_not_supported($(d).attr("type"))){$(d).datetimepicker(c)}else{$(d).removeClass("date");$(d).css("-webkit-appearance","textfield");$(d).css("-moz-appearance","textfield")}}function initialize_datetime_filter_fields(){var a=$("input.datetime-filter");a.each(function(b,c){initialize_datetime_field(c,{language:$DATETIME_LOCALE,pickTime:$(c).data("datetime-display-setting")!==1,pickDate:$(c).data("datetime-display-setting")!==2})});$(".datetime-filter").each(function(b,c){$(c).parent().find(".clear").click(function(){$(c).val("");$(c).trigger("change")})})}function initialize_select2_ajax_element(d,c){if(c===undefined){c=$(d).data("protokey")}var b=$(d).data("app-id");var e="";if(typeof(b)!=="string"||b===""){e=$(d).data("app-choice-element");$("select[name='"+e+"']").on("change",function(){$(d).select2("val","")})}var f="enable";if($(d).data("disabled")==="disabled"){f="disable"}var g=0;var a=get_filters_by_column_key(d,false,true);if(Object.keys(a).length>0){g=-1}if($(d).select2){$(d).select2("destroy")}$(d).select2({allowClear:true,enable:$(d).data("disabled")!=="disabled",dropdownCssClass:"bigdrop",minimumResultsForSearch:g,query:get_select2_serverdata_function($(d).data("origin"),b,e,d,c),initSelection:get_select2_initdata_function(b,e),formatResult:function(h){return"<div>"+h.text+"</div>"},formatSelection:function(h){return h.text}}).select2(f);$(d).parent().find(".clear").click(function(){$(d).select2("val","");$(d).trigger("change")})}function initialize_multilanguage_field(a){$(a).parent().find(".clear").click(function(){$(a).val("");$(a).prop("disabled","");$(a).trigger("change");$(a).parent().find(".edit-options").remove()})}function initialize_datatable_controls(f,h,e,m,c){if(typeof(f)!=="object"||f===null){throw"cannot update datatable controls without an initialized dataTable"
}var s=f.fnSettings();var o=$(s.nTableWrapper);var t=o.find(".tableview-footer");var a=o.find(".dataTables_processing").appendTo(t);var k=o.find(".col-tableview-controls");var n=o.find(".dataTables_filter");if(n.length==0){n=$("<div></div>").appendTo(k)}n.addClass("input-group pull-right horicontal-group");var q=n;if($(h).hasClass("table-controls-in-header")){q=$("#integrated-tableview-actions")}var u=$("<div class='input-group-btn'></div>");var j=[];if(m.length>0&&m.charAt(0)!=="&"){j=$("."+m+"-tableview-button-override")}if(j.length>0){j.appendTo(u);u.appendTo(q)}else{if(($(h).hasClass("manual-ordering")&&$(h).data("editable")===true)||(!($(h).hasClass("manual-ordering"))&&typeof(e)==="string"&&e!==""&&$(h).data("show-create-button")!==false)){var r=$("#tableviewAddActionModal_"+jquery_selector_escape(m));var p=r.data("choicetype");var b=$CREATE_LABEL;if(p==="existing_card"||p==="object_key"){var b=$ADD_LABEL}var d=$("<button type='button' class='btn btn-default btn-sm'>"+b+"</button>").appendTo(u).click(function(){var x=function(A){if($("#card_form").data("saveable")===true){post_form(A,"save_and_open_new_card",m,null)}else{post_form(A,"open_new_card",m,null)}};var z=$(h).data("creationprotokey");if(typeof(z)!=="string"||z===""){z=e}var w=z.indexOf("Definition");if(w!==-1){z=z.substring(0,w)}if(r.length>0){var v=r.find("[name*='card_proto_choice']");if(p!=="static_card"&&p!=="object_key"){initialize_select2_ajax_element(v,e)}var y=r.find("#confirm_link_modal_add_card");y.click(function(){key=v.select2("data").id;table_view_keys=[];$(h).find("tbody tr").each(function(){table_view_keys.push($(this).attr("data-key"))});if($.inArray(key,table_view_keys)==-1){if(p==="static_card"){var C=v.select2("data").id;x(C)}else{var B=v.select2("data").id;var A=$(h).find("tbody");$("<tr></tr>").attr("data-key",B).appendTo(A);post_form(null,null,null,null)}}else{r.modal("hide")}});r.modal("show")}else{x(z)}});u.appendTo(q)}}o.parent().find(".edit-options").appendTo(q);if(s.oInit.bFilter!==false){var i=$("<div class='input-group merged'><span class='input-group-addon search-addon glyphicon glyphicon-search'></span></div>").appendTo(q);var l=n.find("input");l.addClass("form-control tableview-search").appendTo(i).on("focus blur",function(){$(this).prev().toggleClass("focusedInput")});var g=n.find("label");g.remove()}if($(h).hasClass("table-controls-in-header")){k.parent().remove()}else{if(typeof(c)==="string"&&c!==""){var g=$("<label>"+c+"</label>");k.prepend(g)}}reorder_resize_tools.update_resize_handles(f);$(h).on("column-reorder",function(){update_column_menu(f,h);reorder_resize_tools.update_resize_handles(f)})}function update_click_handlers(d,g){if(typeof(d)!=="object"||d===null){throw"cannot update click handlers without an initialized dataTable"}var m=d.fnSettings().fnRecordsTotal();var l=d.fnSettings().aoColumns;if(l.length>0){var c=$(l[0].nTh).find(".selected-all");var k=c.prop("checked");$(g).find(".selected-single").prop("checked",k);c.on("change",function(){var i=c.prop("checked");$(g).find(".selected-single").prop("checked",i)})}for(var a=0;a<m;a++){var j=d.fnGetTds(a);if(!(Array.isArray(j))){continue}var b="";for(var f=0;f<j.length;f++){var e=$(j[f]).children(":first");if(e.data("type")==="key"){b=e.text();break}}if((typeof(b)!=="string"||b==="")&&j.length>0){b=$(j[0]).parent().data("key")}for(var f=0;f<j.length;f++){if(!($(j[f]).hasClass("no-click-to-open"))&&$(j[f]).find(".no-click-to-open").length>0){$(j[f]).addClass("no-click-to-open");continue}if($(j[f]).hasClass("no-click-to-open")){continue}var h=(function(i){return function(n){n.stopPropagation();post_form(null,"no_update_and_edit_related_card",null,i,$(g).data("relatedappkey"))}})(b);$(j[f]).click(h);$(j[f]).addClass("click-to-open");$(j[f]).attr("data-action","edit_related_card");$(j[f]).attr("data-relatedkey",$(g).data("relatedappkey"));$(j[f]).attr("data-relatedappkey","");$(j[f]).attr("data-modalname","saveChangesModal");$(j[f]).attr("data-toggle","modal")}}}function get_aoColumns_of_ajax_tableview(b){var c=get_object_keys(get_filters_by_column_key(b)).length>0;
var a=[];$(b).find("th").each(function(e,g){var d=$(g).data("identifier");var f=c!==true&&!($(g).hasClass("non-sortable"));if(typeof(d)==="string"&&d!==""){a.push({mData:d,bSortable:f})}});return a}function update_datetime_fields(){$(".datetime").each(function(a,b){update_datetime_field(b)})}function update_datetime_field(d){var b=$(d).data("utc-iso");if(typeof(b)!=="string"||b===""){return}moment.locale($DATETIME_LOCALE);var a=moment.utc(b);var c;var e=null;if(input_type_not_supported($(d).attr("type"))){if($(d).data("datetime-display-setting")===1){c="dd L";e=a.format(c)}else{if($(d).data("datetime-display-setting")===2){c="LT";e=a.format(c)}else{c="dd L LT";e=a.local().format(c)}}}else{if($(d).data("datetime-display-setting")===1){c="YYYY-MM-DD";e=a.format(c)}else{if($(d).data("datetime-display-setting")===2){c="HH:mm";e=a.format(c)}else{c="YYYY-MM-DDTHH:mm";e=a.local().format(c)}}}if($(d).is("input")){$(d).val(e)}else{$(d).html(e)}}function get_object_keys(a){var c=[];for(var b in a){if(a.hasOwnProperty(b)){c.push(b)}}return c}function initialize_filter_update_handlers(d,a){var f=$(d).data("filter-column-keys-by-element");var e=get_object_keys(f);for(var c=0;c<e.length;c++){if(e[c]==="#"){continue}var b=$("input#"+e[c]);b.on("change",function(g){a.fnDraw()})}}function initialize_non_persistent_fields(){}function get_filter_column_keys_by_element(b){var a=$(b).data("filter-column-keys-by-element");if(typeof(a)!=="object"||a===null){return{}}return a}function get_column_keys_available_for_multiindex(b){var a=$(b).data("column-keys-available-for-multiindex");if(!(Array.isArray(a))){return[]}return a}function get_filters_by_column_key(n,j,o){if(typeof(j)!=="boolean"){j=true}if(typeof(o)!=="boolean"){o=false}var m={};var k=get_filter_column_keys_by_element(n);var c=get_column_keys_available_for_multiindex(n);var e=get_object_keys(k);var b="";for(var g=0;g<e.length;g++){var p=k[e[g]];if(get_object_keys(m).length>0&&c.indexOf(p)===-1){continue}if(c.indexOf(p)===-1){b=p}if(e[g]==="#"){if(j===true){m[p]=$("#card_form").data("key")}continue}var f=$("input#"+e[g]);if(f.length==0){continue}var a=null;if(f.hasClass("parent-relation")){a=f.val()}else{if(f.hasClass("datetime")){a="";var d=f.val();if(typeof(d)==="string"&&$.trim(d)!==""){var l=["dd L LT","dd L","LLLL","llll","LLL","lll","LL","ll","L","l","L LT"];var h=null;if(f.data("datetime-display-setting")===1){h=moment(d+" Z","dd L Z",$DATETIME_LOCALE,true)}else{h=moment(d,l,$DATETIME_LOCALE,true)}if(!(h.isValid())){console.log("WARNING: Date "+d+" could not be parsed: "+h.invalidAt())}else{a=h.toISOString()}}}else{a=f.data("key")}}if(o===true||(typeof(a)==="string"&&a!=="")){m[p]=a}}if(get_object_keys(m).length>1&&b!==""){delete m[b]}return m}function get_select_elements_acting_as_filter(a){var c=get_column_keys_available_for_multiindex(a);var h=get_filter_column_keys_by_element(a);var f=get_object_keys(h);var b=[];for(var e=0;e<f.length;e++){var g=h[f[e]];if(b.length>0&&c.indexOf(g)===-1){continue}if(f[e]==="#"){continue}var d=$("input#"+f[e]);if(d.length==0){continue}b.push(d)}return b}function update_sortable(c,b){if(typeof(b)!=="boolean"){b=false}for(var a=0;a<c.length;a++){if(b===true&&($(c[a].nTh).hasClass("non-sortable"))){continue}c[a].bSortable=b;c[a].sSortingClass=(b?"sorting":"sorting_disabled");$(c[a].nTh).removeClass((b?"sorting_disabled":"sorting sorting_asc sorting_desc")).addClass((b?"sorting":"sorting_disabled"))}}function open_tableview_for_smartphones(c,d,e){if($(c).parents(".tableViewModal").length){return}var g=parseFloat($(window).height())-170-30;var b=$(c).attr("data-tableview-title");var f=$(".dataTables_scroll",c).html();var a=$("table.dataTable:last",c).attr("id");console.log("table id:"+a);var h=$(".dataTables_filter",c).html();var i=a;$("div.proto-content").prepend('<div class="tableViewModal" data-table-id="'+a+'"><div class="card-actions-fade-left"></div><div class="card-actions-fade-right"></div><div class="card-header"><div class="card-title"><span>'+b+'</span></div><a href="#" class="modalClose"></a></div><div class="card-content"></div>');
$(c).closest(".form-group").addClass("placeholder_"+a);$(c).appendTo(".tableViewModal");$(".tableViewModal .dataTables_wrapper .dataTables_scrollBody").css({height:g+"px"});$(".tableViewModal[data-table-id='"+a+"'] .col-tableview-controls").addClass("card-actions");$(".tableViewModal[data-table-id='"+a+"'] .col-tableview-controls label:first").hide();$(".tableViewModal").animate({bottom:"0"},e,function(){for(a in d){autowidth.adjust_columns_to_tablewidth(d[a]);reorder_resize_tools.synchronize_scroller_body_to_head(d[a].fnSettings());update_column_menu(d[a],d[a])}var j=0;$(".tableViewModal[data-table-id='"+i+"'] .dataTables_filter").children(":not(.clear)").each(function(){var k=parseFloat($(this).outerWidth());j=j+k});j=Math.round(j*1.1,0);$(".tableViewModal[data-table-id='"+i+"'] .dataTables_filter").css({width:j+"px"})})}function setBreadcrumbs(){var b=parseFloat($(".card-header").width());var a=(b-200-40-30)/2;var c=parseFloat($("ol.breadcrumb").width());var d="no";if(c>a){if(d!="once"||d!="twice"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");d="no"}if(parseFloat($("ol.breadcrumb li:last").width())+30>a){if(d!="twice"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");$("ol.breadcrumb li").addClass("hidden");$("ol.breadcrumb").prepend('<li class="clickable">&hellip;<ul class="breadcrumbDropdown">'+$("ol.breadcrumb").html()+"</ul></li>");$("ol.breadcrumb li ul li").removeClass("hidden");d="twice"}}else{if(d!="once"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");$("ol.breadcrumb li").not(":last").addClass("hidden");$("ol.breadcrumb").prepend('<li class="clickable">&hellip;<ul class="breadcrumbDropdown">'+$("ol.breadcrumb").html()+"</ul></li>");$("ol.breadcrumb li ul li").removeClass("hidden");d="once"}}}else{if(d!="once"||d!="twice"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");d="no"}}$("ol.breadcrumb").show().animate({opacity:"1"},300)}function initialize_tableviews(){var d={};var a={};$(".tableview").each(function(j,k){var l=$(k).prop("id");a[l]=false;d[l]=k});$(window).on("table-data-ready",function(){function k(m){autowidth.remove_column_widths(m)}function j(m,n){update_click_handlers(m,d[n]);autowidth.adjust_columns_to_tablewidth(m);reorder_resize_tools.synchronize_scroller_body_to_head(m.fnSettings());update_column_menu(m,d[n])}var l=false;for(id in a){if(a[id]===false){l=true;break}}if(!l){setTimeout(function(){for(datatable_id in datatables_by_id){var m=datatables_by_id[datatable_id];if(typeof(m)!=="object"||m===null){setTimeout(function(){m=get_or_initialize_ajax_datatable(table_elem,a);datatables_by_id[datatable_id]=m;k(m)},200)}}for(datatable_id in datatables_by_id){j(datatables_by_id[datatable_id],datatable_id)}g()},(($CLIENT==="iOS")?500:0))}});$(".ajax-ordering").each(function(l,m){var j=get_or_initialize_ajax_datatable(m,a);var o=$(m).prop("id");datatables_by_id[o]=j;j.bind("filter",function(){var r=j.fnSettings();var t=$(r.nTableWrapper).find(".tableview-search");var s=t.val();if(r.bFiltered&&typeof(s)==="string"&&s!==""){var q=r.aoColumns;update_sortable(q,false)}else{var q=r.aoColumns;for(var p=0;p<q.length;p++){initColumn=r.oInit.aoColumns[p]}update_sortable(q,true)}});var k=$(m).data("protokey");var n=$(m).data("label");initialize_datatable_controls(j,m,k,o,n);initialize_filter_update_handlers(m,j)});$(".manual-ordering").each(function(l,n){var o=$(n).data("label");var p=$(n).prop("id");var j=$(n).data("protokey");var m=$(n).data("editable");var k=$(n).dataTable({sDom:'<"row"<"col-xs-12 col-tableview-controls"f>><"row"<"col-xs-12"Rlrti>>',bPaginate:false,bJQueryUI:true,bFilter:false,bSort:false,bInfo:false,bAutoWidth:false});datatables_by_id[p]=k;initialize_datatable_controls(k,n,j,p,o);update_click_handlers(k,n);update_column_menu(k,n);if(m===true&&!($(n).hasClass("disable-reorder"))){$(n).rowReordering()}a[p]=true;$(window).trigger("table-data-ready")
});$("form:not(.tableview-only-card) .dataTables_wrapper").each(function(){var j=$(".row label:first",this).html();$(this).attr({"data-tableview-title":j});if($(window).width()<=768){$(this).append('<div class="tableViewWrapperLabel">'+j+"</div>")}});$("form:not(.tableview-only-card) div:not(.tableViewModal) .dataTables_wrapper").click(function(){if($(window).width()<=768){open_tableview_for_smartphones($(this),datatables_by_id,300)}});function b(){$(".tableViewModal").each(function(){$(this).closest(".tableViewModal").animate({bottom:"-100%"},1,function(){var j=$(this).attr("data-table-id");$(".dataTables_wrapper",this).prependTo(".form-group.placeholder_"+j);$(this).hide()})});$(".tableViewWrapperLabel").remove()}$(document).on("click",".modalClose",function(){$(this).closest(".tableViewModal").animate({bottom:"-100%"},300,function(){var j=$(this).attr("data-table-id");$(".dataTables_wrapper",this).prependTo(".form-group.placeholder_"+j);$(this).hide()})});function g(){if($(window).width()<=768&&$(".card-actions").size()>=1){$(".card-actions").each(function(){var k=0;if($(".pull-right #integrated-tableview-actions div",this).size()>0){var j=".pull-right #integrated-tableview-actions";$(j,this).children(":not(.clear)").each(function(){var l=parseFloat($(this).outerWidth());k=k+l})}$(".pull-right",this).children("a").each(function(){var l=parseFloat($(this).outerWidth());k=k+l});k=Math.round(k*1.1,0);$(".card-actions-inner",this).css({width:k+"px"})})}}var e=new Date(1,1,2000,12,0,0);var f=false;var h=200;var c=$(window).width();$(window).resize(function(){if($(window).width()===c){return}c=$(window).width();e=new Date();if(f===false){f=true;setTimeout(i,h);for(id in datatables_by_id){autowidth.remove_column_widths(datatables_by_id[id])}}if(c>768){b()}$(".proto-content").css({left:"0px"});$(".sidebar-nav").removeClass("open")});function i(){if(new Date()-e<h){setTimeout(i,h)}else{f=false;for(id in datatables_by_id){autowidth.adjust_columns_to_tablewidth(datatables_by_id[id]);reorder_resize_tools.synchronize_scroller_body_to_head(datatables_by_id[id].fnSettings());update_column_menu(datatables_by_id[id],datatables_by_id[id])}setBreadcrumbs()}}$.extend($.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper form-inline"})}function initialize_help_texts(){if($(window).width()<=768){$(".help-block").each(function(){if(parseFloat($(this).height())>18){$(this).addClass("collapsed")}})}$(".help-block.collapsed").click(function(){$(this).toggleClass("open")})}function initialize_attachments(){$("#attachment-upload").change(function(){post_form()})}function initialize_modals(){$(".modal-caller").each(function(f,i){var c=$(i).data("relatedkey");var j=$(i).data("relatedappkey");var d=$(i).data("action");var g=$(i).data("target");var e="#"+jquery_selector_escape(g.substring(1));var b=$(i).data("id");var h=$("#card_form");var a=$(e).find("input");$(e).find(".btn-action").click(function(){a.each(function(){h.append(this)});post_form(null,d,b,c,j)})})}function initialize_selection_fields(){$(".parent-relation").each(function(a,b){initialize_select2_ajax_element(b)});$(".static-choice").select2();$(".select2-container").each(function(){$(this).find(".select2-focusser").hide();$(this).find(".select2-drop").not(".select2-with-searchbox").find(".select2-search").hide()})}function initialize_datetime_fields(){var a=$("input.datetime-picker-persistent");a.each(function(b,c){initialize_datetime_field(c,{language:$DATETIME_LOCALE,pickTime:$(c).data("datetime-display-setting")!==1,pickDate:$(c).data("datetime-display-setting")!==2})})}function initialize_color_fields(){function a(b){return"<div class='color color-"+b.id+"'></div>"}$(".color-choice").select2({minimumResultsForSearch:-1,dropdownCssClass:"colored-drop",formatResult:a,formatSelection:a,escapeMarkup:function(b){return b}})}function initialize_multilanguage_fields(){$(".multilanguage").each(function(a,b){initialize_multilanguage_field(b)})}function initialize_resizing(a){$(".card-resize").draggable({axis:"x",containment:".proto-content-holder",start:function(){for(id in a){autowidth.remove_column_widths(a[id])
}},drag:function(){var b=parseFloat($(this).css("left"))+9;$(".proto-content").css({width:b});if(b<720){}setBreadcrumbs()},stop:function(){var c=parseFloat($(this).css("left"))+9;if(c<720){c=720}localStorage.setItem("cardWidth",c);$(".proto-content").css({width:c});var b=c-9;$(".card-resize").css({left:b+"px"});setBreadcrumbs();for(id in a){autowidth.adjust_columns_to_tablewidth(a[id]);reorder_resize_tools.synchronize_scroller_body_to_head(a[id].fnSettings());update_column_menu(a[id])}}})}function initialize_breadcrumbs(){$(document).on("click","ol.breadcrumb .clickable",function(){$(".breadcrumbDropdown").toggle()});setBreadcrumbs()}function initialize_save_before_leaving_modal(){var a=$("#card_form");a.one("change keypress select2-selecting",null,ask_user_to_save_before_leaving);if(a.data("beforefirstsave")){ask_user_to_save_before_leaving()}}function initialize_js_editor(){$(".ace-editor").each(function(b,a){var d=$(a).prop("id");var c=ace.edit(d);c.setTheme("ace/theme/chrome");c.getSession().setMode("ace/mode/javascript");c.setValue($(a).data("content"));editors_by_element_id[d]=c})}function notify(c,a){var b="message";if(a==1){b="warning"}if(a==2){b="error"}$(".notification-holder").append('<div class="notification '+b+'"><p>'+c+"</p></div>");if($(".notification").size()>=1&&$(".notification-button").size()==0){$(".notification-holder").append('<div class="notification-button"></div>')}}var systemTools=new Tools("system");function get_notification_ml_text(e,f,d,c,g){var b="";var a="";if(e==="&&mlkey_longrunning_import_task_failed_live_prefix"){b="&&mlkey_longrunning_import_task_failed_live_postfix";a=" failed.\n Error messages: "}if(e==="&&mlkey_longrunning_export_task_failed_live_prefix"){b="&&mlkey_longrunning_export_task_failed_live_postfix";a=" failed.\n Error messages: "}if(e==="&&mlkey_longrunning_print_task_failed_live_prefix"){b="&&mlkey_longrunning_print_task_failed_live_postfix";a=" failed.\n Error messages: "}if(e==="&&mlkey_longrunning_export_task_succeeded_prefix"){b="&&mlkey_longrunning_export_task_succeeded_infix";a="'>here</a>"}else{if(e==="&&mlkey_longrunning_export_task_succeeded_infix"){b="&&mlkey_longrunning_export_task_succeeded_postfix";a="."}}if(e==="&&mlkey_longrunning_print_task_succeeded_prefix"){b="&&mlkey_longrunning_print_task_succeeded_infix";a="');'>print</a>"}else{if(e==="&&mlkey_longrunning_print_task_succeeded_infix"){b="&&mlkey_longrunning_print_task_succeeded_postfix";a=" the card now."}}if(e==="&&mlkey_longrunning_import_task_progress_live_prefix"){b="&&mlkey_longrunning_import_task_progress_live_postfix";a=".\n Percentage: "}if(e==="&&mlkey_longrunning_export_task_progress_live_prefix"){b="&&mlkey_longrunning_export_task_progress_live_postfix";a=".\n Percentage: "}if(e==="&&mlkey_longrunning_print_task_progress_live_prefix"){b="&&mlkey_longrunning_print_task_progress_live_postfix";a=".\n Percentage: "}systemTools.get_multilanguage_string(e,f,undefined,function(h){if(b===""){suffix="";if(c.length>=1){infix_info_string=c.shift()}else{infix_info_string=""}g(d+h+infix_info_string)}else{infix_info_string="";if(c.length>=1){infix_info_string=c.shift()}next_prefix=d+h+" "+infix_info_string;get_notification_ml_text(b,a,next_prefix,c,g)}})}function update_notification(a){jsonObject=a;live=jsonObject.live;type=jsonObject.task_type;taskid=jsonObject.taskid;state=jsonObject.state;infix_information=[];messages=jsonObject.messages;errors=jsonObject.errors;if(typeof known_messages==="undefined"){known_messages=[]}if(messages!=null&&messages!=""){for(message in messages){if($.inArray(messages[message],known_messages)==-1){notify(messages[message],0);known_messages.push(messages[message])}}}if(state=="FAILED"){if(type=="import"){appendToDocument(systemTools.get_multilanguage_string())}if(live){infix_information.push(jsonObject.human_readable_id);infix_information.push(jsonObject.errors);if(type=="import"){get_notification_ml_text("&&mlkey_longrunning_import_task_failed_live_prefix","Import task ","",infix_information,appendToDocument)
}if(type=="export"){get_notification_ml_text("&&mlkey_longrunning_export_task_failed_live_prefix","Export task ","",infix_information,appendToDocument)}if(type=="print"){get_notification_ml_text("&&mlkey_longrunning_print_task_failed_live_prefix","Print task ","",infix_information,appendToDocument)}return}else{get_notification_ml_text("&&mlkey_longrunning_task_failed","An error occured while starting the task. We don't have any more information.","",infix_information,appendToDocument);return}}else{if(state=="SUCCESS"||state=="FINISHED"){if(type=="import"){get_notification_ml_text("&&mlkey_longrunning_import_task_succeeded","Import task finished successfully. Please <a href='javascript:window.location.reload();'>reload</a> the tableview in order to see the new imported cards.","",infix_information,appendToDocument)}else{if(type=="export"){infix_information.push(jsonObject.url);get_notification_ml_text("&&mlkey_longrunning_export_task_succeeded_prefix","Export task finished successfully. You can download the spreadsheet data <a href='","",infix_information,appendToDocument)}else{if(type=="print"){infix_information.push(jsonObject.url);get_notification_ml_text("&&mlkey_longrunning_print_task_succeeded_prefix","Print task has finished successfully. You can <a href='javascript: w=window.open('","",infix_information,appendToDocument)}else{appendToDocument("Task "+taskid+" finished successfully.")}}}if(errors!=null&&errors!=""){errors.forEach(function(b){notify(b,2)})}return}}if(errors!=null&&errors!=""){errors.forEach(function(b){notify(b,2)})}setTimeout(function(){refresh_data(taskid)},5000);if(type==""){}else{if(type=="import"){if(live){infix_information.push(jsonObject.stage);infix_information.push(jsonObject.percentage+"%");get_notification_ml_text("&&mlkey_longrunning_import_task_progress_live_prefix","Import task is currently ","",infix_information,appendToDocument)}else{get_notification_ml_text("&&mlkey_longrunning_import_task_pending","Import task is currently pending.","",infix_information,appendToDocument)}}else{if(type=="export"){if(live){infix_information.push(jsonObject.stage);infix_information.push(jsonObject.percentage+"%");get_notification_ml_text("&&mlkey_longrunning_export_task_progress_live_prefix","Export task is currently ","",infix_information,appendToDocument)}else{get_notification_ml_text("&&mlkey_longrunning_export_task_pending","Export task is currently pending.","",infix_information,appendToDocument)}}else{if(type=="print"){if(live){infix_information.push(jsonObject.stage);infix_information.push(jsonObject.percentage+"%");get_notification_ml_text("&&mlkey_longrunning_export_task_progress_live_prefix","Print task is currently ","",infix_information,appendToDocument)}else{get_notification_ml_text("&&mlkey_longrunning_print_task_pending","Print task is currently pending.","",infix_information,appendToDocument)}}else{if(live){stage=jsonObject.stage;percentage=jsonObject.percentage;appendToDocument("Task "+taskid+" is currently "+stage+".\n Percentages: "+percentage+"%, State: "+state+".")}else{appendToDocument("Task "+taskid+" is currently pending.")}}}}}}function check_for_demo_mode(){if(get_cookie("demo-mode")==="true"){$(".message").hide();$(".warning").hide();$(".error").hide();$(".footer").find("p").prepend("Demo mode active; ")}}function appendToDocument(a){document.getElementById("longrunning_task_msg_inner_html").innerHTML=a;return}function refresh_data(b){var a=window.location;var c=a.protocol+"//"+a.host+"/";getLongrunningUpdate(c,b)}function getLongrunningUpdate(b,a){url=b+"api/v2/tasks/";url=url+a;$.ajax({type:"GET",url:url,contentType:"application/json; charset=utf-8",dataType:"json",success:function(c){if(c.errors.length!=0){notify("We are very sorry, the server task has responded with an error. Please send the following to the environment administrators: "+JSON.stringify(c.errors),2)}else{update_notification(c.result)}},error:function(c){notify("We are very sorry, there was a communication error during the task state update. Please send the following to the environment administrators: "+JSON.stringify(c),2)
}})}$(document).on("change",".btn-file :file",function(){var a=$(this),c=a.get(0).files?a.get(0).files.length:1,b=a.val().replace(/\\/g,"/").replace(/.*\//,"");a.trigger("fileselect",[c,b])});var datatables_by_id={};$(document).ready(function(){try{RequestHandler.initializeRootElement();reset_forms_to_html();update_datetime_fields();initialize_tableviews();initialize_help_texts();initialize_attachments();initialize_modals();initialize_selection_fields();initialize_datetime_filter_fields();initialize_datetime_fields();initialize_non_persistent_fields();initialize_color_fields();initialize_resizing(datatables_by_id);initialize_breadcrumbs();initialize_save_before_leaving_modal();initialize_js_editor();check_for_demo_mode();if($CLIENT==="iOS"){initialize_client_settings_menu()}$(".btn-file :file").on("fileselect",function(e,f,c){var b=$(this).parents(".input-group").find(":text"),d=f>1?f+" files selected":c;if(b.length){b.val(d)}else{if(d){alert(d)}}})}catch(a){alert("Terribly sorry, the javascript client has thrown an error: "+a.message);if(isFunction(console.trace)){console.trace()}}});