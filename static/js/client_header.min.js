...
},aB.show=function(i){if(!ay().prop("disabled")){if(aB.options.useCurrent&&""===ay().val()){if(1!==aB.options.minuteStepping){var k=e(),j=aB.options.minuteStepping;k.minutes(Math.round(k.minutes()/j)*j%60).seconds(0),aB.setValue(k.format(aB.format))}else{aB.setValue(e().format(aB.format))}av("",i.type)}i&&"click"===i.type&&aB.isInput&&aB.widget.hasClass("picker-open")||(aB.widget.hasClass("picker-open")?(aB.widget.hide(),aB.widget.removeClass("picker-open")):(aB.widget.show(),aB.widget.addClass("picker-open")),aB.height=aB.component?aB.component.outerHeight():aB.element.outerHeight(),aw(),aB.element.trigger({type:"dp.show",date:e(aB.date)}),ac(),i&&ah(i))}},aB.disable=function(){var d=ay();d.prop("disabled")||(d.prop("disabled",!0),ab())},aB.enable=function(){var d=ay();d.prop("disabled")&&(d.prop("disabled",!1),ad())},aB.hide=function(){var i,k,j=aB.widget.find(".collapse");for(i=0;i<j.length;i++){if(k=j.eq(i).data("collapse"),k&&k.transitioning){return}}aB.widget.hide(),aB.widget.removeClass("picker-open"),aB.viewMode=aB.startViewMode,ae(),aB.element.trigger({type:"dp.hide",date:e(aB.date)}),aa()},aB.setValue=function(d){e.locale(aB.options.language),d?aB.unset=!1:(aB.unset=!0,Y()),d=e.isMoment(d)?d.locale(aB.options.language):d instanceof Date?e(d):e(d,aB.format,aB.options.useStrict),d.isValid()?(aB.date=d,Y(),aB.viewDate=e({y:aB.date.year(),M:aB.date.month()}),ap(),al()):au(d)},aB.getDate=function(){return aB.unset?null:e(aB.date)},aB.setDate=function(d){var i=e(aB.date);aB.setValue(d?d:null),av(i,"function")},aB.setDisabledDates=function(d){aB.options.disabledDates=U(d),aB.viewDate&&at()},aB.setEnabledDates=function(d){aB.options.enabledDates=U(d),aB.viewDate&&at()},aB.setMaxDate=function(d){void 0!==d&&(aB.options.maxDate=e.isMoment(d)||d instanceof Date?e(d):e(d,aB.format,aB.options.useStrict),aB.viewDate&&at())},aB.setMinDate=function(d){void 0!==d&&(aB.options.minDate=e.isMoment(d)||d instanceof Date?e(d):e(d,aB.format,aB.options.useStrict),aB.viewDate&&at())},az()};f.fn.datetimepicker=function(a){return this.each(function(){var d=f(this),b=d.data("DateTimePicker");b||d.data("DateTimePicker",new g(this,a))})},f.fn.datetimepicker.defaults={format:!1,pickDate:!0,pickTime:!0,useMinutes:!0,useSeconds:!1,useCurrent:!0,calendarWeeks:!1,minuteStepping:1,minDate:e({y:1900}),maxDate:e().add(100,"y"),showToday:!0,collapse:!0,language:e.locale(),defaultDate:"",disabledDates:!1,enabledDates:!1,icons:{},useStrict:!1,direction:"auto",sideBySide:!1,daysOfWeekDisabled:[],widgetParent:!1}});var autowidth=mod_column_autowidth();var reorder_resize_tools=mod_reorder_resize_tools();var editors_by_element_id={};function createKey(){function a(){return Math.floor((1+Math.random())*65536).toString(16).substring(1)}return a()+a()+a()+a()}function get_form_data(){var a={};$("#card_form input, #card_form textarea").each(function(c,d){var b=$(d).attr("name");if(typeof(b)!=="string"||b===""){return}var e=$(d).val();a[b]=e});return JSON.stringify(a)}var RequestHandler=(function(){var b={};function c(g,e){var d=document.getElementById("RequestHandlerIFramesContainer");var f=document.createElement("iframe");f.id="RequestFrame"+g;f.src="fake://"+g+"/"+e;d.appendChild(f)}function a(f){var e=document.getElementById("RequestFrame"+f);if(e!==null){var d=document.getElementById("RequestHandlerIFramesContainer");d.removeChild(e)}}this.initializeRootElement=function(){var d=document.createElement("div");d.style.display="none";d.id="RequestHandlerIFramesContainer";document.body.appendChild(d)};this.sendRequest=function(d){var e=createKey();b[e]=d;c(e,d.url)};this.receiveResponse=function(g,d){try{if(b[g]!==null){var f=b[g];a(g);b[g]=null;f.responseText=d;f.readyState=4;f.status=200;if(f.onreadystatechange!==undefined&&f.onreadystatechange!==null){f.onreadystatechange()}return"OK"}return"ID NOT FOUND"}catch(e){return"ERROR: "+e.message}};return this})();if($CLIENT==="iOS"){XMLHttpRequest=function(){var a=this;this.onreadystatechange=null;this.send=function(){RequestHandler.sendRequest(a)};this.open=function(d,b,c){a.method=d;a.url=b}}}function get_default_sorting(b){var c=-1;var a="asc";b.find("th").each(function(d,e){if(c<0&&!($(e).hasClass("non-sortable"))){c=d;if($(e).data("valuetype")==="date"){a="desc"}}});if(c>-1){return[[c,a]]}else{return[]}}function set_default_sort_column(i,j,c){var f=false;var b=-1;var g=0;var a=-1;var h=-1;var e=-1;for(var d=0;d<j.length;d++){if(b>-1||$(j[d].nTh).hasClass("non-sortable")){continue}b=d}for(var d=0;d<i.length;d++){if(i[d].name==="iSortingCols"){g=i[d].value;e=d}else{if(i[d].name==="iSortCol_0"){a=d}else{if(i[d].name==="iSortDir_0"){h=d}}}}if(g==0&&b>0){if(e>-1){i[e].value=1}else{i.push({name:"iSortingCols",value:1})}if(a>-1){i[a].value=b}else{i.push({name:"iSortCol_0",value:b})}if(h>-1){i[h].value="desc"}else{i.push({name:"iSortDir_0",value:"desc"})}c.aaSorting=[[b,"desc",0]]}}function prepare_datatables_for_serverdata(j,f,a){var d=$(f).dataTable();var g=get_filters_by_column_key(f);var e=false;for(var h in g){j.push({name:"sFilter_"+h,value:g[h]});e=true}for(var c=0;c<j.length;c++){if(j[c].name==="sSearch"&&typeof(j[c].value)==="string"&&j[c].value!==""){e=true}}if(typeof(d)==="object"&&d!==null){var b=d.fnSettings();var i=b.aoColumns;if(e===true){update_sortable(i,false)}else{update_sortable(i,true)}}j.push({name:"proto_key",value:a});$(f).data("last_request_body",j)}function get_datatables_serverdata_function(c,b,a){if($CLIENT==="iOS"){return function(e,f,j){prepare_datatables_for_serverdata(f,c,a);var h=new XMLHttpRequest();h.onreadystatechange=function(){if(h.readyState==4&&h.status==200){j(JSON.parse(decodeURIComponent(h.responseText)))}};var d={};for(var g=0;g<f.length;g++){d[f[g].name]=f[g].value}h.open("GET",encodeURIComponent(JSON.stringify(d))+"/"+e,true);h.send()}}else{return function(d,e,f){prepare_datatables_for_serverdata(e,c,a);$.ajax({dataType:"json",url:d,data:e,timeout:10000,success:function(g){f(g)}})}}}function prepare_app_id(b,d){var a="";if(typeof(b)==="string"&&b!==""){a=b}else{var c=$("select[name='"+d+"']");if(c.length>0){a=c.val()}}return a}function get_select2_serverdata_function(a,c,e,d,b){return function(g){var i={search_term:g.term,related_app_id:prepare_app_id(c,e),element_id:$(d).prop("name"),proto_key:b,page_num:g.page};var f=get_filters_by_column_key(d,false);for(column_key in f){i["filter_"+column_key]=f[column_key]}var j=$(d).data("couchdb-viewname");if(typeof(j)==="string"&&j!==""){i.couchdb_viewname=j}if($CLIENT==="iOS"){var h=new XMLHttpRequest();h.onreadystatechange=function(){if(h.readyState==4&&h.status==200){g.callback(JSON.parse(decodeURIComponent(h.responseText)))
}};h.open("GET",encodeURIComponent(JSON.stringify(i))+"/"+a,true);h.send()}else{$.ajax({dataType:"json",url:a,data:i,timeout:10000,success:function(k){g.callback(k)}})}}}function get_select2_initdata_function(a,b){return function(f,j){var i=$(f).val();if(typeof(i)!=="string"||$.trim(i)===""){var c=$("#card_form").data("parentcardkey");var h=$("#card_form").data("parentprotokey");if(typeof(c)!=="string"||c===""||typeof(h)!=="string"||h===""||$(f).data("protokey")!==h){return}i=c;$(f).val(i).trigger("change")}var d=$(f).data("origin");var g={related_app_id:prepare_app_id(a,b),related_id:i};if($CLIENT==="iOS"){var e=new XMLHttpRequest();e.onreadystatechange=function(){if(e.readyState==4&&e.status==200){j(JSON.parse(decodeURIComponent(e.responseText)).results[0])}};e.open("GET",encodeURIComponent(JSON.stringify(g))+"/"+d,true);e.send()}else{$.ajax({url:d,data:g,dataType:"json"}).done(function(k){j(k.results[0])})}}}jQuery.fn.dataTableExt.oApi.fnSetFilteringDelay=function(c,b){var a=this;if(b===undefined){b=500}this.each(function(e){$.fn.dataTableExt.iApiIndex=e;var g=this,d=null,h=null,f=$("input",a.fnSettings().aanFeatures.f);f.unbind("keyup").bind("keyup",function(){var i=g;if(h===null||h!=f.val()){window.clearTimeout(d);h=f.val();d=window.setTimeout(function(){$.fn.dataTableExt.iApiIndex=e;a.fnFilter(f.val())},b)}});return this});return this};function ask_user_to_save_before_leaving(){var a=$("#card_form");if(a.data("saveable")!==true){return}$("#save_button,#save_and_close_button").removeAttr("disabled");$("a[onclick*='post_form'],button[onclick*='post_form'],.click-to-open").each(function(b,c){var d=$(c).data("modalname");if(typeof(d)!=="string"){return}d="#"+d;$(c).prop("href",d);$(c).removeAttr("onclick");$(c).off("click");$(c).click(function(){var k=$(c).data("action");var e=$(c).data("id");var h=$(c).data("relatedkey");var f=$(c).data("relatedappkey");var j=$(c).parents("tr");if((typeof(h)!=="string"||h==="")&&j.length>0){h=$(j[0]).data("key")}var g=null;var i=$(c).parents("form");if(i.length>0){g=$(i[0]).data("protokey")}$("a[id*='confirm_link_modal']").click(function(){post_form(g,k,e,h,f)});$(d).modal("show");return false})})}function post_form(a,d,b,e,h){var i=$("#card_form");if(typeof(a)!=="string"&&d!=="edit_related_card"){a=i.data("protokey")}post_save_action=i.data("postsaveaction");var c={};if(typeof(a)==="string"){c.proto_key=a}if(typeof(d)==="string"){c.action=d}if(typeof(b)==="string"){c.element_id=b}if(typeof(e)==="string"){c.related_card_key=e}if(typeof(h)==="string"){c.related_app_id=h}if(typeof(post_save_action)==="string"&&post_save_action!=""){c.post_save_action=post_save_action}var g=$(".manual-ordering");g.each(function(m,k){var l=$(k).prop("id");var n=$(k).find("tbody tr");var o=[];n.each(function(p,q){o.push($(q).data("key"))});c[l]=o});for(var b in editors_by_element_id){var f=editors_by_element_id[b];c[b]=f.getValue()}i.find(".dataTables_scrollBody > .ajax-ordering").each(function(k,l){var p=$(l).prop("id");var m=$(l).data("last_request_body");var n=i.find("#tableview_formgroup_"+jquery_selector_escape(p));var o=n.find(".last_request_body");o.val(JSON.stringify(m))});i.find("input.date").each(function(o,n){var m=$(n).val();var k=["dd L LT","dd L","LLLL","llll","LLL","lll","LL","ll","L","l","L LT"];var p=moment(m,k,$DATETIME_LOCALE,true);if($(n).data("datetime-display-setting")===1){p=moment(m+" Z","dd L Z",$DATETIME_LOCALE,true)}if(!(p.isValid())){console.log("WARNING: Date "+m+" could not be parsed: "+p.invalidAt())}else{var l=$(n).attr("name");c[l]=p.toISOString()}});var j="?";for(param_key in c){j+=param_key+"="+encodeURIComponent(c[param_key])+"&"}if(i.length==0){i=$("<form method=post></form>");i.appendTo("body")}i.prop("action",j);i.submit()}function reset_forms_to_html(){$("input").each(function(){if(!this.getAttribute("checked")!=!this.checked){$(this).click()}else{$(this).val(this.getAttribute("value")||"")}});$("select").each(function(){var c=$("option",this),b=0;for(var a=0;a<c.length;a++){if(c[a].getAttribute("selected")){b=a
}}this.selectedIndex=b||0})}function jquery_selector_escape(a){if(a){return a.replace(/([ #;?%&,.+*~\':"!^$[\]()=>|\/@])/g,"\\$1")}else{return a}}function toggle_column(a,e){var d=a.fnSettings().aoColumns[e];var c=$(d.nTh);var b=c.data("displaypriority_override");var f=false;if(d.bVisible||b===10){c.data("displaypriority_override",0)}else{c.data("displaypriority_override",10);f=true}autowidth.remove_column_widths(a);autowidth.adjust_columns_to_tablewidth(a);reorder_resize_tools.synchronize_scroller_body_to_head(a.fnSettings());return f}function toggle_column_checker(a,c,b){$(c).prop("checked",toggle_column(a,b))}function update_columns_button(b){var d=b.fnSettings();var c=$(d.nTableWrapper);var g=c.find(".column-list");if(g.length===0){g=$(".column-list")}var a=g.find("li");var f="<button type='button' class='btn btn-default btn-sm dropdown-toggle columns-chooser' data-toggle='dropdown'>	Columns: "+String(a.find(":checked").length)+" of "+String(a.length)+"	<span class='caret'></span>	</button>";var e=$(g).find(".columns-chooser");if(e.length===0){e=$(f);g.prepend(e)}else{e.remove();g.prepend($(f))}}function update_column_menu(f,h){var l=$("<div class='input-group-btn column-list'></div>");var c=$("<ul class='dropdown-menu pull-right'></ul>").appendTo(l);var a=f.fnSettings().aoColumns;var d=0;for(var p=0;p<a.length;p++){if($(a[p].nTh).hasClass("always-visible")){d+=1;continue}var r=a[p].sTitle;var b=$("<li></li>").appendTo(c);var g=$("<label> "+r+"</label>").appendTo(b);var t=a[p].bVisible;var k=$("<input type='checkbox'>");if(t){k.prop("checked","checked");d+=1}g.prepend(k);var j=(function(u,i){return function(v){v.stopPropagation();toggle_column_checker(f,u,i);update_column_menu(f,h)}})(k,p);k.click(j);b.click(function(i){i.stopPropagation()})}$(h).find(".dataTables_empty").prop("colspan",String(d));var m=f.prop("id");var s=f.fnSettings();var n=$(s.nTableWrapper);var q=null;if($(f).hasClass("table-controls-in-header")){q=$("#integrated-tableview-actions")}else{q=n.find(".horicontal-group")}var o=q.find(".column-list");o.remove();var e=q.find(".merged");if(e.length!==0){q.find(".merged").before(l)}else{q.append(l)}update_columns_button(f)}function initialize_select2_ajax_element(d,c){if(c===undefined){c=$(d).data("protokey")}var b=$(d).data("app-id");var e="";if(typeof(b)!=="string"||b===""){e=$(d).data("app-choice-element");$("select[name='"+e+"']").on("change",function(){$(d).select2("val","")})}var f="enable";if($(d).data("disabled")==="disabled"){f="disable"}var g=0;var a=get_filters_by_column_key(d,false,true);if(Object.keys(a).length>0){g=-1}if($(d).select2){$(d).select2("destroy")}$(d).select2({allowClear:true,enable:$(d).data("disabled")!=="disabled",dropdownCssClass:"bigdrop",minimumResultsForSearch:g,query:get_select2_serverdata_function($(d).data("origin"),b,e,d,c),initSelection:get_select2_initdata_function(b,e),formatResult:function(h){return"<div>"+h.text+"</div>"},formatSelection:function(h){return h.text}}).select2(f);$(d).parent().find(".clear").click(function(){$(d).select2("val","");$(d).trigger("change")})}function initialize_multilanguage_field(a){$(a).parent().find(".clear").click(function(){$(a).val("");$(a).prop("disabled","");$(a).trigger("change");$(a).parent().find(".edit-options").remove()})}function initialize_datatable_controls(f,h,e,m,c){var s=f.fnSettings();var o=$(s.nTableWrapper);var t=o.find(".tableview-footer");var a=o.find(".dataTables_processing").appendTo(t);var k=o.find(".col-tableview-controls");var n=o.find(".dataTables_filter");if(n.length==0){n=$("<div></div>").appendTo(k)}n.addClass("input-group pull-right horicontal-group");var q=n;if($(h).hasClass("table-controls-in-header")){q=$("#integrated-tableview-actions")}var u=$("<div class='input-group-btn'></div>");var j=[];if(m.length>0&&m.charAt(0)!=="&"){j=$("."+m+"-tableview-button-override")}if(j.length>0){j.appendTo(u);u.appendTo(q)}else{if(($(h).hasClass("manual-ordering")&&$(h).data("editable")===true)||(!($(h).hasClass("manual-ordering"))&&typeof(e)==="string"&&e!==""&&$(h).data("show-create-button")!==false)){var r=$("#tableviewAddActionModal_"+jquery_selector_escape(m));
var p=r.data("choicetype");var b=$CREATE_LABEL;if(p==="existing_card"||p==="object_key"){var b=$ADD_LABEL}var d=$("<button type='button' class='btn btn-default btn-sm'>"+b+"</button>").appendTo(u).click(function(){var x=function(A){if($("#card_form").data("saveable")===true){post_form(A,"save_and_open_new_card",m,null)}else{post_form(A,"open_new_card",m,null)}};var z=$(h).data("creationprotokey");if(typeof(z)!=="string"||z===""){z=e}var w=z.indexOf("Definition");if(w!==-1){z=z.substring(0,w)}if(r.length>0){var v=r.find("[name*='card_proto_choice']");if(p!=="static_card"&&p!=="object_key"){initialize_select2_ajax_element(v,e)}var y=r.find("#confirm_link_modal_add_card");y.click(function(){if(p==="static_card"){var C=v.select2("data").id;x(C)}else{var B=v.select2("data").id;var A=$(h).find("tbody");$("<tr></tr>").data("key",B).appendTo(A);post_form(null,null,null,null)}});r.modal("show")}else{x(z)}});u.appendTo(q)}}o.parent().find(".edit-options").appendTo(q);if(s.oInit.bFilter!==false){var i=$("<div class='input-group merged'><span class='input-group-addon search-addon glyphicon glyphicon-search'></span></div>").appendTo(q);var l=n.find("input");l.addClass("form-control tableview-search").appendTo(i).on("focus blur",function(){$(this).prev().toggleClass("focusedInput")});var g=n.find("label");g.remove()}if($(h).hasClass("table-controls-in-header")){k.parent().remove()}else{if(typeof(c)==="string"&&c!==""){var g=$("<label>"+c+"</label>");k.prepend(g)}}reorder_resize_tools.update_resize_handles(f);$(h).on("column-reorder",function(){update_column_menu(f,h);reorder_resize_tools.update_resize_handles(f)})}function update_click_handlers(d,g){var m=d.fnSettings().fnRecordsTotal();var l=d.fnSettings().aoColumns;if(l.length>0){var c=$(l[0].nTh).find(".selected-all");var k=c.prop("checked");$(g).find(".selected-single").prop("checked",k);c.on("change",function(){var i=c.prop("checked");$(g).find(".selected-single").prop("checked",i)})}for(var a=0;a<m;a++){var j=d.fnGetTds(a);if(!(Array.isArray(j))){continue}var b="";for(var f=0;f<j.length;f++){var e=$(j[f]).children(":first");if(e.data("type")==="key"){b=e.text();break}}if((typeof(b)!=="string"||b==="")&&j.length>0){b=$(j[0]).parent().data("key")}for(var f=0;f<j.length;f++){if(!($(j[f]).hasClass("no-click-to-open"))&&$(j[f]).find(".no-click-to-open").length>0){$(j[f]).addClass("no-click-to-open");continue}if($(j[f]).hasClass("no-click-to-open")){continue}var h=(function(i){return function(n){n.stopPropagation();post_form(null,"no_update_and_edit_related_card",null,i,$(g).data("relatedappkey"))}})(b);$(j[f]).click(h);$(j[f]).addClass("click-to-open");$(j[f]).attr("data-action","edit_related_card");$(j[f]).attr("data-relatedkey",$(g).data("relatedappkey"));$(j[f]).attr("data-relatedappkey","");$(j[f]).attr("data-modalname","saveChangesModal");$(j[f]).attr("data-toggle","modal")}}}function get_aoColumns_of_ajax_tableview(b){var c=get_object_keys(get_filters_by_column_key(b)).length>0;var a=[];$(b).find("th").each(function(e,g){var d=$(g).data("identifier");var f=c!==true&&!($(g).hasClass("non-sortable"));if(typeof(d)==="string"&&d!==""){a.push({mData:d,bSortable:f})}});return a}function update_datetime_fields(){$(".datetime").each(function(a,e){var c=$(e).data("utc-iso");if(typeof(c)!=="string"||c===""){return}moment.locale($DATETIME_LOCALE);var b=moment.utc(c);var d="dd L LT";var f=null;if($(e).data("datetime-display-setting")===1){d="dd L";f=b.format(d)}else{f=b.local().format(d)}if($(e).is("input")){$(e).val(f)}else{$(e).html(f)}})}function get_object_keys(a){var c=[];for(var b in a){if(a.hasOwnProperty(b)){c.push(b)}}return c}function initialize_filter_update_handlers(d,a){var f=$(d).data("filter-column-keys-by-element");var e=get_object_keys(f);for(var c=0;c<e.length;c++){if(e[c]==="#"){continue}var b=$("input#"+e[c]);b.on("change",function(g){a.fnDraw()})}}function get_filter_column_keys_by_element(b){var a=$(b).data("filter-column-keys-by-element");if(typeof(a)!=="object"||a===null){return{}
}return a}function get_column_keys_available_for_multiindex(b){var a=$(b).data("column-keys-available-for-multiindex");if(!(Array.isArray(a))){return[]}return a}function get_filters_by_column_key(j,f,k){if(typeof(f)!=="boolean"){f=true}if(typeof(k)!=="boolean"){k=false}var h={};var g=get_filter_column_keys_by_element(j);var b=get_column_keys_available_for_multiindex(j);var c=get_object_keys(g);for(var e=0;e<c.length;e++){var l=g[c[e]];if(get_object_keys(h).length>0&&b.indexOf(l)===-1){continue}if(c[e]==="#"){if(f===true){h[l]=$("#card_form").data("key")}continue}var d=$("input#"+c[e]);if(d.length==0){continue}var a=null;if(d.hasClass("parent-relation")){a=d.val()}else{a=d.data("key")}if(k===true||(typeof(a)==="string"&&a!=="")){h[l]=a}}return h}function get_select_elements_acting_as_filter(a){var c=get_column_keys_available_for_multiindex(a);var h=get_filter_column_keys_by_element(a);var f=get_object_keys(h);var b=[];for(var e=0;e<f.length;e++){var g=h[f[e]];if(b.length>0&&c.indexOf(g)===-1){continue}if(f[e]==="#"){continue}var d=$("input#"+f[e]);if(d.length==0){continue}b.push(d)}return b}function update_sortable(c,b){if(typeof(b)!=="boolean"){b=false}for(var a=0;a<c.length;a++){if(b===true&&($(c[a].nTh).hasClass("non-sortable"))){continue}c[a].bSortable=b;c[a].sSortingClass=(b?"sorting":"sorting_disabled");$(c[a].nTh).removeClass((b?"sorting_disabled":"sorting sorting_asc sorting_desc")).addClass((b?"sorting":"sorting_disabled"))}}function open_tableview_for_smartphones(c,d,e){if($(c).parents(".tableViewModal").length){return}var g=parseFloat($(window).height())-170-30;var b=$(c).attr("data-tableview-title");var f=$(".dataTables_scroll",c).html();var a=$("table.dataTable:last",c).attr("id");console.log("table id:"+a);var h=$(".dataTables_filter",c).html();var i=a;$("body").append('<div class="tableViewModal" data-table-id="'+a+'"><div class="card-actions-fade-left"></div><div class="card-actions-fade-right"></div><div class="card-header"><div class="card-title"><span>'+b+'</span></div><a href="#" class="modalClose"></a></div><div class="card-content"></div>');$(c).closest(".form-group").addClass("placeholder_"+a);$(c).appendTo(".tableViewModal");$(".tableViewModal .dataTables_wrapper .dataTables_scrollBody").css({height:g+"px"});$(".tableViewModal[data-table-id='"+a+"'] .col-tableview-controls").addClass("card-actions");$(".tableViewModal[data-table-id='"+a+"'] .col-tableview-controls label:first").hide();$(".tableViewModal").animate({bottom:"0"},e,function(){for(a in d){autowidth.adjust_columns_to_tablewidth(d[a]);reorder_resize_tools.synchronize_scroller_body_to_head(d[a].fnSettings());update_column_menu(d[a],d[a])}var j=0;$(".tableViewModal[data-table-id='"+i+"'] .dataTables_filter").children(":not(.clear)").each(function(){var k=parseFloat($(this).outerWidth());j=j+k});j=Math.round(j*1.1,0);$(".tableViewModal[data-table-id='"+i+"'] .dataTables_filter").css({width:j+"px"})})}function setBreadcrumbs(){var b=parseFloat($(".card-header").width());var a=(b-200-40-30)/2;var c=parseFloat($("ol.breadcrumb").width());var d="no";if(c>a){if(d!="once"||d!="twice"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");d="no"}if(parseFloat($("ol.breadcrumb li:last").width())+30>a){if(d!="twice"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");$("ol.breadcrumb li").addClass("hidden");$("ol.breadcrumb").prepend('<li class="clickable">&hellip;<ul class="breadcrumbDropdown">'+$("ol.breadcrumb").html()+"</ul></li>");$("ol.breadcrumb li ul li").removeClass("hidden");d="twice"}}else{if(d!="once"){$("ol.breadcrumb li.clickable").remove();$("ol.breadcrumb li.hidden").removeClass("hidden");$("ol.breadcrumb li").not(":last").addClass("hidden");$("ol.breadcrumb").prepend('<li class="clickable">&hellip;<ul class="breadcrumbDropdown">'+$("ol.breadcrumb").html()+"</ul></li>");$("ol.breadcrumb li ul li").removeClass("hidden");d="once"}}}else{if(d!="once"||d!="twice"){$("ol.breadcrumb li.clickable").remove();
$("ol.breadcrumb li.hidden").removeClass("hidden");d="no"}}$("ol.breadcrumb").show().animate({opacity:"1"},300)}function initialize_tableviews(){var d={};var a={};$(".tableview").each(function(j,k){var l=$(k).prop("id");a[l]=false;d[l]=k});$(window).on("table-data-ready",function(){var k=false;for(id in a){if(a[id]===false){k=true;break}}if(!k){for(datatable_id in datatables_by_id){var j=datatables_by_id[datatable_id];autowidth.remove_column_widths(j)}for(datatable_id in datatables_by_id){var j=datatables_by_id[datatable_id];autowidth.adjust_columns_to_tablewidth(j);reorder_resize_tools.synchronize_scroller_body_to_head(j.fnSettings());update_column_menu(j,d[datatable_id])}setTimeout(function(){g()},500)}});$(".ajax-ordering").each(function(q,r){var j="";var l=$(r).data("protokey");if(typeof(l)==="string"&&l!==""){j="/"+encodeURIComponent(l)}var o=$(r).data("label");var k=$(r).prop("id");var m="/"+encodeURIComponent(k);var s=get_aoColumns_of_ajax_tableview(r);var p=$(r).data("tableheight");if($(r).hasClass("table-controls-in-header")){p=$(".card-content").height()-74}var n=$(r).dataTable({sDom:'<"row"<"col-xs-12 col-tableview-controls"rf>><"row"<"col-xs-12"Rlt<"tableview-footer"i>S>>',sScrollY:p,bScrollCollapse:true,bProcessing:true,bServerSide:true,bLengthChange:false,bAutoWidth:false,bScrollAutoCss:false,fnServerData:get_datatables_serverdata_function(r,k,l),fnDrawCallback:function(t){update_datetime_fields();update_click_handlers(n,r);if(typeof(form)==="object"&&form!==null&&form.data("beforefirstsave")){ask_user_to_save_before_leaving()}a[k]=true;$(window).trigger("table-data-ready")},sAjaxSource:$(r).data("origin")+m+j,aoColumns:s,aaSorting:get_default_sorting($(r)),oLanguage:{sSearch:"",sProcessing:"<span class='glyphicon glyphicon-time'></span>",sInfo:"Total: _TOTAL_ Cards"}}).fnSetFilteringDelay();datatables_by_id[k]=n;n.bind("filter",function(){var v=n.fnSettings();var x=$(v.nTableWrapper).find(".tableview-search");var w=x.val();if(v.bFiltered&&typeof(w)==="string"&&w!==""){var u=v.aoColumns;update_sortable(u,false)}else{var u=v.aoColumns;for(var t=0;t<u.length;t++){initColumn=v.oInit.aoColumns[t]}update_sortable(u,true)}});initialize_datatable_controls(n,r,l,k,o);initialize_filter_update_handlers(r,n)});$(".manual-ordering").each(function(l,n){var o=$(n).data("label");var p=$(n).prop("id");var j=$(n).data("protokey");var m=$(n).data("editable");var k=$(n).dataTable({sDom:'<"row"<"col-xs-12 col-tableview-controls"f>><"row"<"col-xs-12"Rlrti>>',bPaginate:false,bJQueryUI:true,bFilter:false,bSort:false,bInfo:false,bAutoWidth:false});datatables_by_id[p]=k;initialize_datatable_controls(k,n,j,p,o);update_click_handlers(k,n);update_column_menu(k,n);if(m===true&&!($(n).hasClass("disable-reorder"))){$(n).rowReordering()}a[p]=true;$(window).trigger("table-data-ready")});$("form:not(.tableview-only-card) .dataTables_wrapper").each(function(){var j=$(".row label:first",this).html();$(this).attr({"data-tableview-title":j});if($(window).width()<768){$(this).append('<div class="tableViewWrapperLabel">'+j+"</div>")}});$("form:not(.tableview-only-card) div:not(.tableViewModal) .dataTables_wrapper").click(function(){if($(window).width()<768){open_tableview_for_smartphones($(this),datatables_by_id,300)}});function b(){$(".tableViewModal").each(function(){$(this).closest(".tableViewModal").animate({bottom:"-100%"},1,function(){var j=$(this).attr("data-table-id");$(".dataTables_wrapper",this).prependTo(".form-group.placeholder_"+j);$(this).hide()})});$(".tableViewWrapperLabel").remove()}$(document).on("click",".modalClose",function(){$(this).closest(".tableViewModal").animate({bottom:"-100%"},300,function(){var j=$(this).attr("data-table-id");$(".dataTables_wrapper",this).prependTo(".form-group.placeholder_"+j);$(this).hide()})});function g(){if($(window).width()<768&&$(".card-actions").size()>=1){$(".card-actions").each(function(){var k=0;if($(".pull-right #integrated-tableview-actions div",this).size()>0){var j=".pull-right #integrated-tableview-actions";
$(j,this).children(":not(.clear)").each(function(){var l=parseFloat($(this).outerWidth());k=k+l})}$(".pull-right",this).children("a").each(function(){var l=parseFloat($(this).outerWidth());k=k+l});k=Math.round(k*1.1,0);$(".card-actions-inner",this).css({width:k+"px"})})}}var e=new Date(1,1,2000,12,0,0);var f=false;var h=200;var c=$(window).width();$(window).resize(function(){if($(window).width()===c){return}c=$(window).width();e=new Date();if(f===false){f=true;setTimeout(i,h);for(id in datatables_by_id){autowidth.remove_column_widths(datatables_by_id[id])}}if(c>768){b()}$(".proto-content").css({left:"0px"});$(".sidebar-nav").removeClass("open")});function i(){if(new Date()-e<h){setTimeout(i,h)}else{f=false;for(id in datatables_by_id){autowidth.adjust_columns_to_tablewidth(datatables_by_id[id]);reorder_resize_tools.synchronize_scroller_body_to_head(datatables_by_id[id].fnSettings());update_column_menu(datatables_by_id[id],datatables_by_id[id])}setBreadcrumbs()}}$.extend($.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper form-inline"})}function initialize_help_texts(){if($(window).width()<768){$(".help-block").each(function(){if(parseFloat($(this).height())>18){$(this).addClass("collapsed")}})}$(".help-block.collapsed").click(function(){$(this).toggleClass("open")})}function initialize_attachments(){$("#attachment-upload").change(function(){post_form()})}function initialize_modals(){$(".modal-caller").each(function(c,b){var g=$(b).data("relatedkey");var d=$(b).data("relatedappkey");var e=$(b).data("action");var f=$(b).data("target");var a=$(b).data("id");$("#"+jquery_selector_escape(f.substring(1))).find(".btn-action").click(function(){post_form(null,e,a,g,d)})})}function initialize_selection_fields(){$(".parent-relation").each(function(a,b){initialize_select2_ajax_element(b)});$(".static-choice").select2();$(".select2-container").each(function(){$(this).find(".select2-focusser").hide();$(this).find(".select2-drop").not(".select2-with-searchbox").find(".select2-search").hide()})}function initialize_datetime_fields(){var a=$(".date");a.each(function(b,e){var d="dd L LT";if($(e).data("datetime-display-setting")===1){d="dd L"}var c=true;if($CLIENT==="iOS"){c=false}$(e).datetimepicker({language:$DATETIME_LOCALE,format:d,pickTime:$(e).data("datetime-display-setting")!==1,sideBySide:c})})}function initialize_color_fields(){function a(b){return"<div class='color color-"+b.id+"'></div>"}$(".color-choice").select2({minimumResultsForSearch:-1,dropdownCssClass:"colored-drop",formatResult:a,formatSelection:a,escapeMarkup:function(b){return b}})}function initialize_multilanguage_fields(){$(".multilanguage").each(function(a,b){initialize_multilanguage_field(b)})}function initialize_resizing(a){$(".card-resize").draggable({axis:"x",containment:".proto-content-holder",start:function(){for(id in a){autowidth.remove_column_widths(a[id])}},drag:function(){var b=parseFloat($(this).css("left"))+9;$(".proto-content").css({width:b});if(b<720){}setBreadcrumbs()},stop:function(){var c=parseFloat($(this).css("left"))+9;if(c<720){c=720}localStorage.setItem("cardWidth",c);$(".proto-content").css({width:c});var b=c-9;$(".card-resize").css({left:b+"px"});setBreadcrumbs();for(id in a){autowidth.adjust_columns_to_tablewidth(a[id]);reorder_resize_tools.synchronize_scroller_body_to_head(a[id].fnSettings());update_column_menu(a[id])}}})}function initialize_breadcrumbs(){$(document).on("click","ol.breadcrumb .clickable",function(){$(".breadcrumbDropdown").toggle()});setBreadcrumbs()}function initialize_save_before_leaving_modal(){var a=$("#card_form");a.one("change keypress select2-selecting",null,ask_user_to_save_before_leaving);if(a.data("beforefirstsave")){ask_user_to_save_before_leaving()}}function initialize_js_editor(){$(".ace-editor").each(function(b,a){var d=$(a).prop("id");var c=ace.edit(d);c.setTheme("ace/theme/chrome");c.getSession().setMode("ace/mode/javascript");c.setValue($(a).data("content"));editors_by_element_id[d]=c})}var datatables_by_id={};
$(document).ready(function(){try{RequestHandler.initializeRootElement();reset_forms_to_html();update_datetime_fields();initialize_tableviews();initialize_help_texts();initialize_attachments();initialize_modals();initialize_selection_fields();initialize_datetime_fields();initialize_color_fields();initialize_resizing(datatables_by_id);initialize_breadcrumbs();initialize_save_before_leaving_modal();initialize_js_editor();if($CLIENT==="iOS"){initialize_client_settings_menu()}}catch(a){alert("Terribly sorry, the javascript client has thrown an error: "+a.message)}});